...
若要啟動AI小幫手，請從Experience Platform UI的頂端標題中選取&#x200B;**[!UICONTROL AI Assistant icon]**。

![Experience Platform首頁，已選取AI助理圖示並開啟AI助理介面。](./images/ai-assistant-full-icon.png)

AI Assistant介面隨即顯示，立即為您提供開始使用的資訊。 您可以使用[!UICONTROL Ideas to get started]下提供的選項來回答下列問題和命令：
...
根據您的查詢，AI Assistant會提供與沙箱中資料相關的其他資訊。 若要檢視您查詢的回應如何套用至您的特定沙箱，請選取&#x200B;**[!UICONTROL In your sandbox].**
...
若要檢視引文並驗證AI助理的回應，請選取&#x200B;**[!UICONTROL Show sources]**。
...
在收到操作深入分析問題的答案後，請選取&#x200B;**[!UICONTROL Show sources]**，然後選取&#x200B;**[!UICONTROL View source query]**。
...
若要重設，請選取AI助理介面上的省略符號(**`...`**)，然後選取&#x200B;**[!UICONTROL Start new conversation]**。 這會通知AI助理您打算變更主題，並在疑難排解失敗或參考錯誤資訊的查詢時特別有用。
...
**注意**：建議預設為啟用。 選取&#x200B;**[!UICONTROL Suggest ideas]**&#x200B;切換以停用此功能。
