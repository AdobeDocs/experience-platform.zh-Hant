...
- [即時客戶個人檔案概觀](../../rtcdp/overview.md):內建 [!DNL Adobe Experience Platform], Real-time Customer Data Platform(Real-time CDP)可協助公司匯整已知和未知的資料，在客戶歷程中運用智慧決策功能啟用客戶設定檔。 Real-time CDP結合了多個企業資料源，以即時建立統一的配置檔案，這些配置檔案可用於跨所有渠道和設備提供一對一的個性化客戶體驗。
