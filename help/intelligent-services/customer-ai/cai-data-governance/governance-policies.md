...
當您完成建立模型並提交模型組態的工作流程後，[原則執行](/help/data-governance/enforcement/auto-enforcement.md)會檢查是否有任何違規。 如果發生原則違規，會出現一個彈出視窗，指出已違反一或多個原則。 這是為了確保您的Platform資料作業和行銷動作符合資料使用原則。
