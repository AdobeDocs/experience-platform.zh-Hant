...
此外，為了存取客戶AI的分數，您需要有成功執行狀態的服務例項。 若要建立新的服務例項，請造訪 [Customer AI使用指南](./user-guide.md)。 如果您最近建立了一個服務例項，但它仍在訓練和計分中，請允許24小時以完成執行。
...
在您的客戶AI見解服務例項中，按一下右上方導覽中的「更多 *動作* 」下拉式清單，然後選取「存 **取分數」**。
