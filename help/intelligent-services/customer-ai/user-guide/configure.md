...
- **[!UICONTROL 傾向性型別]：**&#x200B;傾向性型別決定分數和量度極性的意圖。 您可以選擇&#x200B;**[!UICONTROL 流失]**&#x200B;或&#x200B;**[!UICONTROL 轉換]**。 請參閱探索深入分析檔案中[評分摘要](./discover-insights.md#scoring-summary)下的備註，以取得傾向性型別如何影響您執行個體的詳細資訊。

![安裝程式](../images/user-guide/create-instance.png)
...
未選取![資料集索引鍵](../images/user-guide/select-identity.png)
