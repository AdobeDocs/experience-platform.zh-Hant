...
- Attribution AI {#attribution-ai}
   ...
   - 資料治理 {#aai-data-governance}
      ...
      - [客戶自管金鑰](attribution-ai/aai-data-governance/customer-managed-keys.md)
...
- Customer AI {#customer-ai}
   ...
   - [Customer AI傾向分數模型詳細資料](customer-ai/model-detail.md)
   - UI 指南{#user-guide}
   ...
   - 資料治理 {#cai-data-governance}
      ...
      - [客戶自管金鑰](customer-ai/cai-data-governance/customer-managed-keys.md)
