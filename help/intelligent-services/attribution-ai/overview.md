...
Attribution AI作為智慧服務的一部分，是一種多通道算法歸屬服務，它計算客戶交互對特定結果的影響和增量影響。 透過 Attribution AI，行銷人員可經由了解每個客戶在客戶歷程各個階段的互動所產生的影響，來衡量行銷和廣告支出並予以最佳化。
...
Attribution AI還提供與其他Adobe解決方案的整合， [!DNL Customer Journey Analytics]。 這使您能夠使用這些解決方案利用可定製的算法模型來評估媒體效能並提供分析見解。
