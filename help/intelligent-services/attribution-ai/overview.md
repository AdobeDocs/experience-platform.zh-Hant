...
Attribution AI輸出可以跨不同維度區隔，並可用於客戶歷程的不同階段。 無需將業務需求轉換為機器學習問題、挑選演演算法、培訓或部署模型，即可完成上述工作。
...
下列影片的設計目的，是要協助您瞭解Attribution AI。
...
- **完整的漏斗歸因**：瞭解行銷對整個客戶歷程的影響。 例如，免費帳戶註冊以取得付費轉換及其他功能。
...
您可以依照[快速入門](./getting-started.md)指南開始。 本指南會逐步引導您設定Attribution AI的所有必要預先請求。 如果您已經準備好認證和資料，請瀏覽[Attribution AI使用手冊](./user-guide.md)。 本指南會逐步引導您建立執行個體，並將其提交以進行訓練和評分。
