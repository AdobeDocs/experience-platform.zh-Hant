...
>[!NOTE] 如果您不需要查詢或存取原始分數，可略過此步驟並繼續使用 [者介面指南](./user-guide.md)。

Attribution AI的存取和查詢分數是透過Snowflake完成。 目前，您需要以電子郵件寄送Adobe支援，寄送至attributionai-support@adobe.com，以設定並接收Snowflake的讀者帳戶認證，或大量匯出原始資料。
