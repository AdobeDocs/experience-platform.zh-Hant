...
為您的公司布建標籤存取權，並依前述說明設定您的使用者之後，您應該就能從[Adobe Experience Cloud儀表板](https://experience.adobe.com/)存取資料收集UI和Experience Platform UI。 如果您在完成上述步驟後仍無法存取其中一個UI，請聯絡您的Adobe客戶團隊或客戶服務。
