...
**調整「管理屬性」許可權** - 「管理屬性」許可權發生問題，使用者具有建立新屬性的許可權，但在建立後無法看到該屬性（如社群執行緒[這裡](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-platform-launch/technical-advisory-adjustments-to-the-manage-properties/ba-p/399176?profile.language=zh-Hant)所述）。 現已修正，許可權已如文章所述強制執行。
