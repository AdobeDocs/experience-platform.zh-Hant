...
標籤不需額外付費。 這些規則可供任何[!DNL Adobe Experience Cloud]客戶使用。
...
若您有其他問題，請前往位於[https://adobe.com/go/launchme](https://adobe.com/go/launchme)之主要標籤頁面的「Adobe社群」中發問。

標籤只是我們平台邁向目標的其中一個範例：更開放、更整合，並永遠致力於客戶成功。
