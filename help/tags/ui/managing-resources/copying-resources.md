...
您可以檢視已安裝的擴充功能，選取「**[!UICONTROL Configure]**」按鈕上的下拉式箭頭並選取「**[!UICONTROL Copy]**」，以啓動擴充功能副本。

![複製 Analytics 擴充功能](../../images/copy-initiate-extension.png)

若是屬性、規則和資料元素，只要選取您要複製的資源，然後選取動作選單中的「**[!UICONTROL Copy]**」即可。
