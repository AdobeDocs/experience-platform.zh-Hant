...
如果尚未安裝AdobeContextHub擴充功能，請開啟您的屬性，然後選取「**[!UICONTROL 擴充功能>目錄]**」，將游標停留在AdobeContextHub擴充功能上，然後選取「**[!UICONTROL 安裝]**」。
