...
若 `getTracker` 是 `undefined`，標籤程式庫中沒有Adobe Analytics擴充功能。 您可以自訂記錄訊息，以精確反映未安裝 Adobe Analytics 時可能遺失的功能。


## [!DNL augment-tracker]

初始化追蹤器物件後，緊接著是增強程序。此步驟可讓您的擴充功能在從Adobe Analytics擴充功能設定套用任何變數或傳送任何信標之前，使用任何必要的專案來增強追蹤器。
