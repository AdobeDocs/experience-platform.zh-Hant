...
以下是用戶端標籤擴充功能的檔案清單。 如需可用伺服器端擴充功能的清單，請參閱 [事件轉送擴充功能參考](../server/overview.md) 。
...
* [Adobe用戶端資料層](./client-data-layer/overview.md)
...
* [Adobe MediumAnalytics for Audio and Video](./media-analytics/overview.md)
