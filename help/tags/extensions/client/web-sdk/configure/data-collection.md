...
# 資料收集設定 {#data-collection}

>[!CONTEXTUALHELP]
>id="platform_tags_websdk_datacollection"
>title="資料彙集"
>abstract="決定要收集哪些資料，以及如何在標記擴充功能中收集這些資料。"
...
* **[!UICONTROL Send referrer to Adobe Analytics only once per page view]**：防止將重複的反向連結資料傳送至Adobe Analytics。
