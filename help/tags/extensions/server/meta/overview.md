...
此 [!UICONTROL 驗證結果] 對話方塊會顯示中繼擴充功能實作結果。 選取&#x200B;**[!UICONTROL 「下一步」]**。您也可以選取 **[!UICONTROL 保證]** 連結。
...
選取 [!UICONTROL 事件型別]. 在此範例中，我們已選取 [!UICONTROL 按一下] 事件並設定為當 **.add-to-cart-button** 「 」已選取。 選取&#x200B;**[!UICONTROL 「保留變更」]**。
