...
使用[!DNL Algolia]事件轉寄延伸功能，透過[!DNL Algolia]將使用者行為事件傳送至[!DNL Insights API]。 此行為資料可啟用AI支援的建議、個人化體驗和智慧型搜尋功能。
...
在&#x200B;**[!UICONTROL Data Collection]**&#x200B;中導覽至[!DNL Adobe Experience Platform]。 選取 **[!UICONTROL Extensions]** 索引標籤。

開啟&#x200B;**[!UICONTROL Catalog]**&#x200B;並找到&#x200B;**[!UICONTROL Algolia Event Forwarding]**&#x200B;擴充功能，然後選取&#x200B;**[!UICONTROL Install]**。
...
若要設定[!DNL Algolia]事件轉送擴充功能，請瀏覽至&#x200B;**[!UICONTROL Extensions]**&#x200B;標籤，選取&#x200B;**[!UICONTROL Algolia]**&#x200B;擴充功能，然後選取&#x200B;**[!UICONTROL Configure]**。

在Adobe Experience Platform中設定Algolia事件轉送擴充功能的![設定畫面](../../../images/extensions/server/algolia/configure.png)

| 屬性 | 說明 |
|----------|-------------|
| **[!UICONTROL Application ID]** | 輸入[!UICONTROL Application ID]API金鑰[區段下的Algolia Dashboard中的](https://www.algolia.com/account/api-keys/all)。 |
| **[!UICONTROL Search API Key]** | 輸入[!UICONTROL Search API Key]API金鑰[區段下的Algolia Dashboard中的](https://www.algolia.com/account/api-keys/all)。 |
| **[!UICONTROL Index Name]** | 輸入包含產品或內容的[!UICONTROL Index Name]。 此索引會作為預設值使用。 |
...
設定&#x200B;**[!UICONTROL Send event]**&#x200B;動作以將事件轉送至[!DNL Algolia]：
...
### 使用[!UICONTROL Data Collection]標籤對應及傳送資料
...
1. 使用[!UICONTROL Data Element]建立&#x200B;**[!DNL Adobe Experience Platform Web SDK]**。
2. 選取&#x200B;**[!UICONTROL XDM object]**&#x200B;作為資料元素型別。
...
4. 選取&#x200B;**[!UICONTROL Send event]**&#x200B;作為動作型別。
...
導覽至您的[!DNL Algolia]儀表板並移至&#x200B;**[!UICONTROL Data Sources > Events > Debugger]**。
...
- **驗證API認證**：確定&#x200B;**[!UICONTROL Application ID]**&#x200B;和&#x200B;**[!UICONTROL API Key]**&#x200B;符合您[!DNL Algolia]儀表板中的值。
...
本指南說明如何使用[!DNL Algolia]將資料傳送至[!DNL Algolia Event Forwarding Extension]。 如需[!DNL Adobe Experience Platform]中事件轉送功能的詳細資訊，請閱讀[事件轉送概觀](../../../ui/event-forwarding/overview.md)。
