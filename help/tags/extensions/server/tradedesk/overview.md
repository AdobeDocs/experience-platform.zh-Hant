...
您可以利用[[!DNL The Trade Desk Real-Time Conversions API]事件轉送](https://partner.thetradedesk.com/v3/portal/data/doc/DataConversionEventsApi)規則中的API功能，使用[!DNL The Trade Desk][擴充功能將資料從Adobe Experience Platform Edge Network傳送至](../../../ui/event-forwarding/overview.md)。

使用[!DNL The Trade Desk Real-Time Conversions API]擴充功能，您可以在[事件轉送](../../../ui/event-forwarding/overview.md)規則中運用API的功能，從Adobe Experience Platform Edge Network傳送資料給[!DNL The Trade Desk]。
...
在左側導覽中選取&#x200B;**[!UICONTROL Extensions]**。 在「**[!UICONTROL Catalog]**」標籤中，選取「**[!UICONTROL The Trade Desk]**&#x200B;即時轉換API」卡片，然後選取「**[!UICONTROL Install]**」。
...
您應該考慮設定數個規則，以透過[和](https://partner.thetradedesk.com/v3/portal/data/doc/DataConversionEventsApi#properties)即時轉換API傳送所有已接受的[!DNL The Trade Desk]要求屬性[!DNL The Trade Desk]。

>[!NOTE]
>
>事件應儘可能即時或接近即時傳送。

在您的事件轉送屬性中建立新的事件轉送[規則](../../../ui/managing-resources/rules.md)。 在&#x200B;**[!UICONTROL Actions]**&#x200B;底下，新增動作並將擴充功能設為&#x200B;**[!UICONTROL The Trade Desk]**。 接下來，為&#x200B;**[!UICONTROL Real Time Conversion]**&#x200B;選取&#x200B;**[!UICONTROL Action Type]**。

![「事件轉送屬性規則」檢視中，醒目顯示新增事件轉送規則動作設定所需的欄位。](../../../images/extensions/server/tradedesk/tradedesk-event-action.png)

選取後，會顯示其他控制項以進一步設定將傳送至[!DNL The Trade Desk]的事件資料。 選取&#x200B;**[!UICONTROL Keep Changes]**&#x200B;以儲存規則。
...
| 廣告ID | 事件的唯一廣告ID。 |
| 廣告識別碼型別 | 廣告ID的型別，在AD ID屬性中指定：TDID、IDFA、AAID、DAID、NAID、IDL、EUID或UID2。 |
...
請參閱[!DNL The Trade Desk]開發人員檔案，以取得有關[即時轉換API所接受的](https://partner.thetradedesk.com/v3/portal/data/doc/DataConversionEventsApi#properties)要求屬性[!DNL The Trade Desk]的詳細資訊。
...
如需[及其屬性的詳細資訊，請參閱](https://partner.thetradedesk.com/v3/portal/data/doc/DataConversionEventsApi#properties-items)即時轉換事件[!UICONTROL Object Request Parameters]檔案。

**[!UICONTROL Configuration Overrides]**

>[!NOTE]
>
>[!UICONTROL Configuration Overrides]欄位可讓您在每個規則上設定不同的[!DNL Advertiser ID]和/或[!DNL Merchant ID]。
...
如需有關如何有效實作整合的更多指引，請參閱[!DNL The Trade Desk]有關[即時轉換API [!DNL The Trade Desk] 的](https://partner.thetradedesk.com/v3/portal/data/doc/DataConversionEventsApi)最佳實務的檔案。
