...
* 事件轉送 {#event-forwarding}
   ...
   * [引導式設定](./ui/event-forwarding/guided-setup.md)
...
* 擴充功能 {#extensions}
   ...
   * 標籤擴充功能（使用者端） {#client}
      ...
      * Adobe Content Analytics {#content-analytics}
         ...
         * [發行說明](./extensions/client/content-analytics/release-notes.md)
      ...
      * Adobe Experience Platform Web SDK {#web-sdk}
         ...
         * 設定 {#configure}
            ...
            * [建置選項](extensions/client/web-sdk/configure/custom-build-components.md)
            * [SDK執行個體](extensions/client/web-sdk/configure/general.md)
            * [資料串流](extensions/client/web-sdk/configure/datastreams.md)
      ...
      * [!DNL Algolia]個深入分析 {#algolia-insights}
         * [概觀](./extensions/client/algolia/overview.md)
   ...
   * 事件轉送擴充功能（伺服器端） {#server}
      ...
      * [!DNL Algolia] {#algolia}
         * [概觀](./extensions/server/algolia/overview.md)
      * [!DNL Amazon] {#amazon}
      ...
      * [!DNL Nextdoor] {#nextdoor}
         * [概觀](./extensions/server/nextdoor/overview.md)
...
* 擴充功能開發 {#extension-dev}
   ...
   * [共用私人擴充功能](./extension-dev/shared-private-extensions.md)
* Reactor API {#api}
   * [概觀](./api/overview.md)
