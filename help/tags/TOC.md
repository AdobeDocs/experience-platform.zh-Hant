...
* 發佈 {#publish}
   ...
   * [Premium CDN支援（測試版）](./ui/publishing/premium-cdn.md)
* 用戶端資訊 {#client-side}
...
* 事件轉送 {#event-forwarding}
   ...
   * [監控（測試版）](./ui/event-forwarding/monitoring.md)
* 管理 {#admin}
...
* 擴充功能 {#extensions}
   ...
   * 標籤擴充功能（用戶端） {#client}
      ...
      * [Adobe Analytics透過Adobe Experience Platform Web SDK](https://exchange.adobe.com/apps/ec/108985/search-discovery-for-adobe-analytics-via-aep-web-sdk)
...
* [不再支援Internet Explorer 10和11](./ie-deprecation.md)
* 發行說明 {#release-notes}
