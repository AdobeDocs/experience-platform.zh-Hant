...
* UI參考線 {#ui}
   * [總覽](./ui/managing-resources/overview.md)
   * 擴充功能 {#extensions}
      * [總覽](./ui/managing-resources/extensions/overview.md)
      * [擴展升級](./ui/managing-resources/extensions/extension-upgrade.md)
...
* 發佈 {#publish}
   * [總覽](./ui/publishing/overview.md)
   * [發佈流程](./ui/publishing/publishing-flow.md)
   * 主機 {#hosts}
      * [總覽](./ui/publishing/hosts/hosts-overview.md)
      * [Adobe管理的主機](./ui/publishing/hosts/managed-by-adobe-host.md)
      * [SFTP主機](./ui/publishing/hosts/sftp-host.md)
   * 環境 {#environments}
      * [總覽](./ui/publishing/environments.md)
   ...
   * [高級CDN支援（試用版）](./ui/publishing/premium-cdn.md)
* 用戶端資訊 {#client-side}
   * [總覽](./ui/client-side/overview.md)
   ...
   * [內容安全策略(CSP)支援](./ui/client-side/content-security-policy.md)
...
* 擴充功能 {#extensions}
   ...
   * 事件轉發擴展（伺服器端） {#server}
      ...
      * [用於Google Analytics的雲連接器](https://exchange.adobe.com/apps/ec/106542)
      * 核心 {#core}
         * [總覽](./extensions/server/core/overview.md)
      * [Epsilon事件API](https://exchange.adobe.com/apps/ec/109127)
      * Google廣告增強轉換 {#google-ads-enhanced-conversions}
      ...
      * [!UICONTROL MicrosoftAzure] {#azure}
      ...
      * [!DNL Pinterest] {#pinterest}
         * [總覽](./extensions/server/pinterest/overview.md)
...
* 擴充功能開發 {#extension-dev}
   ...
   * 提交程序 {#submit}
      * [總覽](./extension-dev/submit/overview.md)
...
* Reactor API {#api}
   ...
   * 端點 {#endpoints}
      ...
      * [擴展包](./api/endpoints/extension-packages.md)
      ...
      * [應用程式配置](./api/endpoints/app-configurations.md)
      * [審計事件](./api/endpoints/audit-events.md)
      * [回調](./api/endpoints/callbacks.md)
      * [附註](./api/endpoints/notes.md)
      * [設定檔](./api/endpoints/profile.md)
      * [搜尋](./api/endpoints/search.md)
      * [秘密](./api/endpoints/secrets.md)
   * 指南 {#guides}
      * [委託描述符ID](./api/guides/delegate-descriptor-ids.md)
      * [加密值](./api/guides/encrypting-values.md)
      * [錯誤處理](./api/guides/error-handling.md)
      * [篩選響應](./api/guides/filtering.md)
      * [正在分頁響應](./api/guides/pagination.md)
      * [對響應排序](./api/guides/sorting.md)
      * [關係](./api/guides/relationships.md)
      * [搜索資源](./api/guides/search.md)
