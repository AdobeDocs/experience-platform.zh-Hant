...
* [與Privacy Service](#integrated)整合的應用程式：能夠傳送存取、刪除或選擇退出要求給[!DNL Privacy Service]的應用程式。
