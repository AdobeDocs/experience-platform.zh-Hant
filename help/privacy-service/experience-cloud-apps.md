...
| Adobe Analytics | ✓ | ✓ | <ul><li>[存取／刪除檔案](https://marketing.adobe.com/resources/help/en_US/analytics/gdpr/index.html)</li><li>Analytics會使用隱私權報告變數處理退出 [請求](https://docs.adobe.com/content/help/zh-Hant/analytics/admin/data-governance/consent-variables.html)</li></ul> |
...
| [Adobe Dynamic Tag Manager](https://marketing.adobe.com/resources/help/zh_TW/dtm/opt-in.html) | 防止Adobe標籤在取得同意前引發的步驟。 |
