...
**MODPA**： [!DNL Maryland Online Data Privacy Act]授予住戶權利，包括存取、更正、刪除和資料可攜性。 居民可以選擇退出針對性廣告、個人資料銷售和設定檔的資料處理。 該法禁止在心理健康或生殖健康設施周圍設定地理圍欄。 此法律適用於處理來自超過35,000名消費者的資料的實體，或適用於處理來自超過10,000名消費者的資料並透過銷售該資料獲得超過20%收入的實體。 執行工作由馬里蘭州總檢察長負責，違例者可處以罰款和罰款。
...
**PIPA** （南韓）： [!DNL Personal Information Protection Act]會規範南韓居民個人資料的處理和保護。 PIPA授予居民權利，包括知情權、存取權、取得復本，以及要求更正、刪除或暫停處理。 控管單位必須指定收集目的、以必要的最低程度合法處理資料，並確保資料正確性。 該法案還建立了個人資訊保護委員會以供強制執行，該委員會可以對違反規定者處以罰款和行政處罰。
