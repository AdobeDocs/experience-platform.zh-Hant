...
Adobe Experience Platform [!DNL Privacy Service] 提供RESTful API和使用者介面，可讓您協調各種解決方案的隱私權和法規遵循要求。 本檔案探討 [!DNL Privacy Service] UI。 如需使用API的詳細資訊，請參閱 [Privacy ServiceAPI指南](../api/overview.md).
...
選擇 **[!UICONTROL 使用Adobe ID登入]** 並在出現提示時輸入您的Adobe ID憑證。
