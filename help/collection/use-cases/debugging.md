---
title: 偵錯方法
description: 瞭解如何在Web SDK中切換偵錯功能。
...
啟用偵錯功能後，Web SDK會輸出訊息至瀏覽器主控台，以協助您對實作進行偵錯。 如果您使用標籤作為實作方法，它也能讓您檢視[`_satellite.logger`](../tags/logger.md)則訊息。 如果您想要瞭解SDK如何根據您建立的規則和資料元素運作，除錯就十分實用。
...
如需詳細資訊，請參閱[`debugEnabled`](../js/commands/configure/debugenabled.md)。
...
如需詳細資訊，請參閱[`setDebug`](../js/commands/setdebug.md)命令。
...
![啟用偵錯工具](../js/assets/enable-debugging.png)
