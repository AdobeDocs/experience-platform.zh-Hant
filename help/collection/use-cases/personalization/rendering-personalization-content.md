...
此外，Web SDK可透過Adobe Experience Platform個人化目標(例如[Adobe Target](/help/destinations/catalog/personalization/adobe-target-connection.md)和[自訂個人化連線](/help/destinations/catalog/personalization/custom-personalization.md))，提供相同頁面和下一頁個人化功能。 若要瞭解如何設定Experience Platform以進行相同頁面和下一頁個人化，請參閱[專屬指南](/help/destinations/ui/activate-edge-personalization-destinations.md)。
