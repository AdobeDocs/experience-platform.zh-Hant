...
| `StreamType` | 資料流型別 | `VOD`、`Live`、`Linear`、`Podcast`、`Audiobook`、`AOD` |
...
## 使用Web Analytics標籤擴充功能取得Media SDK追蹤器

此命令的Web SDK標籤延伸等效項是[**[!UICONTROL Get Media Analytics tracker]**](/help/tags/extensions/client/web-sdk/actions/get-media-analytics-tracker.md)動作。
