---
keywords: Experience Platform;home；熱門主題；架構；架構；XDM;fields;schemas;geo;geo shape;datatype；資料類型；
...
[!UICONTROL Geo ] Shape是一種標準的XDM資料類型，可描述地理區域的形狀。此資料類型基於[schema.org](https://schema.org/GeoShape)上記載的公共規範。

<img src="../images/data-types/geo-shape.png" width="500" /><br />

| 屬性 | 資料類型 | 說明 |
| --- | --- | --- |
| `_schema.box` | [[!UICONTROL 地理座標]](./geo-coordinates.md)的陣列 | 描述由兩個坐標構成的矩形所包圍的地理區域。 第一坐標是矩形的下角，第二坐標是上角。 |
| `_schema.circle` | [[!UICONTROL 地理座標]](./geo-coordinates.md)的陣列 | 描述圓形區域，其特定半徑位於地理坐標上。 |
