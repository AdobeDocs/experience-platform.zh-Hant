...
[!UICONTROL 索引鍵值配對] 是標準的體驗資料模型(XDM)資料型別，可擷取一般索引鍵/值組的詳細資訊。 此資料型別用於 [[!UICONTROL Adobe Analytics ExperienceEvent完整擴充功能] 欄位群組](../field-groups/event/analytics-full-extension.md) 說明清單變數的陣列專案。
