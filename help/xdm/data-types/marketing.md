...
[!UICONTROL 行銷]是標準的XDM資料型別，說明在特定接觸點上處於作用中狀態的行銷活動。

![](../images/data-types/marketing.png)

| 屬性 | 資料類型 | 說明 |
| --- | --- | --- |
| `campaignGroup` | 字串 | 行銷活動群組的名稱（當多個行銷活動聚集在一起時，例如`50%_DISCOUNT`）。 |
...
* [已填入範例](https://github.com/adobe/xdm/blob/master/components/datatypes/marketing/marketing.example.1.json)
