...
![可用性資料型別結構](../../images/data-types/healthcare/availability/availability.png)
...
![可用的時間結構](../../images/data-types/healthcare/availability/available-time.png)
...
![沒有可用的時間結構](../../images/data-types/healthcare/availability/not-available-time.png)

| 顯示名稱 | 屬性 | 資料類型 | 說明 |
| --- | --- | --- | --- |
| [!UICONTROL 期間] | `during` | [[!UICONTROL 週期]](../healthcare/period.md) | 專案停止可用的時間週期。 |
