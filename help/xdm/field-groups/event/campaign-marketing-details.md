...
description: 瞭解行銷活動行銷詳細資料結構欄位群組。
...
# [!UICONTROL 行銷活動行銷詳細資料]結構描述欄位群組

>[!NOTE]
>
>數個結構描述欄位群組的名稱已變更。 如需詳細資訊，請參閱[欄位群組名稱更新](../name-updates.md)的檔案。

[!UICONTROL 行銷活動行銷詳細資料]是[[!DNL XDM ExperienceEvent] 類別](../../classes/experienceevent.md)的標準結構描述欄位群組，用於描述行銷活動資訊，例如行銷活動群組、名稱和追蹤代碼。
...
* [已填入範例](https://github.com/adobe/xdm/blob/master/components/fieldgroups/experience-event/experienceevent-marketing.example.1.json)
