...
![欄位群組結構](../../images/field-groups/healthcare-goal/goal.png)
...
| [!UICONTROL 開始可程式碼的概念] | `startCodeableConcept` | [[!UICONTROL 可程式碼概念]](../../data-types/healthcare/codeable-concept.md) | 之後應說服目標的事件。 |
