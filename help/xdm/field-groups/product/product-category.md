...
[!UICONTROL 產品類別]是[[!UICONTROL 產品]類別](../../classes/product.md)的標準結構描述欄位群組，可擷取與產品類別相關的屬性。
...
| `productSubcategoryDescription` | 字串 | 產品次類別的說明。 |
| `productSubcategoryName` | 字串 | 產品次類別的名稱。 |
