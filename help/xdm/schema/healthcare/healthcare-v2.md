...
| 名稱 | 說明 |
| --- | --- |
| [[!UICONTROL Address]](./data-types/address.md) | 說明使用郵遞區號慣例（而非GPS或其他位置定義格式）表示的地址。 |
| [[!UICONTROL Annotation]](./data-types/annotation.md) | 歸因於作者的文位元組點。 |
| [[!UICONTROL Availability]](./data-types/availability.md) | 專案的可用性資料。 |
| [[!UICONTROL Codeable Concept]](./data-types/codeable-concept.md) | 從一種資源到另一種資源的參考。 |
| [[!UICONTROL Codeable Reference]](./data-types/codeable-reference.md) | 對資源或概念的參照。 |
| [[!UICONTROL Coding]](./data-types/coding.md) | 術語系統定義的程式碼參考。 |
| [[!UICONTROL Contact Point]](./data-types/contact-point.md) | 個人的聯絡詳細資訊。 |
| [[!UICONTROL Dosage]](./data-types/dosage.md) | 用藥方式或應如何服用。 |
| [[!UICONTROL Duration]](./data-types/duration.md) | 時間長度。 |
| [[!UICONTROL Extended Contact Details]](./data-types/extended-contact-detail.md) | 延伸連絡人的資訊。 |
| [[!UICONTROL Human Name]](./data-types/human-name.md) | 有關人類或其他生命實體名稱的資訊。 |
| [[!UICONTROL Identifier]](./data-types/identifier.md) | 用於計算的識別碼。 |
| [[!UICONTROL Money]](./data-types/money.md) | 以某些公認的貨幣表示的經濟公用程式金額。 |
| [[!UICONTROL Period]](./data-types/period.md) | 由開始和結束日期/時間定義的時間期間。 |
| [[!UICONTROL Person]](./data-types/person.md) | 有關一般人員記錄的資訊。 |
| [[!UICONTROL Quantity]](./data-types/quantity.md) | 測量或可測量的金額。 |
| [[!UICONTROL Range]](./data-types/range.md) | 由低值和高值繫結的一組值。 |
| [[!UICONTROL Ratio]](./data-types/ratio.md) | 透過分子和分母的兩個[[!UICONTROL Quantity]](./data-types/quantity.md)值的比例。 |
| [[!UICONTROL Reference]](./data-types/reference.md) | 從一種資源到另一種資源的參考。 |
| [[!UICONTROL Repeat]](./data-types/repeat.md) | 說明事件排程時間的一組規則。 |
| [[!UICONTROL Simple Quantity]](./data-types/simple-quantity.md) | 測量或可測量的金額。 |
| [[!UICONTROL Timing]](./data-types/timing.md) | 關於可能發生多次之事件的資訊。 |
| [[!UICONTROL Virtual Service Detail]](./data-types/virtual-service-detail.md) | 虛擬服務連絡人詳細資料。 |
