...
在Experience Data Model (XDM)中，[!UICONTROL 提供者]類別會擷取定義提供者商業實體（例如醫療保健提供者或保險提供者）的最低屬性集。
...
類別可以與[[!UICONTROL 醫療保健提供者]欄位群組](../field-groups/provider/healthcare-provider.md)一起擴充，以說明醫療保健提供者的詳細資訊。
