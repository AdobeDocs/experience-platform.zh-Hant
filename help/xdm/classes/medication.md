...
在Experience Data Model (XDM)中， [!UICONTROL 藥物] 類別會擷取定義用於醫療的物質（尤其是藥物或藥物）的最小屬性集。
...
可以使用來擴充類別 [[!UICONTROL 醫療保健藥物] 欄位群組](../field-groups/medication/healthcare-medication.md) 以進一步說明藥物或藥物的詳細資訊。
