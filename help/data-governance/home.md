...
Adobe Experience Platform的核心功能之一，就是將來自多個企業系統的資料整合在一起，讓行銷人員能夠更好地識別、瞭解並吸引客戶。 此資料可能受您組織或法律法規所定義的使用限制所約束。 因此，請務必確保[!DNL Platform]中的資料操作符合資料使用策略。
...
以下視訊介紹Experience Platform中的各種[!DNL Data Governance]功能。
