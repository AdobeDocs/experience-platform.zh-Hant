...
本文檔介紹如何使用 **[!UICONTROL 策略]** 工作區，以建立和管理資料使用策略。

>[!NOTE]
>
>有關如何在UI中管理訪問控制策略的資訊，請參閱 [基於屬性的訪問控制UI指南](../../access-control/abac/ui/policies.md) 的雙曲餘切值。
...
>[!IMPORTANT]
>
>只有已購買的組織才可使用同意策略 **Adobe醫療保健盾** 或 **Adobe隱私與安全防護**。
...
在 **[!UICONTROL 然後]** 部分，從聯合架構中至少選擇一個同意屬性。 此屬性必須存在，如此設定檔才能包含在此原則控管的動作中。可以從清單中選擇一個提供的選項，或選擇 **[!UICONTROL 查看全部]** 從聯合架構中直接選擇屬性。
