...
若要在資料集層級管理資料使用標籤，您必須選取現有的資料集或建立新的資料集。 登入Adobe Experience Platform後，在左側導覽中選擇&#x200B;**[!UICONTROL Datasets]**&#x200B;以開啟&#x200B;**[!UICONTROL Datasets]**&#x200B;工作區。 此頁列出屬於您組織的所有已建立資料集，以及與每個資料集相關的有用詳細資訊。
...
要建立新資料集，請在&#x200B;**[!UICONTROL Datasets]**&#x200B;工作區右上角選擇&#x200B;**[!UICONTROL Create Dataset]**。

![](../images/labels/create-dataset.png)

出現&#x200B;**[!UICONTROL 建立資料集]**&#x200B;畫面。 在此處，選擇&#x200B;**[!UICONTROL 從架構建立資料集]**。

![從架構建立資料集](../images/labels/create-from-dataset.png)

將顯示&#x200B;**[!UICONTROL 選擇方案]**&#x200B;螢幕，其中列出了可用於建立資料集的所有可用方案。 選擇方案旁邊的單選按鈕以選擇它。 右側的&#x200B;**[!UICONTROL 方案]**&#x200B;部分顯示有關所選方案的其他詳細資訊。 選擇方案後，選擇&#x200B;**[!UICONTROL Next]**。

![選擇資料集模式](../images/labels/select-schema.png)

出現「**[!UICONTROL Configure Dataset]**」螢幕。 為新資料集提供名稱（必要）和說明（可選，但建議使用），然後選擇&#x200B;**[!UICONTROL 完成]**。

![使用名稱和說明配置資料集](../images/labels/configure-dataset.png)

此時會出現「**[!UICONTROL 資料集活動]**」頁面，顯示有關新建立資料集的資訊。 在此範例中，資料集名為「忠誠成員」，因此，頂端導覽會顯示&#x200B;**資料集>忠誠成員**。

![「資料集活動」頁](../images/labels/dataset-created.png)

### 將資料使用標籤新增至資料集{#add-labels}

建立新資料集或從&#x200B;**[!UICONTROL Datasets]**&#x200B;工作區的清單中選取現有資料集後，選取&#x200B;**[!UICONTROL Data Governance]**&#x200B;以開啟&#x200B;**[!UICONTROL Data Governance]**&#x200B;工作區。 工作區可讓您在資料集層級和欄位層級管理資料使用標籤。
...
將開啟&#x200B;**[!UICONTROL 編輯治理標籤]**&#x200B;對話框。 在對話方塊中，勾選您要套用至資料集之標籤旁的方塊。 請記住，資料集內的所有欄位都會繼承這些標籤。 當您勾選每個方塊時，**[!UICONTROL 已套用的標籤]**&#x200B;標題會更新，顯示您選擇的標籤。 選擇所需標籤後，選擇&#x200B;**[!UICONTROL 保存更改]**。

![在資料集層級套用治理標籤](../images/labels/apply-labels-dataset.png)

**[!UICONTROL 資料控管]**&#x200B;工作區會重新出現，顯示您在資料集層級套用的標籤。 您也可以看到標籤會繼承至資料集內的每個欄位。
...
**[!UICONTROL 顯示繼承的標籤]**&#x200B;切換為預設開啟，可讓您查看從資料集繼承到其欄位的任何標籤。 切換關閉功能會隱藏資料集內任何繼承的標籤。
...
若要將資料使用標籤套用至個別欄位，請選取欄位名稱旁的核取方塊，然後選取「編輯控管標籤」**[!UICONTROL 。]**

![編輯欄位標籤](../images/labels/field-label-edit.png)

此時將顯示&#x200B;**[!UICONTROL 編輯治理標籤]**&#x200B;對話框。 對話方塊會顯示標題，其中顯示選取的欄位、套用的標籤和繼承的標籤。 請注意，繼承的標籤（C2和C5）在對話方塊中會變灰。 這些標籤是繼承自資料集層級的唯讀標籤，因此僅能在資料集層級編輯。

![編輯個別欄位的治理標籤](../images/labels/field-label-inheritance.png)

選取您要使用之每個標籤旁的核取方塊，以選取欄位層級標籤。 在您選擇標籤時，**[!UICONTROL 已套用的標籤]**&#x200B;標題會更新，以顯示已套用至&#x200B;**[!UICONTROL 已選取欄位]**&#x200B;標題中顯示欄位的標籤。 選擇完欄位級標籤後，請選擇&#x200B;**[!UICONTROL 保存更改]**。

![套用欄位層級標籤](../images/labels/apply-labels-field.png)

**[!UICONTROL 資料管理]**&#x200B;工作區會重新出現，現在會在欄位名稱旁的列中顯示選取的欄位層級標籤。 請注意，欄位層級標籤旁有&quot;x&quot;，讓您移除標籤。
...
您可以在[!DNL Experience Platform] UI的&#x200B;**[!UICONTROL Policys]**&#x200B;工作區中建立您自己的自訂使用標籤。 在左側導航中選擇&#x200B;**[!UICONTROL 策略]**，然後選擇&#x200B;**[!UICONTROL 標籤]**&#x200B;以查看現有標籤的清單。 在此處，選擇&#x200B;**[!UICONTROL 建立標籤]**。

![](../images/labels/create-label-btn.png)

出現&#x200B;**[!UICONTROL 建立標籤]**&#x200B;對話框。 從這裡，為新標籤提供以下資訊：
...
對話框關閉，新建立的自定義標籤將顯示在&#x200B;**[!UICONTROL 標籤]**&#x200B;頁籤下的清單中。

![](../images/labels/label-created.png)

現在，編輯資料集和欄位的使用標籤時或建立資料使用策略時，可以在&#x200B;**[!UICONTROL 自定義標籤]**&#x200B;下選擇標籤。
