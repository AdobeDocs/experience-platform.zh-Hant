...
即時CDP現在支援資料激活超過50次 [!DNL Experience Cloud Launch] 擴展、啟用分析、個性化和其他使用案例。 有關詳細資訊，請參閱下面：

| 文件 | 說明 |
|--- | ---|
| [目標類型和類別](../../destinations/destination-types.md) | 本文說明了即時CDP介面中連接和擴展之間的區別，並建議何時使用這些目標。 |
| [Experience Platform Launch擴展](../../destinations/catalog/launch-extensions/overview.md) | 本頁說明了 [!DNL Launch] 擴展是，列出使用它們的使用案例，以及每個文檔的文檔連結 [!DNL Launch] 即時CDP中的擴展。 |
