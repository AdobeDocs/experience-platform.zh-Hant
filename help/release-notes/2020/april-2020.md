...
Real-time CDP現在支援多達五十個的資料激活 [!DNL Experience Cloud Launch] 擴充功能，啟用分析、個人化和其他使用案例。 如需詳細資訊，請參閱下方：

| 文件 | 說明 |
|--- | ---|
| [目的地類型和類別](../../destinations/destination-types.md) | 本文說明即時CDP介面中連線和擴充功能之間的差異，並建議何時分別使用這些目的地。 |
