...
description: Adobe Experience Platform 2020 年 7 月的發行說明。
...
| Adobe Audience Manager整合 | 任何與[!DNL Platform]的[!DNL Audience Manager]共用的區段都會繼承任何套用的資料使用標籤，做為[!DNL Data Export Controls]，反之亦然。 請參閱[!DNL Audience Manager]檔案，瞭解使用標籤與資料匯出控制項](https://experienceleague.adobe.com/docs/audience-manager/user-guide/implementation-integration-guides/integration-experience-platform/aam-aep-audience-sharing.html)之間的特定[對應。 |
...
| 功能 | 說明 |
| ------- | ----------- |
| 串流區段 | 當資料進入[!DNL Platform]時，串流區段現在可以符合使用者進入區段的資格，從而大幅縮短區段資格時間。 串流細分也可減少手動執行細分工作的需求。 |
