...
description: Adobe Experience Platform 2020年9月版本注意事項。
...
| 功能 | 說明 |
| --- | --- |
| Adobe I/O事件通知 | [!DNL Observability Insights]利用Adobe I/O事件建立數個Experience Platform服務的事件通知。 通知裝載會傳送至已設定的webhook，然後您可以使用它來自動化後續的下游流程。 |
...
| 功能 | 說明 |
| ------- | ----------- |
| 自動對應 | [!DNL Platform]會根據使用者選取的目標結構描述或資料集，在資料擷取工作流程期間提供自動對應的智慧型建議。 您可以手動調整彈性的自動對應規則，以符合您的使用案例。 |
