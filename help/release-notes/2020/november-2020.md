...
| 功能 | 說明 |
| ------- | ----------- |
| 目的地詳細資訊UX更新 | 即時CDP的目標工作流程現在包含內嵌監控，讓您可以查看哪些批次啟動成功。 此功能可讓使用者透過警報和監控控制面板，直接在批次目的地的工作流程中解決問題，以追蹤處理管道中的錯誤。 |
...
Customer AI是Intelligent Services的一部分，可讓行銷人員在個別層級產生客戶預測並提供說明。 在影響因素的協助下， Customer AI可告訴您客戶可能做什麼及為什麼。 此外，行銷人員也能受益於Customer AI預測和深入分析，提供最適當的選件和訊息，以個人化客戶體驗。
