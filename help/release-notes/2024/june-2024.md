...
| 功能 | 說明 |
| --- | --- |
| Experience Platform 中的 AI 助理 | 現在起，您可以在 Experience Platform 中使用 AI 助理了。AI 助理支援 Experience Platform、Real-Time Customer Data Platform、Adobe Journey Optimizer 和 Customer Journey Analytics。<br> Experience Experience Platform中的![AI助理。Experience Experience Platform中的](../2024/assets/june/ai-assistant-full.png "AI助理。"){width="100" zoomable="yes"} <br>如需有關此功能的詳細資訊，請閱讀 [AI 助理使用者介面指南](../../ai-assistant/ui-guide.md)。 |
