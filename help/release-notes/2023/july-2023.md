...
- [Adobe Experience Platform 發行說明](#adobe-experience-platform-release-notes)
   ...
   - [資料收集 {#data-collection}](#data-collection-data-collection)
   ...
   - [體驗資料模式 (XDM) {#xdm}](#experience-data-model-xdm-xdm)
...
- 您現在可以將對象匯出為 [JSON或Parquet檔案](/help/destinations/ui/activate-batch-profile-destinations.md#supported-file-formats-export)，以及已支援的CSV格式。
