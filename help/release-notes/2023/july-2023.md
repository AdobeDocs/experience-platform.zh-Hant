...
| 元件類型 | 名稱 | 說明 |
| --- | --- | --- |
| 類別 | [[!UICONTROL XDM Individual Prospect Profile]](https://github.com/adobe/xdm/pull/1758/files) | 使用此類別引入來自資料供應商的漏斗頂部客戶贏取使用案例的潛在客戶資料。 |
| 欄位群組 | [[!UICONTROL Enriched Event Segment Details]](https://github.com/adobe/xdm/pull/1754/files) | 收集事件資料當時輪廓符合資格的客群清單。 |
...
| 元件類型 | 名稱 | 更新說明 |
| --- | --- | --- |
| 欄位群組 | [[!UICONTROL MediaAnalytics Interaction Details]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` 已從實驗更新為 `stable`。 |
| 欄位群組 | [[!UICONTROL Media Interaction Details]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` 已從 `stable` 更新為 `deprecated`。 |
| 資料類型 | [[!UICONTROL Session details information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` 已從 `experimental` 更新為 `stable`。 |
| 資料類型 | [[!UICONTROL Qoe Data details information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` 已從 `experimental` 更新為 `stable`。 |
| 資料類型 | [[!UICONTROL Player state data information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` 已從 `experimental` 更新為 `stable`。 |
| 資料類型 | [[!UICONTROL Media event information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` 已從 `experimental` 更新為 `stable`。 |
| 資料類型 | [[!UICONTROL Media details information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` 已從 `experimental` 更新為 `stable`。 |
| 資料類型 | [[!UICONTROL Error details information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` 已從 `experimental` 更新為 `stable`。 |
| 資料類型 | [[!UICONTROL Error details information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` 已從 `stable` 更新為 `deprecated`。 |
| 資料類型 | [[!UICONTROL Custom metadata details information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` 已從 `experimental` 更新為 `stable`。 |
| 資料類型 | [[!UICONTROL Chapter details information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` 已從 `experimental` 更新為 `stable`。 |
| 資料類型 | [[!UICONTROL Advertising Pod details information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` 已從 `experimental` 更新為 `stable`。 |
| 資料類型 | [[!UICONTROL Advertising details information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` 已從 `experimental` 更新為 `stable`。 |
| 擴充功能 (客戶歷程管理) | [[!UICONTROL Domain]](https://github.com/adobe/xdm/pull/1756/files) | `Domain`欄位已新增到[!UICONTROL Adobe CJM ExperienceEvent - Message Profile Details]以記錄收件者電子郵件地址的網域。 |
| 擴充功能 (客戶歷程管理) | [[!UICONTROL Channel's variant Name]](https://github.com/adobe/xdm/pull/1753/files) | 此欄位已新增到[!UICONTROL AJO Entity Fields]以代表頻道變體名稱。 |
| 擴充功能 (Adobe Analytics) | [[!UICONTROL Context value]](https://github.com/adobe/xdm/pull/1761/files) | `Context value` 已新增至 [!UICONTROL `Adobe Analytics ExperienceEvent Full Extension`]。 |
