...
| [[!DNL Amazon S3] 更新](../../destinations/catalog/cloud-storage/amazon-s3.md#changelog) | 已更新 | 透過此更新，目的地會提供增強的檔案匯出功能並支援 [!BADGE Beta]{type=Informative}資料集匯出。 |
| [[!DNL Azure Blob] 更新](../../destinations/catalog/cloud-storage/azure-blob.md#changelog) | 已更新 | 透過此更新，目的地會提供增強的檔案匯出功能並支援 [!BADGE Beta]{type=Informative}資料集匯出。 |
| [[!DNL SFTP] 更新](../../destinations/catalog/cloud-storage/sftp.md#changelog) | 已更新 | 透過此更新，目的地會提供增強的檔案匯出功能並支援 [!BADGE Beta]{type=Informative}資料集匯出。 |
...
| 功能 | 說明 |
| ------- | ----------- |
| Audience Portal | Audience Portal 會提供在 Adobe Experience Platform 中存取、建立和管理對象的全新瀏覽體驗。在 Audience Portal 中，您可以檢視 Platform 產生的對象和外部產生的對象；透過篩選、資料夾和標記提高您的工作效率；建立 Platform 產生的對象；並透過 CSV 檔案匯入外部產生的對象。如需對象入口網站的詳細資訊，請參閱 [Audience Portal概述](../../segmentation/ui/audience-portal.md). |
