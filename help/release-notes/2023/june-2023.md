...
| 元件類型 | 名稱 | 說明 |
| --- | --- | --- |
| 擴充功能（潛在客戶 — 設定檔） | [[!UICONTROL Adobe 統一設定檔服務潛在客戶設定檔聯合擴充功能]](https://github.com/adobe/xdm/pull/1735/files) | 已新增潛在客戶設定檔聯合結構的必填欄位。 |
...
| [!BADGE 測試版]{type=Informative}支援 [!DNL RainFocus] | 您現在可以使用 [!DNL RainFocus] 來源整合，將事件管理和分析資料從您的 [!DNL RainFocus] 帳戶帶到 Experience Platform。如需詳細資訊，請閱讀 [[!DNL RainFocus]  來源概觀](../../sources/connectors/analytics/rainfocus.md)。 |
