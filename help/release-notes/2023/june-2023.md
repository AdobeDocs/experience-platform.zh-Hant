...
| 欄位群組 | [[!UICONTROL 輪廓合作夥伴擴充 (範例)]](https://github.com/adobe/xdm/pull/1747/files) | 已新增輪廓合作夥伴擴充的範例綱要。 |
| 欄位群組 | [[!UICONTROL 合作夥伴前景的詳細資料 (範例)]](https://github.com/adobe/xdm/pull/1747/files) | 已新增資料廠商前景輪廓擴充功能的範例綱要。 |
...
| 擴充功能 | [[!UICONTROL Adobe 統一輪廓服務帳戶聯合擴充功能]](https://github.com/adobe/xdm/pull/1731/files) | 身分對應已新增至 [!UICONTROL Adobe 統一輪廓服務帳戶聯合擴充功能]。 |
