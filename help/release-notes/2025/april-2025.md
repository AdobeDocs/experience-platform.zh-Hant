...
- **改善對 LiveRamp 載入失敗的 SFTP 傳輸的處理方式**\
...
| 功能 | 說明 |
| ------- | ----------- |
| 匿名設定檔資料到期 | 在「個人資料」儀錶板中管理您的假名設定檔數據過期。 若要了解有關此功能和匿名輪廓的詳細資訊，請閱讀[匿名輪廓資料期限指南](../../profile/pseudonymous-profiles.md)。 |
