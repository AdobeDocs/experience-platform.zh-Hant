...
| 其他識別碼支援[Facebook](../../destinations/catalog/social/facebook.md#supported-identities)目的地 | [!DNL Facebook]目的地現在支援新位址相關欄位的對應，以改進目標定位並與Facebook屬性上的設定檔進行比對。 如需新位址相關欄位的詳細資訊，請參閱[支援的身分](../../destinations/catalog/social/facebook.md#supported-identities)區段。<br> 顯示Facebook其他欄位的![平台UI影像。](assets/june/facebook-destination-fields.png "顯示Facebook其他欄位的Platform UI影像。"){width="200" align="center" zoomable="yes"} |
