...
| 來源 | 說明 |
| --- | --- |
| [!BADGE 的]{type=Informative}Beta[!DNL Didomi]支援(串流SDK) | 使用[!DNL Didomi]來源從[!DNL Didomi]擷取同意和偏好設定管理資料，以支援遵守隱私權法規及同意型行銷策略。 如需如何取得設定的詳細資訊，請閱讀[[!DNL Didomi] 來源概觀](../../sources/connectors/consent-and-preferences/didomi.md)。 如需建立來源連線的步驟，請閱讀[[!DNL Didomi] 來源連線指南](../../sources/tutorials/ui/create/consent-and-preferences/didomi.md)。 |
