...
| 功能 | 說明 |
| ------- | ----------- |
| 匯出儀表板資料許可權 | 儀表板中的&#x200B;**[!UICONTROL 下載CSV]**&#x200B;和&#x200B;**[!UICONTROL 以電子郵件傳送]**&#x200B;選項現在需要&#x200B;**[!UICONTROL 匯出儀表板資料]**&#x200B;許可權。 此許可權可確保只有授權的使用者才能匯出清單化insight資料，支援更嚴格的控管和資料存取控制原則。 如需詳細資訊，請參閱存取控制指南](../../access-control/home.md#permissions)的[許可權區段。 |
