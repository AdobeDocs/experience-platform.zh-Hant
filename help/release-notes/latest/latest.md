...
| [[!DNL Azure Data Lake Storage Gen2]](../../destinations/catalog/cloud-storage/adls-gen2.md) | 新增 | 建立與 [!DNL Azure Data Lake Storage Gen2] 的即時輸出連線，定期將資料檔案從 Adobe Experience Platform 匯出至您自己的儲存位置。這個新目的地可提供更強的檔案匯出功能並支援 [!BADGE Beta]{type=Informative} |
| [[!DNL Data Landing Zone]](../../destinations/catalog/cloud-storage/data-landing-zone.md) | 新增 | [!DNL Data Landing Zone] 是一個由 Adobe Experience Platform 提供所需的 [!DNL Azure Blob] 儲存介面，可授權您存取安全、雲端式檔案儲存設施，並讓您將檔案匯出至平台之外。這個新目的地可提供更強的檔案匯出功能並支援 [!BADGE Beta]{type=Informative} |
| [[!DNL Google Cloud Storage]](../../destinations/catalog/cloud-storage/google-cloud-storage.md) | 新增 | 建立與 [!DNL Google Cloud Storage] 的即時輸出連線，定期將資料檔案從 Adobe Experience Platform 匯出至您自己的貯體。這個新目的地可提供更強的檔案匯出功能並支援 [!BADGE Beta]{type=Informative} |
| [[!DNL Amazon S3] 更新](../../destinations/catalog/cloud-storage/amazon-s3.md#changelog) | 已更新 | 進行這次更新後，目的地可提供更強的檔案匯出功能並支援 [!BADGE Beta]{type=Informative} |
| [[!DNL Azure Blob] 更新](../../destinations/catalog/cloud-storage/azure-blob.md#changelog) | 已更新 | 進行這次更新後，目的地可提供更強的檔案匯出功能並支援 [!BADGE Beta]{type=Informative} |
| [[!DNL SFTP] 更新](../../destinations/catalog/cloud-storage/sftp.md#changelog) | 已更新 | 進行這次更新後，目的地可提供更強的檔案匯出功能並支援 [!BADGE Beta]{type=Informative} |
...
| 計算統計數據的別名 | 現在，您可以提供別名以描述方式來引用 SQL 查詢中計算統計數據的結果。有關此更新以及 COMPUTE STATISTICS 命令的其他更新資訊，請參閱文件。如需詳細資訊，請參閱[文件](../../query-service/essential-concepts/dataset-statistics.md#alias-name)。 |
...
| 功能 | 說明 |
| ------- | ----------- |
| Audience Portal | Audience Portal 會提供在 Adobe Experience Platform 中存取、建立和管理對象的全新瀏覽體驗。在 Audience Portal 中，您可以檢視 Platform 產生的對象和外部產生的對象；透過篩選、檔案夾和標記提高您的工作效率；建立 Platform 產生的對象；並透過 CSV 檔案匯入外部產生的對象。如需有關 Audience Portal 的詳細資訊，請詳閱 [Segmentation Service UI 指南](../../segmentation/ui/overview.md)。 |
