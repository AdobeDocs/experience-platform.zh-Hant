...
| 類型 | 功能 | 說明 |
| --- | --- | --- |
| Insights | [!DNL Acxiom] 匿名訪客分析 | 探索您的網站訪客來自何處 [!DNL Acxiom's] 訪客分析。 我們利用地理IP查詢技術，精準找出匿名瀏覽器的位置。 在識別之後，在組織好的資料庫中快速搜尋會產生其他深入分析，並傳回給瀏覽器。 對內容創作者而言，這是量身打造其內容，以符合這些資料點的黃金機會，即使訪客一開始是陌生人，也能提供更個人化且吸引人的體驗。 |
