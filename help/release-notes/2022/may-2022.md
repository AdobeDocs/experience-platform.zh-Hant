...
| 與資料流整合 | 使用Platform中的來源目錄來存取您的PlatformEdge Network資料，包括資料收集的資料準備以及改善對資料準備警告的支援。 請參閱 [Adobe資料收集來源概觀](../../sources/connectors/adobe-applications/data-collection.md) 以取得詳細資訊。 |
...
| 支援Adobe資料收集 | 使用Platform中的來源目錄來存取您的PlatformEdge Network資料，包括資料收集的資料準備以及改善對資料準備警告的支援。 請參閱 [Adobe資料收集來源概觀](../../sources/connectors/adobe-applications/data-collection.md) 以取得詳細資訊。 |
