...
## 在CDP B2B中，主導到帳戶匹配(#lead到帳戶匹配)

B2B企業通常將客戶資訊儲存在多個系統中，每個系統都只包含同一真實業務實體的部分甚至衝突資料。 這就帶來了一個巨大的挑戰，即要準確地瞭解客戶的情況，從而降低其B2B營銷和銷售工作的效率和效率。 隨著銷售線索與帳戶匹配的發佈，CDP B2B將已知人員配置檔案與帳戶配置檔案進行匹配，以便能夠用B2B上下文資料（如帳戶、機會等）分段和定位這些配置檔案。

閱讀以下文檔頁中有關該功能的詳細資訊：

- [在CDP B2B中導致帳戶匹配](../../rtcdp/b2b-ai-ml-services/lead-to-account-matching.md)
- [在監控器配置檔案富集指南中導出帳戶匹配配置檔案富集](../../dataflows/ui/b2b/monitor-profile-enrichment.md)
