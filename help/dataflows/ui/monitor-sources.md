...
登入 [Experience Platform UI](https://platform.adobe.com) ，然後從左側導覽中選 **[!UICONTROL 取Sources]** ，以存取 [!UICONTROL Sources] 工作區。 從頂 **[!UICONTROL 部標題中]** ，選擇資料流以查看現有資料流。
...
有關監視資料流和接收的詳細資訊，請參閱監視流資料流 [的教程](../../ingestion/quality/monitor-data-ingestion.md)。
