...
## 監視串流客群量度 {#streaming-audience-metrics}
...
>title="P95 攝取延遲"
>abstract="此量度會測量到達 Adobe Experience Platform 之事件的第 95 個百分位數延遲，藉以成功評估客群。"
>text="Learn more in documentation"
...
| 失敗的記錄 | 在串流區段中由於所選時間範圍內的錯誤而進行&#x200B;**失敗**&#x200B;評估的記錄總數。 | 資料集，流量執行 |
