...
在Experience Platform UI中，選取左側導覽中的&#x200B;**[!UICONTROL Profiles]**&#x200B;以開啟顯示設定檔儀表板的&#x200B;**[!UICONTROL Overview]**&#x200B;標籤。

>[!NOTE]
>
>如果您的組織剛開始使用Experience Platform，但尚未建立作用中的設定檔資料集或合併原則，則不會顯示[!UICONTROL Profiles]儀表板。 [!UICONTROL Overview]索引標籤反而會顯示連結和檔案，協助您開始使用即時客戶個人檔案。
...
### 依[!UICONTROL Merge policy]瀏覽

根據預設，**[!UICONTROL Browse]**&#x200B;索引標籤會設定為您的組織的預設合併原則。 若要選擇不同的合併原則，請選取合併原則名稱旁的`X`，然後使用選取器開啟&#x200B;**[!UICONTROL Select merge policy]**&#x200B;對話方塊。

>[!NOTE]
>
>如果未選取合併原則，請使用&#x200B;**[!UICONTROL Merge policy]**&#x200B;欄位旁的選擇器按鈕來開啟選取對話方塊。

![合併原則選擇器已反白顯示。](../images/user-guide/browse-by-merge-policy.png)

若要從&#x200B;**[!UICONTROL Select merge policy]**&#x200B;對話方塊選擇合併原則，請選取原則名稱旁的單選按鈕，然後使用&#x200B;**[!UICONTROL Select]**&#x200B;返回[!UICONTROL Browse]索引標籤。 然後，您可以選取&#x200B;**[!UICONTROL View]**&#x200B;以重新整理範例設定檔，並檢視套用新合併原則的設定檔樣本。
...
若要檢視其中一個範例設定檔的詳細資料，請選取&#x200B;**[!UICONTROL Profile ID]**。 如需詳細資訊，請參閱本指南稍後關於[檢視設定檔詳細資料](#profile-detail)的章節。
...
### 依[!UICONTROL Identity]瀏覽 {#browse-identity}

在&#x200B;**[!UICONTROL Browse]**&#x200B;標籤上，您可以使用身分名稱空間，以依身分值查詢特定設定檔。 依身分瀏覽需要您提供合併原則、身分名稱空間和身分值。

![合併原則選擇器已反白顯示。](../images/user-guide/browse-by-merge-policy.png)

如有必要，請使用&#x200B;**[!UICONTROL Merge policy]**&#x200B;選擇器開啟&#x200B;**[!UICONTROL Select merge policy]**&#x200B;對話方塊，並選擇要使用的合併原則。

![會顯示一個對話方塊，您可在其中選取要篩選的合併原則。](../images/user-guide/select-merge-policy.png)

然後使用&#x200B;**[!UICONTROL Identity namespace]**&#x200B;選取器開啟&#x200B;**[!UICONTROL Select identity namespace]**&#x200B;對話方塊，並選擇您要搜尋的名稱空間。 如果您的組織有許多名稱空間，您可以使用對話方塊中的搜尋列，開始輸入名稱空間的名稱。

您可以選取名稱空間以檢視其他詳細資訊，或選取選項按鈕以選擇名稱空間。 然後您可以使用&#x200B;**[!UICONTROL Select]**&#x200B;繼續。

![會顯示一個對話方塊，您可在其中選取要篩選的身分名稱空間。](../images/user-guide/select-identity-namespace.png)

選取[!UICONTROL Identity namespace]並返回[!UICONTROL Browse]索引標籤後，您可以輸入與您選取的名稱空間相關的&#x200B;**[!UICONTROL Identity value]**。
...
輸入值之後，選取&#x200B;**[!UICONTROL View]**&#x200B;並傳回符合值的單一設定檔。 選取&#x200B;**[!UICONTROL Profile ID]**&#x200B;以檢視設定檔。
...
選取&#x200B;**[!UICONTROL Profile ID]**&#x200B;後，**[!UICONTROL Detail]**&#x200B;索引標籤會開啟。 **[!UICONTROL Detail]**&#x200B;標籤上顯示的設定檔資訊已從多個設定檔片段合併在一起，以形成個別客戶的單一檢視。 這包括基本屬性、連結的身分和管道偏好設定等客戶細節。
...
**[!UICONTROL Customer profile insights]**&#x200B;區段會顯示設定檔屬性的簡短簡介。 這包括設定檔ID、電子郵件、電話號碼、性別、出生日期，以及設定檔的身分和對象會籍。
...
>[!IMPORTANT]
>
>如果您是Healthcare Shield客戶，您將&#x200B;**無法**&#x200B;使用AI insight Widget。

**[!UICONTROL AI insight widgets]**&#x200B;區段會顯示AI產生的Widget。 這些介面工具會根據設定檔資料，包括人口統計（例如年齡、性別或位置）、使用者行為（例如購買記錄、網站活動或社群媒體參與）以及心理變數（例如興趣、偏好或生活方式選擇），提供對設定檔的快速深入分析。 所有AI Widget都使用設定檔中已&#x200B;**存在**&#x200B;的資料。

![顯示AI insight Widget區段。](../images/user-guide/ai-insight-widgets.png)

#### 可自訂的小工具 {#customizable-widgets}

**[!UICONTROL Customizable widgets]**&#x200B;區段顯示您可自訂以符合業務需求的Widget。 您可以將屬性群組至個別的Widget、移除不要的Widget，或調整Widget的配置。
...
您也可以選擇在檢視屬性名稱作為其顯示名稱與其欄位路徑名稱之間切換。 若要在這兩個顯示之間切換，請選取&#x200B;**[!UICONTROL Show display names]**&#x200B;切換按鈕。

![顯示名稱切換已反白顯示。](../images/user-guide/show-display-names.png)

#### 自動分類的小工具 {#auto-classified-widgets}

**[!UICONTROL Auto-classified widgets]**&#x200B;區段顯示的小工具可運用聯合結構描述來判斷屬性所屬的來源欄位群組，提供更清楚的資料來源內容。 您可以使用搜尋列更輕鬆地在Widget中尋找關鍵字。
...
**[!UICONTROL Attributes]**&#x200B;索引標籤提供清單檢視，在套用指定的合併原則之後，彙總與單一設定檔相關的所有屬性。

也可以選取&#x200B;**[!UICONTROL View JSON]**，將這些屬性檢視為JSON物件。 對於想更瞭解如何將設定檔屬性擷取到Experience Platform的使用者，此功能會很有幫助。
...
**[!UICONTROL Audience membership]**&#x200B;索引標籤會顯示清單，其中包含個別客戶設定檔目前所屬對象的名稱和說明。 當設定檔符合對象資格或過期時，此清單會自動更新。 設定檔目前符合資格的受眾總數會顯示在索引標籤的右側。
...
從主要&#x200B;**[!UICONTROL Profiles]**&#x200B;功能表中選取&#x200B;**[!UICONTROL Merge Policies]**&#x200B;標籤，以檢視屬於您組織的合併原則清單。 每個列出的原則都會顯示其名稱（無論是否為預設的合併原則）及其套用的結構描述類別。
...
從主要&#x200B;**[!UICONTROL Profiles]**&#x200B;功能表中，選取&#x200B;**[!UICONTROL Union Schema]**&#x200B;索引標籤以檢視您擷取資料的可用聯合結構描述。 聯合結構描述是相同類別下所有[!DNL Experience Data Model] (XDM)欄位的合併，其結構描述已在[!DNL Real-Time Customer Profile]中啟用。
...
從主要&#x200B;**[!UICONTROL Profiles]**&#x200B;功能表中選取&#x200B;**[!UICONTROL Computed attributes]**&#x200B;標籤，以檢視屬於您組織的計算屬性清單。
