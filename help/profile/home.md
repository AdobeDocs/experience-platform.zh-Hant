...
每家企業都想以個人化的方式與客戶溝通。 不過，為客戶提供相關數位體驗的其中一項挑戰，是瞭解如何將互不相連的資料連結在一起，這通常會跨不同的數位通道（例如平板電腦、行動電話和筆記型電腦）傳播。 [!DNL Identity Service] 可讓您從多個通道連結身分，為每位客戶建立身份圖表，以便更好地瞭解客戶，從而將客戶的完整形象拼湊在一起。 如需詳細 [資訊，請造訪Identity Service](../identity-service/home.md) 總覽。
