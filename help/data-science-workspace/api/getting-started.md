...
本開發人員指南提供步驟，協助您開始使用[Sensei Machine Learning API](https://developer.adobe.com/experience-platform-apis/references/sensei-machine-learning/)，並示範在各種資料科學Workspace資源上執行CRUD作業的API呼叫。
