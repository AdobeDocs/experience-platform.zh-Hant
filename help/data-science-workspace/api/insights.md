...
可以通過對見解終結點執行單個GET 要求來檢索Insights清單。  為了幫助篩選結果，您可以在請求路徑中指定查詢參數。 有關可用查詢的清單，請参閱有關資產檢索](./appendix.md#query)的查詢参数的[附錄部分。
...
若要查找特定分析請進行GET 要求並在請求路徑中提供有效 `{INSIGHT_ID}` 。 為了幫助篩選結果，您可以在請求路徑中指定查詢參數。 有關可用查詢的清單，請参閱有關資產檢索](./appendix.md#query)的查詢参数的[附錄部分。
