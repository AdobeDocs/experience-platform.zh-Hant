...
type: Tutorial
description: 本教學課程向insight說明如何使用提供的零售範例來設定和匯入封裝的配方。 在本教學課程結束時，您已準備好在Adobe Experience Platform資料科學Workspace中建立、訓練及評估模型。
...
本教學課程向insight說明如何使用提供的零售範例來設定和匯入封裝的配方。 在本教學課程結束時，您已準備好在Adobe Experience Platform [!DNL Data Science Workspace]中建立、訓練及評估模型。
...
首先，瀏覽並選取位於&#x200B;**[!UICONTROL Workflows]** UI左上角的[!DNL Experience Platform]。 接著，選取&#x200B;**匯入配方**&#x200B;並選取&#x200B;**[!UICONTROL Launch]**。

![](../images/models-recipes/import-package-ui/launch-import.png)

**匯入配方**&#x200B;工作流程的&#x200B;**設定**&#x200B;頁面隨即顯示。 輸入配方的名稱和說明，然後在右上角選取&#x200B;**[!UICONTROL Next]**。
...
一旦您進入&#x200B;**選取來源**&#x200B;頁面，請在[!DNL Python]欄位中貼上對應使用&#x200B;**[!UICONTROL Source URL]**&#x200B;來源檔案建置之封裝配方的Docker URL。 接著，拖放匯入提供的組態檔，或使用檔案系統&#x200B;**瀏覽器**。 提供的組態檔可在`experience-platform-dsw-reference/recipes/python/retail/retail.config.json`找到。 在&#x200B;**[!UICONTROL Python]**&#x200B;執行階段&#x200B;**下拉式清單中選取**，並在&#x200B;**[!UICONTROL Classification]**&#x200B;型別&#x200B;**下拉式清單中選取**。 填寫完畢後，選取右上角的&#x200B;**[!UICONTROL Next]**&#x200B;以繼續進行&#x200B;**管理結構描述**。

>[!NOTE]
>
> 型別支援&#x200B;**[!UICONTROL Classification]**&#x200B;和&#x200B;**[!UICONTROL Regression]**。 如果您的模型不屬於其中一種型別，請選取&#x200B;**[!UICONTROL Custom]**。
...
在&#x200B;**功能管理**&#x200B;區段下，在結構描述檢視器中選取租使用者識別以展開零售銷售輸入結構描述。 反白所需的功能，然後在右側&#x200B;**[!UICONTROL Input Feature]**&#x200B;視窗中選取&#x200B;**[!UICONTROL Target Feature]**&#x200B;或&#x200B;**[!UICONTROL Field Properties]**，以選取輸入和輸出功能。 在本教學課程中，請將&#x200B;**[!UICONTROL weeklySales]**&#x200B;設為&#x200B;**[!UICONTROL Target Feature]**，並將其他專案設為&#x200B;**[!UICONTROL Input Feature]**。 選取&#x200B;**[!UICONTROL Next]**&#x200B;以檢閱您新設定的配方。

視需要檢閱配方、新增、修改或移除設定。 選取&#x200B;**[!UICONTROL Finish]**&#x200B;以建立配方。
...
進入&#x200B;**選取來源**&#x200B;頁面後，在&#x200B;**[!UICONTROL Source URL]**&#x200B;欄位中貼上與R來源檔案建置之封裝配方相對應的Docker URL。 接著，拖放匯入提供的組態檔，或使用檔案系統&#x200B;**瀏覽器**。 提供的組態檔可在`experience-platform-dsw-reference/recipes/R/Retail\ -\ GradientBoosting/retail.config.json`找到。 在&#x200B;**[!UICONTROL R]**&#x200B;執行階段&#x200B;**下拉式清單中選取**，並在&#x200B;**[!UICONTROL Classification]**&#x200B;型別&#x200B;**下拉式清單中選取**。 填寫完畢後，選取右上角的&#x200B;**[!UICONTROL Next]**&#x200B;以繼續進行&#x200B;**管理結構描述**。

>[!NOTE]
>
> *型別*&#x200B;支援&#x200B;**[!UICONTROL Classification]**&#x200B;和&#x200B;**[!UICONTROL Regression]**。 如果您的模型不屬於其中一種型別，請選取&#x200B;**[!UICONTROL Custom]**。
...
**匯入配方**&#x200B;工作流程的&#x200B;**設定**&#x200B;頁面隨即顯示。 輸入配方的名稱和說明，然後在右上角選取&#x200B;**[!UICONTROL Next]**&#x200B;以繼續。
...
進入&#x200B;**選取來源**&#x200B;頁面後，在&#x200B;**[!UICONTROL Source URL]**&#x200B;欄位中貼上與PySpark來源檔案建置的封裝配方相對應的Docker URL。 接著，拖放匯入提供的組態檔，或使用檔案系統&#x200B;**瀏覽器**。 提供的組態檔可在`experience-platform-dsw-reference/recipes/pyspark/retail/pipeline.json`找到。 在&#x200B;**[!UICONTROL PySpark]**&#x200B;執行階段&#x200B;**下拉式清單中選取**。 選取PySpark執行階段後，預設成品會自動填入&#x200B;**[!UICONTROL Docker]**。 接下來，在&#x200B;**[!UICONTROL Classification]**&#x200B;型別&#x200B;**下拉式清單中選取**。 填寫完畢後，選取右上角的&#x200B;**[!UICONTROL Next]**&#x200B;以繼續進行&#x200B;**管理結構描述**。
...
進入&#x200B;**選取來源**&#x200B;頁面後，在Source URL欄位中貼上與Scala來源檔案建置的封裝配方相對應的Docker URL。 接著，以拖放方式匯入提供的組態檔案，或使用檔案系統「瀏覽器」。 提供的組態檔可在`experience-platform-dsw-reference/recipes/scala/retail/pipelineservice.json`找到。 在&#x200B;**[!UICONTROL Spark]**&#x200B;執行階段&#x200B;**下拉式清單中選取**。 選取[!DNL Spark]執行階段後，預設成品會自動填入&#x200B;**[!UICONTROL Docker]**。 接下來，從&#x200B;**[!UICONTROL Regression]**&#x200B;型別&#x200B;**下拉式清單中選取**。 填寫完畢後，選取右上角的&#x200B;**[!UICONTROL Next]**&#x200B;以繼續進行&#x200B;**管理結構描述**。
...
此教學課程提供設定配方並將配方匯入[!DNL Data Science Workspace]的insight。 您現在可以使用新建立的配方來建立、訓練及評估模型。
