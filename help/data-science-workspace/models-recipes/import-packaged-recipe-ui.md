...
將打包的方式 [!DNL Data Science Workspace] 導入到需要特定的方式配置，編譯成單個JavaScript物件表示法（JSON）檔，這種方式配置的編譯稱為配置檔。 具有一組特定配置的打包方式稱為方式 執行個體。 一個 方式 可用於在 中創建 [!DNL Data Science Workspace]多個方式例項。
...
| `ACP_DSW_FEATURE_UPDATE_SUPPORT` | 布林值 | 確定輸入和輸出要素是否可修改 |
| `tenantId` | 字串 | 此 ID 可確保您建立的資源已正確設置命名空間並包含在組織中。 [按照此處](../../xdm/api/getting-started.md#know-your-tenant_id) 的步驟查找租戶ID。 |
| `ACP_DSW_TRAINING_XDM_SCHEMA` | 字串 | 用於培訓模型的輸入綱要。 在UI中匯入時，請將此項留空；使用API匯入時，請以培訓SchemaID取代。 |
...
此時將显示匯入 方式&#x200B;****&#x200B;工作流程&#x200B;**的配置**&#x200B;頁面。輸入方式的名稱和描述，然後選擇 **[!UICONTROL 右上角的下一個]** 。

![設定工作流程](../images/models-recipes/import-package-ui/configure-workflow.png)

>[!NOTE]
>
> 在將 [源文件打包到配方](./package-source-files-recipe.md) 教學課程中，在使用 Python 源文件構建零售銷售方式結束時提供了一個 Docker URL。

進入“**選擇源**”頁面後，在“來源 URL”字段中粘貼&#x200B;**[!UICONTROL 與使用源文件生成的[!DNL Python]打包方式對應的 Docker URL]**。下一個，通過拖放導入提供的配置檔，或使用文件系統 **瀏覽器**。 提供的配置檔可以在 中找到 `experience-platform-dsw-reference/recipes/python/retail/retail.config.json`。 在&#x200B;**執行階段**&#x200B;下拉式清單中選取&#x200B;**[!UICONTROL Python]**，並在&#x200B;**型別**&#x200B;下拉式清單中選取&#x200B;**[!UICONTROL 分類]**。 填寫完畢後，選取右上角的&#x200B;**[!UICONTROL 下一步]**&#x200B;以繼續進行&#x200B;**管理結構描述**。
...
>[!NOTE]
>
> 在將 [源文件打包到配方](./package-source-files-recipe.md) 教學課程中，在使用 R 源文件生成零售銷售方式結束時提供了 Docker URL。

進入“ **選擇源** ”頁面後，在“ **[!UICONTROL 來源 URL”字段中粘貼與使用 R 源文件生成的打包方式對應的 Docker URL]** 。 下一個，通過拖放導入提供的配置檔，或使用文件系統 **瀏覽器**。 提供的配置檔可以在 中找到 `experience-platform-dsw-reference/recipes/R/Retail\ -\ GradientBoosting/retail.config.json`。 在「運行時&#x200B;**」下拉清單中選擇“R]**”，在&#x200B;**[!UICONTROL “類型**”下拉列表中選擇&#x200B;**[!UICONTROL “分類]****”。**&#x200B;填寫完畢後，選取右上角的&#x200B;**[!UICONTROL 下一步]**&#x200B;以繼續進行&#x200B;**管理結構描述**。
...
開始方法是瀏覽並選擇&#x200B;**[!UICONTROL 位於UI左[!DNL Platform]上角的工作流]**。下一個，選擇“ **匯入 方式** ”，然後選擇“ **[!UICONTROL Launch]**”。
...
在“功能管理&#x200B;**”**&#x200B;部分下，選擇綱要 檢視者中的租戶標識以展開“零售銷售”輸入綱要。通過突出顯示所需要素並在右側字段窗口中選擇&#x200B;**[!UICONTROL 輸入要素或**[!UICONTROL  Target ]**要素來選擇輸入和]**&#x200B;輸出要素屬性&#x200B;]**。**[!UICONTROL &#x200B;在此教學課程中，請將&#x200B;**[!UICONTROL weeklySales]**&#x200B;設定為&#x200B;**[!UICONTROL 目標功能]**，並將其他專案設定為&#x200B;**[!UICONTROL 輸入功能]**。 選取&#x200B;**[!UICONTROL 下一步]**&#x200B;以檢閱您新設定的配方。
...
繼續執行 [後續步驟](#next-steps) ，瞭解如何使用新創建的零售銷售方式創建模型 [!DNL Data Science Workspace] 。
...
下一個，使用“管理架構&#x200B;**”選擇器選擇**“零售銷售”輸入和輸出架構，這些架構是使用“[創建零售銷售綱要和資料集](../models-recipes/create-retails-sales-dataset.md)教學課程中提供的引導腳本創建的。

![管理結構](../images/models-recipes/import-package-ui/manage-schemas.png)

在“功能管理&#x200B;**”**&#x200B;部分下，選擇綱要 檢視者中的租戶標識以展開“零售銷售”輸入綱要。通過突出顯示所需要素並在右側字段窗口中選擇&#x200B;**[!UICONTROL 輸入要素或**[!UICONTROL  Target ]**要素來選擇輸入和]**&#x200B;輸出要素屬性&#x200B;]**。**[!UICONTROL &#x200B;為此教學課程，請將“weeklySales]”設置為&#x200B;**[!UICONTROL Target功能]**，將其他所有內容設置為&#x200B;**[!UICONTROL 輸入功能]**。[!UICONTROL 選擇 **[!UICONTROL 下一個]** 以查看新配置的方式。
