...
type: Tutorial
description: 本教程為您提供了所有其他Adobe Experience Platform資料科學工作區教程所需的先決條件和資產。 完成後，您和您的IMS組織成員將可以使用零售銷售模式和資料集進行Experience Platform。
...
本教程為您提供所有其他元件所需的必備元件和資產 [!DNL Adobe Experience Platform] [!DNL Data Science Workspace] 教程。 完成後，您和IMS組織的成員將可以使用零售銷售模式和資料集 [!DNL Experience Platform]。

## 快速入門

在啟動本教程之前，您必須具備以下先決條件：
- 訪問 [!DNL Adobe Experience Platform]。 如果您沒有訪問中的IMS組織 [!DNL Experience Platform]，請在繼續之前與系統管理員聯繫。
