...
本檔案提供有關Adobe Experience Platform [!DNL Data Science Workspace]常見問題的解答。 如需[!DNL Platform] API的一般問題和疑難排解，請參閱[Adobe Experience Platform API疑難排解指南](../landing/troubleshooting.md)。
...
很遺憾，您無法為PySpark核心安裝其他程式庫。 不過，您可以聯絡您的Adobe客戶服務代表，為您安裝自訂PySpark程式庫。
