...
當您在一個沙箱中建立並發佈Playbook時，它會自動在您組織內的所有沙箱中變得可用。 如此一來，您就不需要手動共用，並可順暢地在任何其他沙箱中建立Playbook例項。

>[!TIP]
>
>如果Playbook參考的欄位在目標沙箱的聯合結構描述中不可用或缺少必要許可權，您在嘗試建立執行個體時可能會看到錯誤訊息。 該訊息會呼叫缺少的欄位和/或缺少的許可權。
