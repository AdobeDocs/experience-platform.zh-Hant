...
* API教學課程{#api}
   * [使用API呼叫連線至串流目的地並啟用資料](./api/streaming-destinations.md)
   * [連線至電子郵件行銷目標，並使用API呼叫啟用資料](./api/email-marketing.md)
* UI指南{#ui}
   * [目標工作區概觀](./ui/destinations-workspace.md)
...
* 目標目錄{#catalog}
   ...
   * 社交網路目的地{#social}
      ...
      * [Facebook擴充功能](./catalog/social/facebook.md)
   * 調查目標{#survey}
