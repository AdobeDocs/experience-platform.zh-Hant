...
* 目標目錄{#catalog}
   ...
   * 廣告目的地{#advertising}
      ...
      * [Awin廣告轉換標籤](./catalog/advertising/awin-conversiontag.md)
      * [Awin Advertising Mastertag](./catalog/advertising/awin-mastertag.md)
      * [Bing Ads通用事件追蹤](./catalog/advertising/bing-ads.md)
      ...
      * [Google廣告（延伸功能）](./catalog/advertising/google-ads-extension.md)
      * [Google廣告管理員](./catalog/advertising/google-ad-manager.md)
      ...
      * [LinkedIn Insight標籤](./catalog/advertising/linkedin.md)
      * [Microsoft Bing](./catalog/advertising/bing.md)
      * [Pinterest轉換追蹤](./catalog/advertising/pinterest.md)
      * [貿易部門](./catalog/advertising/tradedesk.md)
      * [Twitter通用網站標籤](./catalog/advertising/twitter-uwt.md)
   * Analytics目標{#analytics}
      * [概述](./catalog/analytics/overview.md)
      * [Adform網站追蹤](./catalog/analytics/adform.md)
      * [Adobe Analytics](./catalog/analytics/adobe-analytics.md)
      * [音訊和視訊專用的Adobe Media Analytics](./catalog/analytics/adobe-video-analytics.md)
      * [Clicktale](./catalog/analytics/clicktale.md)
      * [Contentsquare](./catalog/analytics/contentsquare.md)
      * [分貝](./catalog/analytics/decibel.md)
      * [Demandbase](./catalog/analytics/demandbase.md)
      * [Dialogtech](./catalog/analytics/dialogtech.md)
      * [Google全域網站標籤分析](./catalog/analytics/gtag-analytics.md)
      * [Google Universal Analytics](./catalog/analytics/google-universal-analytics.md)
      * [JW Player分析（測試版）](./catalog/analytics/jw-player-analytics.md)
      * [Nielsen BSDK](./catalog/analytics/nielsen-bsdk.md)
      * [Nielsen IMA處理常式](./catalog/analytics/nielsen-ima.md)
      * [Nielsen VideoJS播放器處理常式](./catalog/analytics/nielsen-videojs.md)
      * [Parse.ly Analytics](./catalog/analytics/parsely.md)
      * [量子量度](./catalog/analytics/quantum-metric.md)
      * [SessionCam](./catalog/analytics/sessioncam.md)
      * [TMMData](./catalog/analytics/tmmdata.md)
      * [文字轉換追蹤](./catalog/analytics/yext.md)
   * 雲端儲存空間目標{#cloud-storage}
      ...
      * [Azure事件集線器](./catalog/cloud-storage/azure-event-hubs.md)
   ...
   * 電子郵件目標{#email}
      * [Bizbile Analytics](./catalog/email/bizible.md)
   ...
   * 電子郵件行銷目標{#email-marketing}
      ...
      * [Oracle Exovila](./catalog/email-marketing/oracle-eloqua.md)
   ...
   * 行動參與目標{#mobile-engagement}
      ...
      * [飛艇屬性](./catalog/mobile-engagement/airship-attributes.md)
      * [飛艇標籤](./catalog/mobile-engagement/airship-tags.md)
      * [佈雷茲](./catalog/mobile-engagement/braze.md)
   * 個人化目標{#personalization}
      ...
      * [貝姆雷](./catalog/personalization/beemray.md)
   ...
   * 調查目標{#survey}
      ...
      * [Qualtrics網站意見回應](./catalog/survey/qualtrics.md)
      * [Web截距調查- QuestionPro](./catalog/survey/web-intercept-surveys.md)
   * 客戶目標語音{#voice}
      * [概述](./catalog/voice/overview.md)
      * [確認數位意見回應](./catalog/voice/confirmit-digital-feedback.md)
