...
* 目的地如何運作 {#how-destinations-work}
   ...
   * [串流目的地的對象生命週期](./how-destinations-work/audience-lifecycle-streaming-destinations.md)
* API教學課程 {#api}
...
* 目的地目錄 {#catalog}
   ...
   * Adobe目的地{#adobe}
      ...
      * [Marketo Engage人員同步連線](./catalog/adobe/marketo-engage-person-sync.md)
      * [Marketo Measure Ultimate連線](./catalog/adobe/marketo-measure-ultimate.md)
      * [Experience Platform受眾共用](https://experienceleague.adobe.com/docs/audience-manager/user-guide/implementation-integration-guides/integration-experience-platform/aam-aep-audience-sharing.html?lang=zh-Hant)
      * [同盟對象構成連線](https://www.adobe.com/go/destinations-federated-audience-composition)
   * Advertising目的地{#advertising}
      ...
      * [Adobe Advertising DSP連線](./catalog/advertising/adobe-advertising-dsp-connection.md)
      * [舊版Adobe Advertising DSP連線](./catalog/advertising/adobe-advertising-cloud-dsp-connection-legacy.md)
      * [Adobe Advertising擴充功能](./catalog/advertising/adobe-advertising-cloud.md)
      * [Adform連線](./catalog/advertising/adform.md)
      * [（舊版） Amazon Ads連線](./catalog/advertising/amazon-ads.md)
      * [Amazon Ads v2連線](./catalog/advertising/amazon-ads-v2.md)
      ...
      * {hide-from-toc}[(Beta) FreeWheel連線](./catalog/advertising/freewheel.md)
      ...
      * [索引Exchange連線](./catalog/advertising/index-exchange.md)
      * [Kevel連線](./catalog/advertising/kevel.md)
      ...
      * [Microsoft Ads Customer Match連線](./catalog/advertising/microsoft-ads-customer-match.md)
      ...
      * [(Beta) Reddit自訂對象連線](./catalog/advertising/reddit-custom-audience.md)
      * [Rokt連線](./catalog/advertising/rokt.md)
   ...
   * 倉儲目的地 {#warehouse}
      * [Snowflake批次連線](./catalog/warehouses/snowflake-batch.md)
      * [Snowflake串流連線](./catalog/warehouses/snowflake.md)
* Destination SDK {#destination-sdk}
   ...
   * 指南 {#guides}
      ...
      * 設定以檔案為基礎的目的地 {#configure-file-based-destinations}
         ...
         * [使用自訂檔案格式選項和自訂檔案名稱設定來設定Azure Blob儲存目標](../destinations/destination-sdk/guides/batch/configure-blob-destination-with-custom-file-formatting.md)
         * [使用自訂檔案格式選項和自訂檔案名稱設定來設定Azure Data Lake儲存目標](../destinations/destination-sdk/guides/batch/configure-adls-destination-with-custom-file-formatting.md)
