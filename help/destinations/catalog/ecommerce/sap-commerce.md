...
為協助您更清楚瞭解您應如何及何時使用[!DNL SAP Commerce]目的地，以下是[!DNL Adobe Experience Platform]客戶可以使用此目的地解決的範例使用案例。
...
* [!DNL SAP Commerce]服務金鑰可透過Experience Platform存取[!DNL SAP Subscription Billing] API。 檢視[!DNL SAP Commerce] [建立具有使用者端識別碼和使用者端密碼的服務金鑰](https://help.sap.com/docs/CLOUD_TO_CASH_OD/1216e7b79c984675b0a6f0005e351c74/87c11a0f5dc3494eaf3baa355925c030.html#create-a-service-key-with-client-id-and-client-secret)以建立服務金鑰。 [!DNL SAP Commerce] 需要下列項目:
   * 用戶端 ID
   * 用戶端密碼
...
如需其他指南，請參閱[!DNL SAP Subscription Billing] [自訂參考](https://help.sap.com/docs/CLOUD_TO_CASH_OD/80d121f216af43648e79664efe5595f7/85696a63c8d8453a934e86c9413a25cf.html?version=2023-11-27)檔案。
...
若要將您的對象資料從[!DNL Adobe Experience Platform]正確傳送至[!DNL SAP Commerce]目的地，您必須完成欄位對應步驟。 對應包括在Experience Platform帳戶中的Experience Data Model (XDM)結構描述欄位與來自目標目的地的對應對應專案之間建立連結。 若要將您的XDM欄位正確對應到[!DNL SAP Commerce]目的地欄位，請遵循下列步驟：
...
前往[!DNL SAP Subscription Billing]帳戶，然後導覽至&#x200B;**[!UICONTROL Contacts]**頁面以檢查對象狀態。 清單可設定為顯示自訂參考的欄，並顯示對應的對象狀態。
