---
keywords: 質量；質量；質量；網站反饋；質量；質量；網站反饋；質量
title: 質量網站反饋擴展
description: Qualtrics網站反饋擴展是Adobe Experience Platform的一個調查目的地。 有關擴展功能的詳細資訊，請參閱AdobeExchange上的擴展頁。
...
[!DNL Qualtrics Website Feedback] 使您能夠在適當的時間用正確的資訊與網站訪問者聯繫。 無論您是希望通過網站反饋調查來改善訪問者體驗，還是希望增加轉換， [!DNL Qualtrics Website Feedback] 已經掩護你了。

使用直觀的點擊式介面，在幾分鐘內建立和部署高度目標化的標籤Web消息。 您從您的網站收集到的資料和見解會與所有渠道的客戶反饋資料一起浮出水面，提供您客戶體驗的完整視圖 — 全部在一個平台上。

[!DNL Qualtrics Website Feedback] 是Adobe Experience Platform的調查延期。 有關擴展功能的詳細資訊，請參閱上的擴展頁 [AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html)。

此目標是標籤擴展。 有關標籤擴展在平台中如何工作的詳細資訊，請參見 [標籤擴展概述](../launch-extensions/overview.md)。

![質量網站反饋擴展](../../assets/catalog/survey/qualtrics/catalog.png)
...
安裝 [!DNL Qualtrics Website Feedback] 擴展：
...
有關擴展配置選項和安裝支援的資訊，請參見 [AdobeExchange上的質量網站反饋頁](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html)。
