---
keywords: Qualtrics;Qualtrics;Qualtrics網站意見；Qualtrics網站意見；Qualtrics網站意見
title: Qualtrics網站意見回饋擴充功能
description: Qualtrics網站意見回饋擴充功能是Adobe Experience Platform中的調查目的地。 如需擴充功能的詳細資訊，請參閱Exchange上的擴充功能頁面。
...
[!DNL Qualtrics Website Feedback] 可讓您在正確的時間，以正確的訊息吸引網站訪客。無論您是想要改善網站意見調查的訪客體驗，還是想增加轉換，[!DNL Qualtrics Website Feedback]都能涵蓋您。

使用直觀的點按式介面，在數分鐘內建立並部署目標明確、品牌化的Web訊息。 您從網站收集到的資料和深入分析會與所有管道的客戶意見資料一起呈現，提供客戶體驗的完整檢視（全部在單一平台上）。

[!DNL Qualtrics Website Feedback] 是Adobe Experience Platform中的調查擴充功能。如需擴充功能的詳細資訊，請參閱[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html)上的擴充功能頁面。

此目的地是標籤擴充功能。 如需有關標籤擴充功能在Platform中如何運作的詳細資訊，請參閱[標籤擴充功能概述](../launch-extensions/overview.md)。

![Qualtrics網站意見擴充功能](../../assets/catalog/survey/qualtrics/catalog.png)
...
要安裝[!DNL Qualtrics Website Feedback]擴展，請執行以下操作：
...
如需擴充功能設定選項和安裝支援的相關資訊，請參閱Exchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html)Adobe上的[Qualtrics網站意見頁面。
