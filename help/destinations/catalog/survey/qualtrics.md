...
[!DNL Qualtrics Website Feedback]是Adobe Experience Platform中的調查延伸模組。 如需有關擴充功能功能的詳細資訊，請參閱[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html)上的擴充功能頁面。
...
如需擴充功能組態選項和安裝支援的相關資訊，請參閱Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html)上的[Qualtrics網站意見回饋頁面。
