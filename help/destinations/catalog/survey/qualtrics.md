---
keywords: Qualtrics；Qualtrics；Qualtrics網站意見反應；Qualtrics網站意見反應；Qualtricks網站意見反應
title: Qualtrics網站意見回饋擴充功能
description: Qualtrics網站意見回饋擴充功能是Adobe Experience Platform中的調查目的地。 如需擴充功能的相關詳細資訊，請參閱Adobe交換上的擴充功能頁面。
...
[!DNL Qualtrics Website Feedback] 可讓您在適當的時間以適當的訊息吸引網站訪客。 無論您是要透過網站意見調查改善訪客體驗，還是要提高轉換率， [!DNL Qualtrics Website Feedback] 已為您提供保障。

使用直覺式的點選式介面，在幾分鐘內建立並部署高針對性的品牌網路訊息。 您從網站收集到的資料和深入分析會與所有管道的客戶意見回饋資料一起出現，提供您客戶體驗的完整檢視 — 所有這些都在一個平台上。

[!DNL Qualtrics Website Feedback] 是Adobe Experience Platform中的調查擴充功能。 如需擴充功能的相關詳細資訊，請參閱擴充功能頁面，網址為 [Adobe交換](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html).

此目的地是標籤延伸模組。 如需標籤擴充功能在Platform中如何運作的詳細資訊，請參閱 [標籤擴充功能概觀](../launch-extensions/overview.md).

![Qualtrics網站意見反應擴充功能](../../assets/catalog/survey/qualtrics/catalog.png)
...
若要安裝 [!DNL Qualtrics Website Feedback] 副檔名：
...
如需擴充功能組態選項和安裝支援的詳細資訊，請參閱 [Adobe Exchange上的Qualtrics網站意見回饋頁面](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html).
