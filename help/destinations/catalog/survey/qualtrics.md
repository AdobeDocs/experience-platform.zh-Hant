---
keywords: Qualtrics；Qualtrics；Qualtrics網站意見；Qualtrics網站意見；Qualtricks網站意見
title: Qualtrics網站意見回饋擴充功能
description: Qualtrics網站意見回饋擴充功能是Adobe Experience Platform中的調查目的地。 如需擴充功能的相關詳細資訊，請參閱Adobe Exchange上的擴充功能頁面。
...
[!DNL Qualtrics Website Feedback]可讓您在正確的時間以正確的訊息與網站訪客互動。 無論您是要透過網站意見調查改善訪客體驗，或是提高轉換率，[!DNL Qualtrics Website Feedback]都能協助您解決問題。

使用直覺式的點選介面，在幾分鐘內建立並部署高針對性的品牌網路訊息。 您從網站收集的資料和深入分析會與所有管道的客戶意見回饋資料一起出現，提供您客戶體驗的完整檢視 — 所有這些都在一個平台上。

[!DNL Qualtrics Website Feedback]是[!DNL Adobe Experience Platform]中的調查延伸。 如需有關擴充功能功能的詳細資訊，請參閱[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html)上的擴充功能頁面。

此目的地是標籤延伸模組。 如需有關標籤擴充功能在Experience Platform中如何運作的詳細資訊，請參閱[標籤擴充功能概觀](../launch-extensions/overview.md)。

![Qualtrics網站意見反應延伸](../../assets/catalog/survey/qualtrics/catalog.png)
...
若要安裝[!DNL Qualtrics Website Feedback]擴充功能：
...
如需有關擴充功能組態選項和安裝支援的資訊，請參閱Adobe Exchange[上的](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html)Qualtrics網站意見回饋頁面。
