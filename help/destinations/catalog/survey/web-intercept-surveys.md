...
[!DNL QuestionPro Intercept Surveys]是Adobe Experience Platform中的調查延伸模組。 如需有關擴充功能功能的詳細資訊，請參閱[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html)上的擴充功能頁面。
