...
[!DNL InMoment] Launch整合可讓您透過Digital Intercept產品快速輕鬆地啟用線上意見。 在應用程式中，可通過CXI雲管理員配置和管理截獲，使CX管理員能夠更好地控制其程式。

[!DNL InMoment] 是Adobe Experience Platform中的調查擴充功能。如需擴充功能的詳細資訊，請參閱[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100847.html)上的擴充功能頁面。
...
如需擴充功能設定選項的相關資訊，請參閱Exchange上的[Google Universal Analytics擴充功能頁面](https://exchange.adobe.com/experiencecloud.details.100847.html)。
