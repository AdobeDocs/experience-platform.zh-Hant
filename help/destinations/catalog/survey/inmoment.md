...
title: InMoment擴充功能
description: InMoment擴充功能是Adobe Experience Platform的調查目的地。 如需擴充功能的詳細資訊，請參閱Adobe交換的擴充功能頁面。
...
[!DNL InMoment] 是Adobe Experience Platform的調查分機。有關擴展功能的詳細資訊，請參閱[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100847.html)上的擴展頁。
...
如需擴充功能設定選項的詳細資訊，請參閱Adobe交換上的[ Google Universal Analytics擴充功能頁面](https://exchange.adobe.com/experiencecloud.details.100847.html)。
