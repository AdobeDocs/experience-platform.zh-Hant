...
title: InMoment擴展
description: InMoment擴展是Adobe Experience Platform的一個調查目的地。 有關擴展功能的詳細資訊，請參閱AdobeExchange上的擴展頁。
...
的 [!DNL InMoment] 標籤擴展允許您通過Digital Intercept產品快速而輕鬆地啟用線上反饋。 在應用中，可以通過CXI雲管理配置和管理截獲，使CX管理員能夠更多地控制其程式。

[!DNL InMoment] 是Adobe Experience Platform的調查延期。 有關擴展功能的詳細資訊，請參閱上的擴展頁 [AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100847.html)。

此目標是標籤擴展。 有關標籤擴展在平台中如何工作的詳細資訊，請參見 [標籤擴展概述](../launch-extensions/overview.md)。

![內矩擴展](../../assets/catalog/survey/inmoment/catalog.png)
...
有關擴展配置選項的資訊，請參見 [Google通用分析擴展頁](https://exchange.adobe.com/experiencecloud.details.100847.html) Adobe交易所。
