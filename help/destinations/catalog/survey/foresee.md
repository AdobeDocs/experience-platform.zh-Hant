...
title: 預測擴展目標
description: 預測延期是Adobe Experience Platform的一個調查目的地。 有關擴展功能的詳細資訊，請參閱AdobeExchange上的擴展頁。
...
配置 [!DNL ForeSee] 使用標籤進行產品部署。

[!DNL Foresee] 是Adobe Experience Platform的調查延期。 有關擴展功能的詳細資訊，請參閱上的擴展頁 [AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100164.html)。

此目標是標籤擴展。 有關標籤擴展在平台中如何工作的詳細資訊，請參見 [標籤擴展概述](../launch-extensions/overview.md)。

![預測擴展](../../assets/catalog/survey/foresee/catalog.png)
...
有關擴展配置選項的資訊，請參見 [預見擴展頁](https://exchange.adobe.com/experiencecloud.details.100164.html) Adobe交易所。
