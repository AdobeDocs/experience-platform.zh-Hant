...
title: Foresee擴充功能目的地
description: Foresee擴充功能是Adobe Experience Platform中的調查目的地。 如需擴充功能的相關詳細資訊，請參閱Adobe Exchange上的擴充功能頁面。
...
# [!DNL Foresee] 擴充功能 {#foresee-extension}

## 概觀 {#overview}

使用標籤設定[!DNL ForeSee]產品部署。

[!DNL Foresee]是[!DNL Adobe Experience Platform]中的調查延伸。 如需有關擴充功能功能的詳細資訊，請參閱[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100164.html)上的擴充功能頁面。

此目的地是標籤延伸模組。 如需有關標籤擴充功能在Experience Platform中如何運作的詳細資訊，請參閱[標籤擴充功能概觀](../launch-extensions/overview.md)。

![Foresee延伸模組](../../assets/catalog/survey/foresee/catalog.png)
...
如需擴充功能組態選項的相關資訊，請參閱Adobe Exchange上的[Foresee擴充功能頁面](https://exchange.adobe.com/experiencecloud.details.100164.html)。
