...
title: Foresee擴展目的地
description: Foresee擴充功能是Adobe Experience Platform中的調查目的地。 如需擴充功能的詳細資訊，請參閱Exchange上的擴充功能頁面。
...
[!DNL Foresee] 是Adobe Experience Platform中的調查擴充功能。如需擴充功能的詳細資訊，請參閱[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100164.html)上的擴充功能頁面。
...
如需擴充功能設定選項的相關資訊，請參閱Exchange上的[Foresee擴充功能頁面](https://exchange.adobe.com/experiencecloud.details.100164.html)。
