...
description: Foresee擴充功能是Adobe Experience Platform中的調查目的地。 如需擴充功能的詳細資訊，請參閱Adobe Exchange的擴充功能頁面。
seo-description: Foresee擴充功能是Adobe Experience Platform中的調查目的地。 如需擴充功能的詳細資訊，請參閱Adobe Exchange的擴充功能頁面。
...
使用Experience Platform Launch配置[!DNL ForeSee]產品部署。

[!DNL Foresee] 是Adobe Experience Platform中的調查擴充功能。如需擴充功能的詳細資訊，請參閱[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100164.html)上的擴充頁。
...
如需擴充功能設定選項的詳細資訊，請參閱Adobe Exchange上的[Foresee擴充功能頁面](https://exchange.adobe.com/experiencecloud.details.100164.html)。
