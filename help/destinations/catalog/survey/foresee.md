...
設定 [!DNL ForeSee] 使用標籤進行產品部署。

[!DNL Foresee] 是Adobe Experience Platform中的調查擴充功能。 如需擴充功能的詳細資訊，請參閱 [AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100164.html).
