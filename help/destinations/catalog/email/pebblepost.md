...
title: PebblePost擴展
description: PebblePost分機是Adobe Experience Platform的一個電子郵件目的地。 有關擴展功能的詳細資訊，請參閱AdobeExchange上的擴展頁。
...
[!DNL PebblePost's Programmatic Direct Mail®] 解決方案幫助數字營銷人員將線上興趣和意圖與可轉換的離線有形媒體聯繫起來。 營銷人員可以利用他們在Adobe中建立的定製資料段，現在瞄準具有相關的、更持久的家庭媒體印象的消費者。 根據響應路徑活動和現場轉換即時分析效能。

[!DNL PebblePost] 是Adobe Experience Platform的電子郵件分機。 有關PebblePost的更多資訊，請閱讀 [整合部落格](https://blog.adobe.com/en/publish/2017/11/16/pebblepost-builds-integration-launch-adobe.html#gs.7lejiq)。
