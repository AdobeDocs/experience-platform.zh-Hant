...
[!DNL Marketo]是[!DNL Adobe Experience Platform]中的電子郵件副檔名。 如需有關擴充功能功能的詳細資訊，請參閱Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.106250.bounteous-extension-for-adobe-launch-and-marketo.html)上的[擴充功能頁面。
...
如需有關擴充功能組態選項和安裝支援的資訊，請參閱Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.106250.bounteous-extension-for-adobe-launch-and-marketo.html)上的[Marketo頁面。
