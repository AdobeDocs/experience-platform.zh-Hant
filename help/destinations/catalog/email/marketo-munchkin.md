...
description: Marketo Munchkin擴充功能是Adobe Experience Platform的個人化目的地。 如需擴充功能的詳細資訊，請參閱Adobe交換的擴充功能頁面。
...
[!DNL Marketo Munchkin] 是Adobe Experience Platform的電子郵件分機。有關擴展功能的詳細資訊，請參閱[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101054.marketo-munchkin.html)上的擴展頁。
...
有關擴展配置選項和安裝支援的資訊，請參見AdobeExchange的[ Marketto Munchkin頁。](https://exchange.adobe.com/experiencecloud.details.101054.marketo-munchkin.html)
