...
[!DNL Marketo Munchkin]是[!DNL Adobe Experience Platform]中的電子郵件副檔名。 如需Marketo Munchkin的詳細資訊，請參閱Marketo檔案中的[潛在客戶追蹤](https://developers.marketo.com/javascript-api/lead-tracking/)。
