...
[!DNL Bizible]是[!DNL Adobe Experience Platform]中的電子郵件副檔名。 如需有關Bizible的詳細資訊，請閱讀Bizible概觀資源中的[行銷歸因](https://experienceleague.adobe.com/docs/bizible/using/introduction-to-bizible/overview-resources/marketing-attribution.html)。
