...
title: Bizible擴充功能
description: Bizible擴充功能是Adobe Experience Platform中的電子郵件目的地。 如需擴充功能的相關詳細資訊，請參閱Adobe Exchange上的擴充功能頁面。
...
[!DNL Bizible]是[!DNL Adobe Experience Platform]中的電子郵件副檔名。 如需有關Bizible的詳細資訊，請閱讀Bizible概觀資源中的[行銷歸因](https://experienceleague.adobe.com/docs/bizible/using/introduction-to-bizible/overview-resources/marketing-attribution.html?lang=zh-Hant)。

此目的地是標籤延伸模組。 如需有關標籤擴充功能在Experience Platform中如何運作的詳細資訊，請參閱[標籤擴充功能概觀](../launch-extensions/overview.md)。

![Bizible延伸模組](../../assets/catalog/email/bizible/catalog.png)
