...
[!DNL Talk URL Inbox] 是Adobe Experience Platform中客戶擴充功能的聲音。 如需擴充功能的詳細資訊，請參閱 [AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100583.html).
...
如需擴充功能組態選項和安裝支援的相關資訊，請參閱 [AdobeExchange上的「通話URL收件匣」頁面](https://exchange.adobe.com/experiencecloud.details.100583.html).
