...
[!DNL Talk URL Inbox] 是Adobe Experience Platform中客戶延伸功能的代言人。如需擴充功能的詳細資訊，請參閱[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100583.html)上的擴充頁。
...
![通話URL收件匣副檔名](../../assets/catalog/voice/talkurl/catalog.png)
...
有關擴展配置選項和安裝支援的資訊，請參閱Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100583.html)上的「通話URL收件箱」頁。[
