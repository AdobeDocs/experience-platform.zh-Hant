---
keywords: 交談URL收件匣；交談URL收件匣；交談URL收件匣；交談URL收件匣；交談URL；交談URL
title: 交談URL收件匣擴充功能
description: Talk URL Inbox擴充功能是Adobe Experience Platform中客戶目的地的聲音。 如需擴充功能的相關詳細資訊，請參閱Adobe交換上的擴充功能頁面。
...
接收來自網頁訪客的語音訊息。 包含託管UI和雲端型機器學習，可立即將您的語音訊息轉譯為文字分析。

[!DNL Talk URL Inbox] 是Adobe Experience Platform中客戶擴充功能的聲音。 如需擴充功能的相關詳細資訊，請參閱擴充功能頁面，網址為 [Adobe交換](https://exchange.adobe.com/experiencecloud.details.100583.html).

此目的地是標籤延伸模組。 如需標籤擴充功能在Platform中如何運作的詳細資訊，請參閱 [標籤擴充功能概觀](../launch-extensions/overview.md).

![交談URL收件匣擴充功能](../../assets/catalog/voice/talkurl/catalog.png)
...
如需擴充功能組態選項和安裝支援的詳細資訊，請參閱 [Adobe交換上的交談URL收件匣頁面](https://exchange.adobe.com/experiencecloud.details.100583.html).
