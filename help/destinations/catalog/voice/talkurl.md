...
title: 通話URL收件箱擴展
description: Talk URL Inbox擴展是Adobe Experience Platform客戶目標的語音。 有關擴展功能的詳細資訊，請參閱AdobeExchange上的擴展頁。
...
從網頁訪問者接收語音留言。 包括托管的UI和基於雲的機器學習，以便將語音消息即時轉錄為文本洞察。

[!DNL Talk URL Inbox] 是Adobe Experience Platform客戶分機的聲音。 有關擴展功能的詳細資訊，請參閱上的擴展頁 [AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100583.html)。
...
有關擴展配置選項和安裝支援的資訊，請參見 [AdobeExchange上的「通話URL收件箱」頁](https://exchange.adobe.com/experiencecloud.details.100583.html)。
