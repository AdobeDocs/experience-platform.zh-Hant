...
![交談URL收件匣延伸](../../assets/catalog/voice/talkurl/catalog.png)
...
如需有關擴充功能組態選項和安裝支援的資訊，請參閱Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100583.html)上的[交談URL收件匣頁面。
