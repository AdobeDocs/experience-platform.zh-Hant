...
[!DNL Confirmit] 數位意見回饋是Adobe Experience Platform中客戶延伸功能的代言人。如需擴充功能的詳細資訊，請參閱[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html)上的擴充頁。
...
如需擴充功能設定選項和安裝支援的詳細資訊，請參閱Adobe Exchange的[確認數位意見頁面](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html)。
