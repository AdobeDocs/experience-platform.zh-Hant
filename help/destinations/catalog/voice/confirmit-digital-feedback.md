...
[!DNL Confirmit]數位意見是Adobe Experience Platform中的客戶語音擴充功能。 如需有關擴充功能功能的詳細資訊，請參閱[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html)上的擴充功能頁面。
