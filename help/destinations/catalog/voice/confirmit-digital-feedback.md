...
title: 確認數位意見延伸
description: Confirm Digital Feedback擴充功能是Adobe Experience Platform中的客戶語音目的地。 如需擴充功能的相關詳細資訊，請參閱Adobe Exchange上的擴充功能頁面。
...
[!DNL Confirmit Digital Feedback]解決方案可協助您將網站流量轉換為即時深入分析。 透過[!DNL Confirmit]，可以根據您的需求顯示低調且目標明確的調查，鼓勵訪客提供意見回饋，例如：
...
[!DNL Confirmit]數位意見是[!DNL Adobe Experience Platform]中客戶分機的Voice。 如需有關擴充功能功能的詳細資訊，請參閱[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html)上的擴充功能頁面。

此目的地是標籤延伸模組。 如需有關標籤擴充功能在Experience Platform中如何運作的詳細資訊，請參閱[標籤擴充功能概觀](../launch-extensions/overview.md)。

![確認數位意見延伸](../../assets/catalog/voice/confirmit-digital-feedback/catalog.png)
...
如需有關擴充功能組態選項和安裝支援的資訊，請參閱Adobe Exchange[上的](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html)確認數位意見回饋頁面。
