...
| 項目 | 類型 | 附註 |
|---------|----------|---------|
| 匯出類型 | **[!UICONTROL Audience export]** | 您正在匯出具有Facebook目的地中所使用識別碼（名稱、電話號碼或其他）的對象的所有成員。 |
...
1. 在目的地目錄中尋找Facebook目的地，並選取&#x200B;**[!UICONTROL Set Up]**。
...
您可以從&#x200B;**[!UICONTROL Account expiration date]**&#x200B;或&#x200B;**[[!UICONTROL Accounts]](../../ui/destinations-workspace.md#accounts)**&#x200B;索引標籤中的&#x200B;**[[!UICONTROL Browse]](../../ui/destinations-workspace.md#browse)**&#x200B;欄監視權杖到期日。
...
* **[!UICONTROL Account ID]**：您的[!DNL Facebook Ad Account ID]。 您可以在您的[!DNL Facebook Ads Manager]帳戶中找到此ID。 輸入此 ID 時，都必須加上首碼 `act_`。
...
在&#x200B;**[!UICONTROL Segment schedule]**&#x200B;步驟中，您將對象傳送至[!UICONTROL Origin of audience]時必須提供[!DNL Facebook Custom Audiences]。
