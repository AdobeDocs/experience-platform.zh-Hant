...
| 項目 | 類型 | 附註 |
|---------|----------|---------|
| 匯出類型 | **[!UICONTROL Audience export]** | 您正使用Twitter自訂對象目的地中使用的識別碼匯出對象的所有成員。 |
...
1. 在目的地目錄中尋找[!DNL Twitter Custom Audiences]目的地並選取&#x200B;**[!UICONTROL Set Up]**。
...
* **[!UICONTROL Account ID]**：您的[!DNL Twitter Ads]帳戶識別碼。 您可以在您的[!DNL Twitter Ads]設定中找到此專案。
