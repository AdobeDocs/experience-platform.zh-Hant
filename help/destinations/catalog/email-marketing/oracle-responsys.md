...
若要將對象資料傳送至[!DNL Oracle Responsys]，您必須先在[中](#connect-destination)連線至目的地[!DNL Adobe Experience Platform]，然後[設定將資料從儲存位置匯入](#import-data-into-responsys)至[!DNL Oracle Responsys]。
