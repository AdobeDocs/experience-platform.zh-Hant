...
此[!DNL Adobe Experience Platform] [目的地](/help/destinations/home.md)運用[[!DNL SendGrid Marketing Contacts API]](https://api.sendgrid.com/v3/marketing/contacts)，可讓您匯出第一方電子郵件設定檔，並在新的SendGrid對象中加以啟用，以符合您的業務需求。
