...
* 您必須在[!DNL Adobe Experience Platform]中建立至少一個對象。
...
| 項目 | 類型 | 附註 |
|---------|----------|---------|
| 匯出類型 | **[!UICONTROL Audience export]** | 您正在匯出具有Audience Analysis目的地中所使用識別碼（名稱、電話號碼或其他）的對象的所有成員。 |
...
* **[!UICONTROL Name]**：目的地名稱。
* **[!UICONTROL Description]**：目的地說明。
...
* **[!UICONTROL Activation Skipped Rate Exceed]**：當啟用略過率超過臨界值時收到通知。
...
1. 如果您不在建立的目的地，您可以導覽至「**[!UICONTROL Destinations]** > **[!UICONTROL Browse]**」再次尋找該目的地。
1. 選擇「**[!UICONTROL Activate audiences]**」。
1. 選取您要分析資格的所需對象。 完成後，選取&#x200B;**[!UICONTROL Next]**。
1. 檢閱目的地組態和對象設定，然後選取&#x200B;**[!UICONTROL Finish]**。

您可以導覽回&#x200B;**[!UICONTROL Activate audiences]**&#x200B;頁面，新增更多對象以供日後分析。 對象啟動後，您就無法移除對象。
