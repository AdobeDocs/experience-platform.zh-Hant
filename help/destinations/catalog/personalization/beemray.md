...
title: Beemray擴充功能
description: Bemray擴充功能是Adobe Experience Platform中的個人化目的地。 如需擴充功能的詳細資訊，請參閱Exchange上的擴充功能頁面。
...
[!DNL Beemray] 有助於您根據情境加速產品。讓您獲得深入分析、建立新體驗、促進互動，以及參與真正重要的時刻。 Beemray使用機器學習來自動執行情境智慧。 Beemray可連線至Adobe Experience Cloud和您的其他技術合作夥伴。 一切都是即時發生的。 此擴充功能會在您的網站上安裝[!DNL Beemray] SDK。

Beemray是Adobe Experience Platform中的個人化擴充功能。 如需擴充功能的詳細資訊，請參閱[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101063.beemray-human-context.html)上的擴充功能頁面。
...
有關擴充功能配置選項和安裝支援的資訊，請參閱AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101063.beemray-human-context.html)上的[Beemray頁。
