...
title: Gainsight擴充功能
description: Gainsight擴充功能是Adobe Experience Platform的個人化目的地。 如需擴充功能的詳細資訊，請參閱Adobe交換的擴充功能頁面。
...
[!DNL Gainsight] 是Adobe Experience Platform的個人化延伸。有關擴展功能的詳細資訊，請參閱[AdobeExchange](https://www.adobeexchange.com/experiencecloud.details.103343.html)上的擴展頁。
...
有關擴展配置選項和安裝支援的資訊，請參閱AdobeExchange](https://www.adobeexchange.com/experiencecloud.details.103343.html)上的[ Gainsight頁。
