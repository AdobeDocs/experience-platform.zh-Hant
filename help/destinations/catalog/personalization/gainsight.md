...
title: Gainsight擴充功能
description: Gainsight擴充功能是Adobe Experience Platform中的個人化目的地。 如需擴充功能的相關詳細資訊，請參閱Adobe交換上的擴充功能頁面。
...
[!DNL Gainsight] 讓產品擁有者能夠深入瞭解使用者行為、推動產品採用並收集使用者意見回饋。

[!DNL Gainsight] 是Adobe Experience Platform中的個人化擴充功能。 如需擴充功能的相關詳細資訊，請參閱擴充功能頁面，網址為 [Adobe交換](https://www.adobeexchange.com/experiencecloud.details.103343.html).

此目的地是標籤延伸模組。 如需標籤擴充功能在Platform中如何運作的詳細資訊，請參閱 [標籤擴充功能概觀](../launch-extensions/overview.md).

![Gainsight擴充功能](../../assets/catalog/personalization/gainsight/catalog.png)
...
如需擴充功能組態選項和安裝支援的詳細資訊，請參閱 [Adobe交換上的Gainsight頁面](https://www.adobeexchange.com/experiencecloud.details.103343.html).
