---
keywords: Foresee；Foresee擴充功能；Foresee目的地
title: Gainsight擴充功能
description: Gainsight擴充功能是Adobe Experience Platform中的個人化目的地。 如需擴充功能的相關詳細資訊，請參閱Adobe Exchange上的擴充功能頁面。
...
[!DNL Gainsight]讓產品擁有者能夠使用工具深入瞭解使用者行為、推動產品採用並收集使用者意見回饋。

[!DNL Gainsight]是[!DNL Adobe Experience Platform]中的個人化擴充功能。 如需有關擴充功能功能的詳細資訊，請參閱[Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.103343.html)上的擴充功能頁面。

此目的地是標籤延伸模組。 如需有關標籤擴充功能在Experience Platform中如何運作的詳細資訊，請參閱[標籤擴充功能概觀](../launch-extensions/overview.md)。

![Gainsight延伸模組](../../assets/catalog/personalization/gainsight/catalog.png)
...
如需有關擴充功能組態選項和安裝支援的資訊，請參閱Adobe Exchange[上的](https://www.adobeexchange.com/experiencecloud.details.103343.html)Gainsight頁面。
