---
keywords: Kickfire;Kickfire;Kickfire擴展；Kickfire擴展
title: KickFire擴充功能
description: KickFire擴充功能是Adobe Experience Platform中的個人化目的地。 如需擴充功能的詳細資訊，請參閱Exchange上的擴充功能頁面。
...
[!DNL KickFire's] IP位址智慧和B2B原始資料可讓您將IP位址轉譯至公司、識別匿名Web訪客，以及將帳戶資料整合至您的技術堆疊中 — 所有這一切都取決於公司的IP位址。

[!DNL KickFire] 是Adobe Experience Platform中的個人化擴充功能。有關擴充功能的詳細資訊，請參閱[Kickfire網站](https://www.kickfire.com/)。
