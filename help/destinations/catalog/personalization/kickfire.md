...
title: KickFire擴充功能
description: KickFire擴充功能是Adobe Experience Platform的個人化目的地。 如需擴充功能的詳細資訊，請參閱Adobe交換的擴充功能頁面。
...
[!DNL KickFire] 是Adobe Experience Platform的個人化延伸。如需擴充功能的詳細資訊，請參閱[Kickfire網站](https://www.kickfire.com/)。
