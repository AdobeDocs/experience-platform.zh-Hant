...
title: KickFire擴展
description: KickFire分機是Adobe Experience Platform的個性化目的地。 有關擴展功能的詳細資訊，請參閱AdobeExchange上的擴展頁。
...
[!DNL KickFire's] IP地址智慧和B2B公共資料使您能夠將IP地址轉換到公司、識別匿名Web訪問者，並將帳戶資料整合到您的技術堆棧中 — 所有這一切都基於公司的IP地址。

[!DNL KickFire] 是Adobe Experience Platform的個性化擴展。 有關擴展功能的詳細資訊，請參見 [Kickfire網站](https://www.kickfire.com/)。

此目標是標籤擴展。 有關標籤擴展在平台中如何工作的詳細資訊，請參見 [標籤擴展概述](../launch-extensions/overview.md)。

![Kickfire擴展](../../assets/catalog/personalization/kickfire/catalog.png)
