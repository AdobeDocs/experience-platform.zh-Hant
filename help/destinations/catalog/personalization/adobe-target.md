...
description: Adobe Target分機是Adobe Experience Platform的個人化目的地。 如需擴充功能的詳細資訊，請參閱Adobe交換的擴充功能頁面。
...
Adobe Target是Adobe Experience Platform的個人化延伸。 有關擴展功能的詳細資訊，請參閱[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100162.html)上的擴展頁。
