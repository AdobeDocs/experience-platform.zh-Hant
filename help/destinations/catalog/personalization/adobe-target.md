...
description: Adobe Target分機是Adobe Experience Platform的個性化目的地 有關擴展功能的詳細資訊，請參閱AdobeExchange上的擴展頁。
...
Adobe Target是Adobe Experience Platform的個性化擴展 有關擴展功能的詳細資訊，請參閱上的擴展頁 [AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100162.html)。
...
有關擴展配置選項的資訊，請參見 [Adobe Target擴展頁](../../../tags/extensions/client/target/overview.md) 的下界。
