...
如需擴充功能設定選項的詳細資訊，請參閱「 [Experience」檔案中的](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/target-extension/overview.html) 「Adobe Target擴充 [!DNL Launch] 功能」頁。
