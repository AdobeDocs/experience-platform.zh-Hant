...
Adobe Target是Adobe Experience Platform中的個人化擴充功能。 如需擴充功能的詳細資訊，請參閱 [AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100162.html).
...
如需擴充功能組態選項的相關資訊，請參閱 [Adobe Target擴充功能頁面](../../../tags/extensions/client/target/overview.md) 在標籤檔案中。
