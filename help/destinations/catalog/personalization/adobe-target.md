...
如需擴充功能設定選項的相關資訊，請參閱Experience [!DNL Launch]檔案中的[Adobe Target擴充功能頁面](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/target-extension/overview.html)。
