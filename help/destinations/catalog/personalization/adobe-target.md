...
# [!DNL Adobe Target] 擴充功能

## 概觀 {#overview}

[!DNL Adobe Target]為[!DNL Adobe CX Enterprise]解決方案，提供一切所需工具，讓您量身訂造及個人化您的客戶體驗，藉此為您的網頁以及行動網站、應用程式、社群媒體和其他數位頻道創造最高的收入。

[!DNL Adobe Target]是[!DNL Adobe Experience Platform]中的個人化擴充功能。 如需有關擴充功能功能的詳細資訊，請參閱[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100162.html)上的擴充功能頁面。
...
如需擴充功能組態選項的相關資訊，請參閱標籤檔案中的[Adobe Target擴充功能頁面](../../../tags/extensions/client/target/overview.md)。
