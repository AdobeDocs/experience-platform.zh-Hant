...
現在您已在Experience Platform中設定[!DNL Commerce]目的地，您必須在[!DNL Commerce]中安裝[!DNL Audience Activation]擴充功能，並設定[!DNL Commerce Admin]以匯入您建立的Real-Time CDP對象。 請參閱[[!DNL Commerce] 檔案](https://experienceleague.adobe.com/docs/commerce-admin/customers/customers-menu/audience-activation.html)以瞭解更多資訊。
