---
keywords: D&B訪問者智慧；D&B；訪問者智慧擴展
title: D&B訪問者智慧擴展
description: D&B遊客智慧擴展是Adobe Experience Platform的個性化目的地。 有關擴展功能的詳細資訊，請參閱AdobeExchange上的擴展頁。
...
[!DNL D&B Visitor Intelligence] 是Adobe Experience Platform的個性化擴展。 有關擴展功能的詳細資訊，請參見 [D&amp;B網站](https://www.dnb.com/)。

此目標是標籤擴展。 有關標籤擴展在平台中如何工作的詳細資訊，請參見 [標籤擴展概述](../launch-extensions/overview.md)。

![D&amp;B訪問者智慧擴展](../../assets/catalog/personalization/dnb/catalog.png)
