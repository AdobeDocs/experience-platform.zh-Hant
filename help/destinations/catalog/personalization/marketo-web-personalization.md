...
此擴充功能部署指令碼 [!DNL Marketo’s] Web個人化和ContentAI應用程式。 [!DNL Marketo] Web個人化可唯一識別並個人化網頁訪客特性的內容，例如匿名訪客的firmographics以及 [!DNL Marketo] 適用於已知訪客的參與平台。 [!DNL Marketo] ContentAI包含B2B客戶獨有的AI功能，可用於網路和電子郵件行銷活動的Recommendations和個人化。

[!DNL Marketo Web Personalization] 是Adobe Experience Platform中的個人化擴充功能。 如需Marketo中網頁個人化和ContentAI的詳細資訊，請閱讀 [Web個人化概觀](https://experienceleague.adobe.com/docs/marketo/using/product-docs/web-personalization/understanding-web-personalization/web-personalization-overview.html?lang=en).
