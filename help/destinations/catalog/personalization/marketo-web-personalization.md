---
keywords: MarketoWeb個性化；市場營銷；Marketo Web個性化；MarketoWeb個性化擴展；Marketo Web個性化擴展；市場營銷；Marketo
title: MarketoWeb個性化擴展
description: Marketo網路個性化擴展是Adobe Experience Platform的個性化目的地。 有關擴展功能的詳細資訊，請參閱AdobeExchange上的擴展頁。
...
此擴展將為 [!DNL Marketo’s] Web個性化和內容AI應用程式。 [!DNL Marketo] Web Personalization可唯一地識別和個性化內容，使其與Web訪問者特徵相符，如匿名訪問者的圖形以及Web中的眾多行為屬性 [!DNL Marketo] 已知訪問者的參與平台。 [!DNL Marketo] ContentAI包含AI支援的建議和個性化功能，適用於B2B客戶所獨有的網路和電子郵件活動。

[!DNL Marketo Web Personalization] 是Adobe Experience Platform的個性化擴展。 有關MarketoWeb個性化和內容AI的詳細資訊，請閱讀 [Web個性化概述](https://experienceleague.adobe.com/docs/marketo/using/product-docs/web-personalization/understanding-web-personalization/web-personalization-overview.html?lang=en)。

此目標是標籤擴展。 有關標籤擴展在平台中如何工作的詳細資訊，請參見 [標籤擴展概述](../launch-extensions/overview.md)。

![MarketoWeb個性化擴展](../../assets/catalog/personalization/marketo-web-personalization/catalog.png)
...
安裝 [!DNL Marketo Web Personalization] 擴展：
