...
此擴充功能會為 [!DNL Marketo’s] Web個人化和ContentAI應用程式。 [!DNL Marketo] Web個人化可唯一識別並個人化網站訪客特徵的內容，例如匿名訪客的圖片，以及 [!DNL Marketo] 已知訪客的參與平台。 [!DNL Marketo] ContentAI包含針對B2B客戶專屬之網頁和電子郵件促銷活動，以AI支援的建議和個人化功能。

[!DNL Marketo Web Personalization] 是Adobe Experience Platform中的個人化擴充功能。 如需Marketo中Web個人化和ContentAI的詳細資訊，請參閱 [網頁個人化概述](https://experienceleague.adobe.com/docs/marketo/using/product-docs/web-personalization/understanding-web-personalization/web-personalization-overview.html?lang=en).
