...
Adobe Target v2是Adobe Experience Platform中的個人化擴充功能。 如需擴充功能的詳細資訊，請參閱 [AdobeExchange](https://exchange.adobe.com/experiencecloud.details.102722.adobe-target-v2-launch-extension.html).
...
選取您要安裝擴充功能的屬性。 您也可以選擇建立新屬性。 屬性是規則、資料元素、設定的擴充功能、環境和程式庫的集合。請參閱 [屬性](../../../tags/ui/administration/companies-and-properties.md#properties-page) 以深入了解。

工作流程會逐步引導您完成安裝。

如需擴充功能組態選項的相關資訊，請參閱 [Adobe Target v2擴充功能頁面](../../../tags/extensions/client/target-v2/overview.md) 在標籤檔案中。
