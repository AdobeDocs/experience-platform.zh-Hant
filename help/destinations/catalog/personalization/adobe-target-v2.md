---
keywords: 目標擴展；目標；目標v2；目標v2擴展
title: Adobe Target v2 擴充功能
description: Adobe Targetv2擴展是Adobe Experience Platform的個性化目的地。 有關擴展功能的詳細資訊，請參閱AdobeExchange上的擴展頁。
...
Adobe Targetv2是Adobe Experience Platform的個性化擴展 有關擴展功能的詳細資訊，請參閱上的擴展頁 [AdobeExchange](https://exchange.adobe.com/experiencecloud.details.102722.adobe-target-v2-launch-extension.html)。
...
選擇要在其中安裝副檔名的屬性。 您還可以選擇建立新屬性。 屬性是規則、資料元素、設定的擴充功能、環境和程式庫的集合。查看上的文檔 [屬性](../../../tags/ui/administration/companies-and-properties.md#properties-page) 以瞭解詳細資訊。

工作流將指導您完成安裝的步驟。

有關擴展配置選項的資訊，請參見 [Adobe Targetv2擴展頁](../../../tags/extensions/client/target-v2/overview.md) 的下界。
