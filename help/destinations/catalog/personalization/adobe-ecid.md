...
[!DNL Experience Cloud] ID服務是Adobe Experience Platform中的個人化擴充功能。如需擴充功能的詳細資訊，請參閱標籤檔案中的[Experience CloudID服務擴充功能頁面](../../../tags/extensions/web/id-service/overview.md)。
...
如需擴充功能組態選項和安裝支援的相關資訊，請參閱標籤檔案中的[Experience CloudID服務擴充功能頁面](../../../tags/extensions/web/id-service/overview.md)。
