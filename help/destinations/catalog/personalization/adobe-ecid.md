...
description: Experience CloudID服務擴充功能是Adobe Experience Platform中的個人化目的地。 如需擴充功能的詳細資訊，請參閱Exchange上的擴充功能頁面。
...
此擴充功能會實作[!DNL Experience Cloud] ID服務，以識別所有[!DNL Experience Cloud]解決方案中的訪客。

[!DNL Experience Cloud] ID服務是Adobe Experience Platform中的個人化擴充功能。如需擴充功能的詳細資訊，請參閱[!DNL Experience Platform Launch]檔案中的[Experience CloudID服務擴充頁面](../../../tags/extensions/web/id-service/overview.md)。
...
如需擴充功能設定選項和安裝支援的相關資訊，請參閱[!DNL Experience Launch]檔案中的[Experience CloudID服務擴充功能頁面](../../../tags/extensions/web/id-service/overview.md)。
