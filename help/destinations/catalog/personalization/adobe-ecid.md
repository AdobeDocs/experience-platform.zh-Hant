...
此擴充功能會實作 [!DNL Experience Cloud] ID服務，可識別所有 [!DNL Experience Cloud] 解決方案。

[!DNL Experience Cloud] ID服務是Adobe Experience Platform中的個人化擴充功能。 如需擴充功能的詳細資訊，請參閱 [Experience CloudID服務擴充功能頁面](../../../tags/extensions/client/id-service/overview.md) 在標籤檔案中。
...
如需擴充功能組態選項和安裝支援的相關資訊，請參閱 [Experience CloudID服務擴充功能頁面](../../../tags/extensions/client/id-service/overview.md) 在標籤檔案中。
