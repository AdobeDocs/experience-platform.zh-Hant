...
[!DNL Experience Cloud] ID服務是即時客戶資料平台中的個人化擴充功能。 如需擴充功能的詳細資訊，請參 [閱檔案中的Experience Cloud ID服務擴充](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/id-service-extension/overview.html)[!DNL Experience Platform Launch] 頁。
...
如需擴充功能設定選項和安裝支援的詳細資訊，請參 [閱檔案中的Experience Cloud ID服務擴充](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/id-service-extension/overview.html)[!DNL Experience Launch] 頁。
