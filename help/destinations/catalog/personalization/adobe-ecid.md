...
[!DNL Experience Cloud] ID服務是[!DNL Adobe Experience Platform]中的個人化擴充功能。 如需擴充功能的相關詳細資訊，請參閱標籤檔案中的[Experience Cloud ID服務擴充功能頁面](../../../tags/extensions/client/id-service/overview.md)。
