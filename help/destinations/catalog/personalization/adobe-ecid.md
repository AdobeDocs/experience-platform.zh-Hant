...
description: Experience CloudID服務擴充功能是Adobe Experience Platform的個人化目的地。 如需擴充功能的詳細資訊，請參閱Adobe交換的擴充功能頁面。
...
[!DNL Experience Cloud] ID服務是Adobe Experience Platform的個人化延伸。如需擴充功能的詳細資訊，請參閱[!DNL Experience Platform Launch]檔案中的[Experience CloudID服務擴充頁](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/id-service-extension/overview.html)。
...
![AdobeECID擴充功能](../../assets/catalog/personalization/adobe-ecid/catalog.png)

## 先決條件 {#prerequisites}

此擴充功能可在「目標」目錄中，針對所有已購買平台的客戶提供。

若要使用此擴充功能，您需要存取[!DNL Experience Platform Launch]。 [!DNL Experience Platform Launch] 作為附帶的增值功能提供給Adobe Experience Cloud客戶。請連絡您的組織管理員以取得[!DNL Launch]的存取權，並要求他們授予您&#x200B;**[!UICONTROL manage_properties]**&#x200B;權限，以便您安裝擴充功能。
...
有關擴展配置選項和安裝支援的資訊，請參閱[!DNL Experience Launch]文檔中的[Experience CloudID服務擴展頁](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/id-service-extension/overview.html)。
