...
[!DNL Experience Cloud] ID服務是Adobe Experience Platform中的個人化擴充功能。如需擴充功能的詳細資訊，請參閱[!DNL Experience Platform Launch]檔案中的[Experience Cloud ID服務擴充頁](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/id-service-extension/overview.html)。
...
如需擴充功能設定選項和安裝支援的詳細資訊，請參閱[!DNL Experience Launch]檔案中的[ Experience Cloud ID服務擴充頁](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/id-service-extension/overview.html)。
