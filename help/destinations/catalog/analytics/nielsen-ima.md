---
keywords: Nielsen IMA處理常式；nielsen IMA處理常式；nielsen IMA；Nielsen IMA
title: Nielsen IMA處理常式擴充功能
description: Nielsen IMA Handler擴充功能是Adobe Experience Platform中的分析目的地。 如需擴充功能的相關詳細資訊，請參閱Adobe Exchange上的擴充功能頁面。
...
[!DNL Nielsen IMA Handler]是[!DNL Adobe Experience Platform]中的Analytics擴充功能。

此目的地是標籤延伸模組。 如需有關標籤擴充功能在Experience Platform中如何運作的詳細資訊，請參閱[標籤擴充功能概觀](../launch-extensions/overview.md)。

![Nielsen IMA處理常式延伸](../../assets/catalog/analytics/nielsen-ima/catalog.png)
...
若要安裝[!DNL Nielsen IMA Handler]擴充功能：
