...
description: Nielsen IMA Handler擴充功能是Adobe Experience Platform的分析目的地。 如需擴充功能的詳細資訊，請參閱Adobe交換的擴充功能頁面。
...
[!DNL Nielsen IMA Handler] 是Adobe Experience Platform的分析擴充功能。
...
要安裝[!DNL Nielsen IMA Handler]擴展：
