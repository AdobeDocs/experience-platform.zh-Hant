...
在您的Web屬性上快速無縫部署[!DNL Decibel]。 您也可以使用透過擴充功能提供的動作，搭配規則部署其他進階設定。

[!DNL Decibel] 是Adobe Experience Platform中的analytics擴充功能。如需擴充功能的詳細資訊，請參閱[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100913.html)上的擴充功能頁面。
...
如需擴充功能設定選項的相關資訊，請參閱Exchange上的[Decibel擴充功能頁面](https://exchange.adobe.com/experiencecloud.details.100913.html)。
