---
keywords: 分貝副檔名；分貝；分貝目的地
title: Decibel副檔名
description: Decibel擴充功能是Adobe Experience Platform中的分析目的地。 如需擴充功能的相關詳細資訊，請參閱Adobe Exchange上的擴充功能頁面。
...
快速且順暢地將[!DNL Decibel]部署在您的Web屬性上。 其他進階設定也可使用透過擴充功能提供的動作，與規則一起部署。

[!DNL Decibel]是[!DNL Adobe Experience Platform]中的Analytics擴充功能。 如需有關擴充功能功能的詳細資訊，請參閱[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100913.html)上的擴充功能頁面。

此目的地是標籤延伸模組。 如需有關標籤擴充功能在Experience Platform中如何運作的詳細資訊，請參閱[標籤擴充功能概觀](../launch-extensions/overview.md)。

![分貝延伸](../../assets/catalog/analytics/decibel/catalog.png)
...
如需擴充功能組態選項的相關資訊，請參閱Adobe Exchange上的[Decibel擴充功能頁面](https://exchange.adobe.com/experiencecloud.details.100913.html)。
