...
title: 分貝延伸
description: Decibel擴充功能是Adobe Experience Platform中的分析目的地。 如需擴充功能的相關詳細資訊，請參閱Adobe交換上的擴充功能頁面。
...
快速且順暢地部署 [!DNL Decibel] 在您的Web屬性上。 其他進階設定也可以使用透過擴充功能提供的動作來部署規則。

[!DNL Decibel] 是Adobe Experience Platform中的analytics擴充功能。 如需擴充功能的相關詳細資訊，請參閱擴充功能頁面，網址為 [Adobe交換](https://exchange.adobe.com/experiencecloud.details.100913.html).
...
如需擴充功能組態選項的相關資訊，請參閱 [分貝副檔名頁面](https://exchange.adobe.com/experiencecloud.details.100913.html) 在Adobe交換上。
