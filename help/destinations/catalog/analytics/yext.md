...
此 [!DNL Yext Conversion Tracking] 擴充功能可讓您測量可歸因於您使用Yext產品的轉換。

[!DNL Yext Conversion Tracking] 是Adobe Experience Platform中的analytics擴充功能。 如需擴充功能的詳細資訊，請參閱 [AdobeExchange](https://exchange.adobe.com/experiencecloud.details.103174.yext-conversion-tracking.html).
...
若要安裝 [!DNL Yext Conversion Tracking] 擴充功能：
...
如需擴充功能組態選項和安裝支援的相關資訊，請參閱 [Ext Exchange上的「轉換追蹤」頁面](https://exchange.adobe.com/experiencecloud.details.103174.yext-conversion-tracking.html).
