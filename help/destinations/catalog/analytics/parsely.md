---
keywords: 剖析。 ly;parsely;parsely;parse.ly;Parse.ly
...
[!DNL Parse.ly Analytics] 可協助2,500多家公司使用資料來了解其線上受眾。 此擴充功能會安裝JavaScript程式碼片段，用於追蹤訪客與您網站上內容的互動情形。

Parse.ly是Adobe Experience Platform中的分析擴充功能。 如需擴充功能的詳細資訊，請參閱 [Parse.ly Analytics](https://www.parse.ly/).
