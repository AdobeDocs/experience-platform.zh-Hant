---
keywords: 剖析。 ly；剖析；剖析；parse.ly；Parse.ly
title: Parse.ly Analytics擴充功能
description: Parse.ly Analytics擴充功能是Adobe Experience Platform中的分析目的地。 如需擴充功能的相關詳細資訊，請參閱Adobe Exchange上的擴充功能頁面。
...
[!DNL Parse.ly Analytics]可協助2,500多家公司使用資料來瞭解其線上對象。 此擴充功能會安裝JavaScript程式碼片段，追蹤訪客在您的網站上與內容的互動情形。

Parse.ly是Adobe Experience Platform中的Analytics擴充功能。 如需有關擴充功能功能的詳細資訊，請參閱[Parse.ly Analytics](https://www.parse.ly/)。

此目的地是標籤延伸模組。 如需有關標籤擴充功能在Experience Platform中如何運作的詳細資訊，請參閱[標籤擴充功能概觀](../launch-extensions/overview.md)。

![Parse.ly Analytics擴充功能](../../assets/catalog/analytics/parsely/catalog.png)
