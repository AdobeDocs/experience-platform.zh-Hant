...
description: Parse.ly Analytics擴充功能是Adobe Experience Platform的分析目的地。 如需擴充功能的詳細資訊，請參閱Adobe交換的擴充功能頁面。
...
Parse.ly是Adobe Experience Platform的分析擴充功能。 如需擴充功能的詳細資訊，請參閱[Parse.ly Analytics](https://www.parse.ly/)。
