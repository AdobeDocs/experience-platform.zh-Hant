...
description: Parse.ly Analytics擴充功能是Adobe Experience Platform中的分析目的地。 如需擴充功能的相關詳細資訊，請參閱Adobe交換上的擴充功能頁面。
...
[!DNL Parse.ly Analytics] 可協助2,500多家公司使用資料來瞭解其線上受眾。 此擴充功能會安裝JavaScript程式碼片段，追蹤訪客與您網站內容的互動情形。

Parse.ly是Adobe Experience Platform中的Analytics擴充功能。 如需擴充功能的相關詳細資訊，請參閱 [Parse.ly Analytics](https://www.parse.ly/).
