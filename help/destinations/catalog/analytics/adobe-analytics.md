...
若要使用此擴充功能，您需要存取Experience Platform中的標籤。 標籤是以隨附加值功能的形式提供給[!DNL Adobe CX Enterprise]個客戶。 請聯絡您的組織管理員以取得資料收集UI的存取權，並要求他們授與您許可權&#x200B;**[!UICONTROL manage_properties]**，以便您安裝擴充功能。
