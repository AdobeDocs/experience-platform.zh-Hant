...
description: Demandbase擴充功能是Adobe Experience Platform中的分析目的地。 如需擴充功能的相關詳細資訊，請參閱Adobe Exchange上的擴充功能頁面。
...
直接在[!DNL Demandbase]中取得[!DNL Adobe Analytics]個B2B帳戶深入分析，您可依產業、收入和目標帳戶來劃分流量和行為。 此帳戶型檢視針對參與、轉換和來源提供獨特見解，供您最有價值的訪客使用。

[!DNL Demandbase]是[!DNL Adobe Experience Platform]中的Analytics擴充功能。 如需有關擴充功能功能的詳細資訊，請參閱[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101605.html)上的擴充功能頁面。

此目的地是標籤延伸模組。 如需有關標籤擴充功能在Experience Platform中如何運作的詳細資訊，請參閱[標籤擴充功能概觀](../launch-extensions/overview.md)。

![Demandbase延伸模組](../../assets/catalog/analytics/demandbase/catalog.png)
...
如需擴充功能組態選項的相關資訊，請參閱Adobe Exchange上的[Demandbase擴充功能頁面](https://exchange.adobe.com/experiencecloud.details.101605.html)。
