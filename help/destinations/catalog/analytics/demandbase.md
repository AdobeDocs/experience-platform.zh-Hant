...
直接在Adobe Analytics中取得[!DNL Demandbase]個B2B帳戶深入分析，您可依產業、收入和目標帳戶來劃分流量和行為。 此帳戶型檢視針對參與、轉換和來源提供獨特見解，供您最有價值的訪客使用。

[!DNL Demandbase]是Adobe Experience Platform中的Analytics擴充功能。 如需有關擴充功能功能的詳細資訊，請參閱[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101605.html)上的擴充功能頁面。
