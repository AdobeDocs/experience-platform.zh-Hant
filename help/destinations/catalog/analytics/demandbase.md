...
[!DNL Demandbase] 是Adobe Experience Platform中的分析擴充功能。如需擴充功能的詳細資訊，請參閱[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101605.html)上的擴充頁。
...
如需擴充功能設定選項的詳細資訊，請參閱Adobe Exchange上的[Demandbase擴充功能頁面](https://exchange.adobe.com/experiencecloud.details.101605.html)。
