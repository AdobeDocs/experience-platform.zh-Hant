...
Analytics目的地會追蹤訪客與您網站上內容的互動情形，並收集資料以瞭解您的對象行為。 這些平台為您最有價值的訪客提供參與度和轉換的獨特見解。

## 支援的分析目的地 {#supported-destinations}

目前，[!DNL Adobe Experience Platform]支援下列分析目的地。 如需如何連線至這些目的地的詳細資訊，請參閱個別連結：

* [Adform網站追蹤擴充功能](adform.md)
* [Adobe Analytics 擴充功能](adobe-analytics.md)
* [Adobe Media Analytics for Audio and Video擴充功能](adobe-video-analytics.md)
* [Clicktale擴充功能](clicktale.md)
* [Contentsquare副檔名](contentsquare.md)
...
* [Quantum Metric延伸模組](quantum-metric.md)
