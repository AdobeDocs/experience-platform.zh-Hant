---
keywords: JW播放器；JW播放器；JW播放器；JW擴展；JW擴展
title: JW播放器分析(Beta)擴展
description: JW播放器分析(Beta)擴展是Adobe Experience Platform的分析目標。 有關擴展功能的詳細資訊，請參閱AdobeExchange上的擴展頁。
...
# [!DNL JW Player Analytics] (Beta)擴展 {#jw-player-analytics-extension}

## 總覽 {#overview}

此擴展安裝 [!DNL JW Player] 適配器連接 [!DNL JW Player] 事件以Adobe視頻分析。 利用Adobe視頻分析的強大功能，獲得詳細的洞察力，以瞭解客戶的視頻觀看習慣。

[!DNL JW Player Analytics] (Beta)是Adobe Experience Platform的分析分析擴展。 有關擴展功能的詳細資訊，請參閱上的擴展頁 [AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101523.jw-player-analytics-launch-extension.html)。

此目標是標籤擴展。 有關標籤擴展在平台中如何工作的詳細資訊，請參見 [標籤擴展概述](../launch-extensions/overview.md)。

![JW分析擴展](../../assets/catalog/analytics/jw-analytics/catalog.png)
...
安裝 [!DNL JW Player Analytics] (Beta)擴展：
...
有關擴展配置選項的資訊，請參見 [JW播放器分析(Beta)擴展頁](https://exchange.adobe.com/experiencecloud.details.101523.jw-player-analytics-launch-extension.html) Adobe。
