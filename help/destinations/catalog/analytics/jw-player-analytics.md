...
description: JW Player Analytics（測試版）擴充功能是Adobe Experience Platform的分析目的地。 如需擴充功能的詳細資訊，請參閱Adobe交換的擴充功能頁面。
...
此擴充功能會安裝[!DNL JW Player]介面卡，將[!DNL JW Player]事件連線至「Adobe視訊分析」。 利用Adobe視訊分析的強大功能，獲得深入見解，以瞭解客戶的視訊觀看習慣。

[!DNL JW Player Analytics] （測試版）是Adobe Experience Platform的分析擴充功能。有關擴展功能的詳細資訊，請參閱[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101523.jw-player-analytics-launch-extension.html)上的擴展頁。
...
![JW分析擴充功能](../../assets/catalog/analytics/jw-analytics/catalog.png)
...
如需擴充功能設定選項的詳細資訊，請參閱Adobe交換中的[JW Player Analytics(Beta)擴充功能頁面](https://exchange.adobe.com/experiencecloud.details.101523.jw-player-analytics-launch-extension.html)。
