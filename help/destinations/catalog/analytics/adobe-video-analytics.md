...
title: Adobe Media Analytics for Audio and Video擴充功能
description: Adobe Media Analytics for Audio and Video擴充功能是Adobe Experience Platform中的分析目的地。 如需擴充功能的相關詳細資訊，請參閱Adobe Exchange上的擴充功能頁面。
...
# Adobe Media Analytics for Audio and Video擴充功能 {#adobe-analytics-for-video-extension}

## 概觀 {#overview}

Adobe Media Analytics for Audio and Video是基礎Analytics產品的附加元件，可提供客戶強大的視訊、音訊和廣告測量。

Adobe Media Analytics for Audio and Video是[!DNL Adobe Experience Platform]中的Analytics擴充功能。 如需有關擴充功能功能的詳細資訊，請參閱[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100157.html)上的擴充功能頁面。
...
若要安裝[!DNL Adobe Analytics] for Video擴充功能：
...
如需擴充功能組態選項的相關資訊，請參閱標籤檔案中的[Adobe Media Analytics for Audio and Video擴充功能頁面](../../../tags/extensions/client/media-analytics/overview.md)。
