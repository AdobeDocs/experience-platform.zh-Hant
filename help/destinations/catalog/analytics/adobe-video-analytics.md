...
Adobe MediumAnalytics for Audio and Video是Adobe Experience Platform中的Analytics擴充功能。 如需擴充功能的詳細資訊，請參閱 [AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100157.html).
...
如需擴充功能組態選項的相關資訊，請參閱 [Adobe MediumAnalytics for Audio and Video擴充功能頁面](../../../tags/extensions/client/media-analytics/overview.md) 在標籤檔案中。
