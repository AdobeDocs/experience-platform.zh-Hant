---
keywords: media analytics擴充功能；media analytics；音訊和視訊擴充功能
...
Adobe MediumAnalytics for Audio and Video是基本Analytics產品的附加元件，可為用戶端提供強大的視訊、音訊和廣告測量。

Adobe MediumAnalytics for Audio and Video是Adobe Experience Platform中的Analytics擴充功能。 如需擴充功能的詳細資訊，請參閱[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100157.html)上的擴充功能頁面。
...
如需擴充功能設定選項的相關資訊，請參閱[!DNL Experience Launch]檔案中的[Adobe MediumAnalytics for Audio and Video擴充功能頁面](../../../tags/extensions/web/media-analytics/overview.md)。
