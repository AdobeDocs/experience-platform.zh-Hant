---
keywords: Nielsen VideoJS播放器處理常式；nielsen視訊js播放器；nielsen;nielsen;Nielsen videojs播放器；Nielsen Digital SDK;nielsen數位sdk
...
[!DNL Nielsen VideoJS Player Handler] 是Adobe Experience Platform中的analytics擴充功能。 如需擴充功能的詳細資訊，請參閱 [AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101361.nielsen-digital-sdk-extension.html).
...
如需擴充功能組態選項和安裝支援的相關資訊，請參閱 [Nielsen Digital SDK頁面在AdobeExchange上](https://exchange.adobe.com/experiencecloud.details.101361.nielsen-digital-sdk-extension.html).
