---
keywords: Nielsen VideoJS播放器處理常式；nielsen視訊js播放器；nielsen;nielsen;Nielsen視訊js播放器；Nielsen Digital SDK;nielsen數位sdk
...
[!DNL Nielsen Digital SDK] launch擴充功能透過下列數位測量產品提供對象測量：
...
[!DNL Nielsen VideoJS Player Handler] 是Adobe Experience Platform中的analytics擴充功能。如需擴充功能的詳細資訊，請參閱[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101361.nielsen-digital-sdk-extension.html)上的擴充功能頁面。
...
要安裝[!DNL Nielsen VideoJS Player Handler]擴展，請執行以下操作：
...
如需擴充功能組態選項和安裝支援的相關資訊，請參閱AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101361.nielsen-digital-sdk-extension.html)上的[Nielsen數位SDK頁面。
