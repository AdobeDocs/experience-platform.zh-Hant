---
keywords: Nielsen VideoJS播放器處理常式；nielsen video js播放器；nielsen videojs播放器；Nielsen；Nielsen；Nielsen videojs播放器；Nielsen Digital SDK；nielsen digital sdk
title: Nielsen VideoJS播放器處理常式擴充功能
description: Nielsen VideoJS Player Handler擴充功能是Adobe Experience Platform中的分析目的地。 如需擴充功能的相關詳細資訊，請參閱Adobe Exchange上的擴充功能頁面。
...
DCR：提供非線性數位內容（包括廣告內容）每日測量的測量解決方案，可全面瞭解跨案頭、行動裝置、平板電腦及連線裝置的數位內容受眾使用情況。

DTVR：對於參與的節目來源，這會說明在桌上型電腦和行動裝置上發生的線性電視觀看事件。 這是第一個因在電腦和行動裝置上檢視的節目中，對電視觀眾測量貢獻而獲得MRC認證的解決方案。

[!DNL Nielsen VideoJS Player Handler]是Adobe Experience Platform中的Analytics擴充功能。 如需有關擴充功能功能的詳細資訊，請參閱[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.nielsen-digital-sdk-extension.html)上的擴充功能頁面。

此目的地是標籤延伸模組。 如需標籤擴充功能在Platform中如何運作的詳細資訊，請參閱[標籤擴充功能概觀](../launch-extensions/overview.md)。

![Nielsen VideoJS播放器處理常式延伸](../../assets/catalog/analytics/nielsen-videojs/catalog.png)
...
若要安裝[!DNL Nielsen VideoJS Player Handler]擴充功能：
...
如需有關擴充功能組態選項和安裝支援的資訊，請參閱Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.nielsen-digital-sdk-extension.html)上的[Nielsen Digital SDK頁面。
