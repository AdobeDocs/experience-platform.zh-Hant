...
description: Contentsquare擴充功能是Adobe Experience Platform中的分析目的地。 如需擴充功能的詳細資訊，請參閱Adobe Exchange的擴充功能頁面。
seo-description: Contentsquare擴充功能是Adobe Experience Platform中的分析目的地。 如需擴充功能的詳細資訊，請參閱Adobe Exchange的擴充功能頁面。
...
[!DNL Contentsquare] 是Adobe Experience Platform中的分析擴充功能。如需擴充功能的詳細資訊，請參閱[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100364.html)上的擴充頁。
...
如需擴充功能設定選項的詳細資訊，請參閱Adobe Exchange上的[Contentsquare擴充功能頁面](https://exchange.adobe.com/experiencecloud.details.100364.html)。
