---
keywords: contentsquare副檔名；contentsquare目的地；contentsquare
title: Contentsquare副檔名
description: Contentsquare擴充功能是Adobe Experience Platform中的分析目的地。 如需擴充功能的相關詳細資訊，請參閱Adobe Exchange上的擴充功能頁面。
...
[!DNL Contentsquare]是[!DNL Adobe Experience Platform]中的Analytics擴充功能。 如需有關擴充功能功能的詳細資訊，請參閱[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100364.html)上的擴充功能頁面。

此目的地是標籤延伸模組。 如需有關標籤擴充功能在Experience Platform中如何運作的詳細資訊，請參閱[標籤擴充功能概觀](../launch-extensions/overview.md)。

![Contentsquare延伸](../../assets/catalog/analytics/contentsquare/catalog.png)
...
如需擴充功能組態選項的相關資訊，請參閱Adobe Exchange上的[Contentsquare擴充功能頁面](https://exchange.adobe.com/experiencecloud.details.100364.html)。
