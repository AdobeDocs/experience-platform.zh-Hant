---
keywords: contentsquare擴展；contentsquare目標；contentsquare
title: Contentsquare擴展
description: Contentsquare擴充功能是Adobe Experience Platform中的分析目的地。 如需擴充功能的詳細資訊，請參閱Exchange上的擴充功能頁面。
...
將頁面內行為視覺化，了解客戶為何放棄以及如何改善。 為每個Analytics區段和Target測試的UX和內容元素帶來收入。 安裝[!DNL Contentsquare]標籤，設定自訂變數和事件。 只需按幾下，即可開始收集UX分析的資料。

[!DNL Contentsquare] 是Adobe Experience Platform中的analytics擴充功能。如需擴充功能的詳細資訊，請參閱[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100364.html)上的擴充功能頁面。

此目的地是標籤擴充功能。 如需有關標籤擴充功能在Platform中如何運作的詳細資訊，請參閱[標籤擴充功能概述](../launch-extensions/overview.md)。

![Contentsquare擴展](../../assets/catalog/analytics/contentsquare/catalog.png)
...
要安裝[!DNL Contentsquare]擴展，請執行以下操作：
...
如需擴充功能設定選項的相關資訊，請參閱Exchange上的[Contentsquare擴充功能頁面](https://exchange.adobe.com/experiencecloud.details.100364.html)。
