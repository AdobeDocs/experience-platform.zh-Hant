---
keywords: 會話凸輪；會話凸輪；會話凸輪
title: SessionCam擴展
description: SessionCam擴展是Adobe Experience Platform的分析目標。 有關擴展功能的詳細資訊，請參閱AdobeExchange上的擴展頁。
...
[!DNL SessionCam] 提供了一套重要的工具，可揭示用戶行為並向您顯示要修復的最重要問題。

[!DNL SessionCam] 是Adobe Experience Platform的分析推廣。 有關擴展功能的詳細資訊，請參閱上的擴展頁 [AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100517.html)。

此目標是標籤擴展。 有關標籤擴展在平台中如何工作的詳細資訊，請參見 [標籤擴展概述](../launch-extensions/overview.md)。

![SessionCam擴展](../../assets/catalog/analytics/sessioncam/catalog.png)
...
有關擴展配置選項和安裝支援的資訊，請參見 [AdobeExchange上的SessionCam頁](https://exchange.adobe.com/experiencecloud.details.100517.html)。
