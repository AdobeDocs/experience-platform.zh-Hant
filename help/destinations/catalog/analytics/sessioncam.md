...
[!DNL SessionCam]是[!DNL Adobe Experience Platform]中的Analytics擴充功能。 如需有關擴充功能功能的詳細資訊，請參閱[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100517.html)上的擴充功能頁面。
...
如需有關擴充功能組態選項和安裝支援的資訊，請參閱Adobe Exchange[上的](https://exchange.adobe.com/experiencecloud.details.100517.html)SessionCam頁面。
