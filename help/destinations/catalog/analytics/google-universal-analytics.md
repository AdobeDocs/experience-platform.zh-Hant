...
description: Google Universal Analytics擴充功能是Adobe Experience Platform中的分析目的地。 如需擴充功能的詳細資訊，請參閱Exchange上的擴充功能頁面。
...
[!DNL Google Universal Analytics] 是Adobe Experience Platform中的analytics擴充功能。如需擴充功能的詳細資訊，請參閱[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.102829.google-universal-analytics.html)上的擴充功能頁面。
...
要安裝[!DNL Google Universal Analytics]擴展，請執行以下操作：
...
如需擴充功能設定選項的相關資訊，請參閱Exchange上的[Google Universal Analytics擴充功能頁面](https://exchange.adobe.com/experiencecloud.details.102829.google-universal-analytics.html)。
