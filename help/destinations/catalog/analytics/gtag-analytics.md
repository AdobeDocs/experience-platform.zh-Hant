...
description: Google全域網站標籤擴充功能是Adobe Experience Platform中的分析目的地。 如需擴充功能的相關詳細資訊，請參閱Adobe交換上的擴充功能頁面。
...
傳送資料至 [!DNL Google Analytics]， [!DNL Google Ads]，以及 [!DNL Google Marketing Platform] 透過 [!DNL Google's Global Site Tag]或gtag.js。 每個產品可設定多個帳戶。

[!DNL Google Global Site Tag] 是Adobe Experience Platform中的analytics擴充功能。 如需擴充功能的相關詳細資訊，請參閱擴充功能頁面，網址為 [Adobe交換](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html).
...
若要安裝 [!DNL Google Global Site Tag] 副檔名：
...
如需擴充功能組態選項的相關資訊，請參閱擴充功能的 [Adobe交換](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html) 頁面。
