---
keywords: Google全局站點標籤；gtag;google gtag;google extension;google gtag extension;GTAG
title: Google全球站點標籤擴展
description: Google全球站點標籤擴展是Adobe Experience Platform的分析目的地。 有關擴展功能的詳細資訊，請參閱AdobeExchange上的擴展頁。
...
將資料發送到 [!DNL Google Analytics]。 [!DNL Google Ads]的 [!DNL Google Marketing Platform] 通過 [!DNL Google's Global Site Tag]，或gtag.js。 可以配置每個產品的多個帳戶。

[!DNL Google Global Site Tag] 是Adobe Experience Platform的分析推廣。 有關擴展功能的詳細資訊，請參閱上的擴展頁 [AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html)。

此目標是標籤擴展。 有關標籤擴展在平台中如何工作的詳細資訊，請參見 [標籤擴展概述](../launch-extensions/overview.md)。

![Google全球站點標籤擴展](../../assets/catalog/analytics/gtag-analytics/catalog.png)
...
安裝 [!DNL Google Global Site Tag] 擴展：
...
有關擴展配置選項的資訊，請參閱 [AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html) 的子菜單。
