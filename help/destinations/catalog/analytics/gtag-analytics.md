...
將資料傳送至 [!DNL Google Analytics], [!DNL Google Ads]，和 [!DNL Google Marketing Platform] via [!DNL Google's Global Site Tag]，或gtag.js。 可為每個產品配置多個帳戶。

[!DNL Google Global Site Tag] 是Adobe Experience Platform中的analytics擴充功能。 如需擴充功能的詳細資訊，請參閱 [AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html).
