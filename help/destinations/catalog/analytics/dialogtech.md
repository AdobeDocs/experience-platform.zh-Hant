---
keywords: dialogtech擴充功能；dialogtech;dialogtech目的地；DialogTech;DialogTech SourceTrak
title: DialogTech擴充功能
description: DialogTech擴充功能是Adobe Experience Platform中的分析目的地。 如需擴充功能的詳細資訊，請參閱Exchange上的擴充功能頁面。
...
在AdobeLaunch中加入[!DNL DialogTech SourceTrak] javascript程式碼片段

[!DNL DialogTech] 是Adobe Experience Platform中的analytics擴充功能。如需擴充功能的詳細資訊，請參閱[Dialogtech網站](https://www.dialogtech.com/)。
...
![DialogTech擴充功能](../../assets/catalog/analytics/dialogtech/catalog.png)
