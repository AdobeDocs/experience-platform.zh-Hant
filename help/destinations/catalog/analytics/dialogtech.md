...
description: DialogTech擴充功能是Adobe Experience Platform的分析目的地。 如需擴充功能的詳細資訊，請參閱Adobe交換的擴充功能頁面。
...
在Adobe啟動中包含[!DNL DialogTech SourceTrak] javascript程式碼片段

[!DNL DialogTech] 是Adobe Experience Platform的分析擴充功能。如需擴充功能的詳細資訊，請參閱[Dialogtech網站](https://www.dialogtech.com/)。
