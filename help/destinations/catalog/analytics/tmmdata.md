...
title: TMMData擴充功能
description: TMMData擴充功能是Adobe Experience Platform的分析目的地。 如需擴充功能的詳細資訊，請參閱Adobe交換的擴充功能頁面。
...
[!DNL TMMData's] Adobe Marketing Cloud的基礎平台為行銷團隊提供工具，以存取和混合其所有關鍵資料來源——包括內部／外部和線上／離線資料——以進行自信、全面的跨通道分析，並自動設定宣傳活動，並直接匯入Adobe和其他分析和BI工具。

[!DNL TMMData] 是Adobe Experience Platform的分析擴充功能。有關擴展功能的詳細資訊，請參閱[AdobeExchange](hhttps://exchange.adobe.com/experiencecloud.details.100148.tmmdata-foundation-platform.html)上的擴展頁。
...
有關擴展配置選項和安裝支援的資訊，請參見AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100148.tmmdata-foundation-platform.html)上的[TMMData頁。
