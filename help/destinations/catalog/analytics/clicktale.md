...
title: 點擊表擴展
description: Clicktale擴展是Adobe Experience Platform的分析目標。 有關擴展功能的詳細資訊，請參閱AdobeExchange上的擴展頁。
...
的 [!DNL Clicktale] 標籤擴展允許您使用 [!DNL Clicktale's] 可視編輯器。

[!DNL Clicktale] 是Adobe Experience Platform的分析推廣。 有關擴展功能的詳細資訊，請參閱上的擴展頁 [AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100082.html)。

此目標是標籤擴展。 有關標籤擴展在平台中如何工作的詳細資訊，請參見 [標籤擴展概述](../launch-extensions/overview.md)。

![點擊表擴展](../../assets/catalog/analytics/clicktale/catalog.png)
...
有關擴展配置選項的資訊，請參見 [按一下表擴展頁](https://exchange.adobe.com/experiencecloud.details.100082.html) Adobe。
