...
title: Clicktale擴充功能
description: Clicktale擴充功能是Adobe Experience Platform的分析目的地。 如需擴充功能的詳細資訊，請參閱Adobe交換的擴充功能頁面。
...
[!DNL Clicktale's] 與Experience Platform Launch的整合可讓您使用 [!DNL Clicktale] 視覺編輯器部署程式碼，以及在Launch中對應資料 [!DNL Clicktale's] 元素。

[!DNL Clicktale] 是Adobe Experience Platform的分析擴充功能。有關擴展功能的詳細資訊，請參閱[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100082.html)上的擴展頁。
...
如需擴充功能設定選項的詳細資訊，請參閱「Adobe交換」中的[Clicktale擴充功能頁面](https://exchange.adobe.com/experiencecloud.details.100082.html)。
