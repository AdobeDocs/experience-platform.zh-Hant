...
此 [!DNL Clicktale] 標籤擴充功能可讓您使用 [!DNL Clicktale's] 可視編輯器。

[!DNL Clicktale] 是Adobe Experience Platform中的analytics擴充功能。 如需擴充功能的詳細資訊，請參閱 [AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100082.html).
...
如需擴充功能組態選項的相關資訊，請參閱 [Clicktale擴充功能頁面](https://exchange.adobe.com/experiencecloud.details.100082.html) 在AdobeExchange中。
