...
目的地可讓企業對企業(B2B)資料從[!DNL Adobe Experience Platform]傳輸至Marketo Measure。 此卡僅限Marketo Measure Ultimate客戶使用。

## 使用案例 {#use-cases}

為協助您更清楚瞭解您應如何使用Marketo Measure目的地，以下是[!DNL Adobe Experience Platform]客戶可以使用此目的地解決的範例使用案例。 此整合：
...
| 對象資料型別 | 支援 | 說明 | 使用案例 |
|--------------------|-----------|-------------|-----------|
| [人員對象](/help/segmentation/types/people-audiences.md) | 無 | 根據客戶設定檔，可讓您針對行銷活動的特定人群進行定位。 | 經常購買者、購物車放棄者 |
