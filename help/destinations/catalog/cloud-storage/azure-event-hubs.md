...
在UI中![AWS Kinesis](../../assets/catalog/cloud-storage/event-hubs/catalog.png)
...
Experience Platform會最佳化您[!DNL Azure Event Hubs]目的地的設定檔匯出行為，以只在對象資格或其他重大事件後發生設定檔的相關更新時，將資料匯出至您的目的地。 在下列情況下，設定檔會匯出至您的目的地：
