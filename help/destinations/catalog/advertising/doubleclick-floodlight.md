...
description: DoubleClick Floodlight(Beta)擴充功能是Adobe Experience Platform的廣告目的地。 如需擴充功能的詳細資訊，請參閱Adobe交換的擴充功能頁面。
...
[!DNL DoubleClick Floodlight] (Beta)是Adobe Experience Platform的廣告推廣。如需擴充功能的詳細資訊，請參閱[DoubleClick Floodlight](https://support.google.com/dcm/answer/2823388?hl=en)的[!DNL Google]支援檔案。
