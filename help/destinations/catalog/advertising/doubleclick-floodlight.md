...
[!DNL DoubleClick Floodlight] (Beta)是Adobe Experience Platform中的廣告擴充功能。 如需有關擴充功能功能的詳細資訊，請參閱[!DNL Google]DoubleClick Floodlight[的](https://support.google.com/dcm/answer/2823388?hl=en)支援檔案。
