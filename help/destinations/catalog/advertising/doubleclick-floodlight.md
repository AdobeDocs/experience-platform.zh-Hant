...
[!DNL DoubleClick Floodlight] （測試版）是Adobe Experience Platform中的廣告延伸。如需擴充功能的詳細資訊，請參閱[DoubleClick Floodlight](https://support.google.com/dcm/answer/2823388?hl=en)的[!DNL Google]支援檔案。
