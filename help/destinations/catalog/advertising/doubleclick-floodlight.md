...
[!DNL DoubleClick Floodlight] (Beta)是[!DNL Adobe Experience Platform]中的Advertising擴充功能。 如需有關擴充功能功能的詳細資訊，請參閱[DoubleClick Floodlight](https://support.google.com/dcm/answer/2823388?hl=en)的[!DNL Google]支援檔案。
