...
[!DNL Pinterest Conversion Tracking] 是Adobe Experience Platform中的廣告擴充功能。如需擴充功能的詳細資訊，請參閱[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100523.pinterest-conversion-tracking-for-adobe-launch.html)上的擴充功能頁面。
...
要安裝[!DNL Pinterest Conversion Tracking]擴展，請執行以下操作：
...
如需擴充功能設定選項和安裝支援的相關資訊，請參閱AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100523.pinterest-conversion-tracking-for-adobe-launch.html)上的[Pinterest轉換追蹤頁面。
