...
| EMAIL | 電子郵件地址（純文字或使用SHA256演演算法雜湊） | [!DNL Adobe Experience Platform]同時支援純文字和SHA256雜湊電子郵件地址。 <br>將&#x200B;*Email*&#x200B;或&#x200B;*Email_LC_SHA256*&#x200B;來源身分名稱空間對應到目標身分識別欄位&#x200B;*pinterest_audience*。 |
...
| 項目 | 類型 | 附註 |
|---------|----------|---------|
| 匯出類型 | **[!UICONTROL Audience export]** | 您正在匯出具有Pinterest客戶清單目的地所使用識別碼（名稱、電話號碼或其他）的對象所有成員。 |
...
為協助您更清楚瞭解您應如何及何時使用[!DNL Pinterest Customer List]目的地，以下是[!DNL Adobe Experience Platform]客戶可以使用此目的地解決的範例使用案例。
...
* **[!UICONTROL Ad Account ID]**：您的Pinterest廣告商ID。

### 重新整理驗證認證 {#refresh-authentication-credentials}

Pinterest Token每30天過期一次。 您可以從&#x200B;**[!UICONTROL Account expiration date]**&#x200B;或&#x200B;**[[!UICONTROL Accounts]](../../ui/destinations-workspace.md#accounts)**&#x200B;索引標籤中的&#x200B;**[[!UICONTROL Browse]](../../ui/destinations-workspace.md#browse)**&#x200B;欄監視權杖到期日。
...
4. 在強制回應視窗中，選取&#x200B;**[!UICONTROL Reconnect OAuth]**&#x200B;並使用您的Pinterest認證重新驗證。
...
如需其他資訊，請參閱[Pinterest說明中心頁面](https://help.pinterest.com/en/business/article/audience-targeting)。
...
| 發行月份 | 更新型別 | 說明 |
|---|---|---|
| 2023 年 11 月 | 功能和檔案更新 | [!DNL Real-Time CDP]中的Pinterest目的地現在使用v5廣告商API。 |
