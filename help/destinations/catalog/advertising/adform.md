...
使用此目的地將Adobe [!DNL Real-Time CDP]對象傳送至Adform，以根據Experience Cloud ID (ECID)和Adform的ID Fusion來啟用。 Adform的ID Fusion是Adform的ID解析服務，可讓您根據Experience Cloud ID (ECID)啟用第一方對象。
