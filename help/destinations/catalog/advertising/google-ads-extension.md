---
keywords: Google廣告；谷歌廣告；谷歌廣告擴展；Google廣告擴展
title: Google廣告分機
description: Google廣告分店是Adobe Experience Platform的一個廣告目的地。 有關擴展功能的詳細資訊，請參閱AdobeExchange上的擴展頁。
...
此擴展可跟蹤按一下您 [!DNL Google Ads]。 您還需要安裝gtag.js擴展，並將其添加到庫，如 [!DNL Google Ads] 取決於它。

[!DNL Google Ads] 是Adobe Experience Platform的廣告推廣。 有關擴展功能的詳細資訊，請參閱上的擴展頁 [AdobeExchange](https://www.adobeexchange.com/experiencecloud.details.101383.google-ads.html)。

此目標是標籤擴展。 有關標籤擴展在平台中如何工作的詳細資訊，請參見 [標籤擴展概述](../launch-extensions/overview.md)。

![Google廣告分機](../../assets/catalog/advertising/google-ads-extension/catalog.png)
...
有關擴展配置選項和安裝支援的資訊，請參見 [Google廣告Adobe交易](https://www.adobeexchange.com/experiencecloud.details.101383.google-ads.html)。
