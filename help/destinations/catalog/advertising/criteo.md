...
| 目標身分 | 說明 | 考量事項 |
| --- | --- | --- |
| `email_sha256` | 使用SHA-256演演算法雜湊的電子郵件地址 | Adobe Experience Platform同時支援純文字和SHA-256雜湊電子郵件地址。 當您的來源欄位包含未雜湊的屬性時，請核取[!UICONTROL Apply transformation]選項，讓Experience Platform在啟用時自動雜湊資料。 |
