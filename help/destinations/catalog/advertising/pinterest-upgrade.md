...
>[!IMPORTANT]
>
>pinterest如果您的組織已設定資料流，讓可在2023年11月16日(當天的 **[!UICONTROL （新） Pinterest]** 使用最新Pinterest API的目的地已新增至目的地目錄。
...
是，在2023年11月16日之後，您需要使用Real-Time CDP中的Pinterest廣告商帳戶對新的Pinterest目的地進行驗證。 請參閱以下的詳細說明。
