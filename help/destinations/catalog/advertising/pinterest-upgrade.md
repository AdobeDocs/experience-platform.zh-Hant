...
Pinterest已棄用Real-Time CDP中[Pinterest目的地](/help/destinations/catalog/advertising/pinterest.md)使用的v4廣告商API。 Adobe已更新目的地以使用[v5廣告商API](https://developers.pinterest.com/docs/getting-started/migration/)。 請閱讀本頁面，瞭解您的行動專案，以便順暢地轉換至新的API，而不會干擾您的Pinterest行銷活動。
