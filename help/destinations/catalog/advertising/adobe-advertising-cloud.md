---
keywords: Advertising Cloud；廣告雲擴展；廣告雲端目標
title: Adobe Advertising Cloud分機
description: Adobe Advertising Cloud分機是Adobe Experience Platform的一個廣告目的地。 如需擴充功能的詳細資訊，請參閱Adobe交換的擴充功能頁面。
...
# Adobe Advertising Cloud分機{#adobe-advertising-cloud-extension}

## 概述 {#overview}

這是[!DNL Advertising Cloud]擴充功能，用於實作[!DNL Advertising Cloud]轉換和區段標籤(目前不支援DSPDCO)。

Adobe Advertising Cloud是Adobe Experience Platform的廣告推廣商。
...
![Adobe Advertising Cloud分機](../../assets/catalog/advertising/adobe-advertising-cloud/catalog.png)
