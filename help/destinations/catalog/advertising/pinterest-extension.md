---
title: Pinterest轉換跟蹤擴展
description: pinterest轉換跟蹤擴展是Adobe Experience Platform的一個廣告目的地。 有關擴展功能的詳細資訊，請參閱AdobeExchange上的擴展頁。
...
在查看已升級的Pin後跟蹤您網站上的訪問者操作。 衡量廣告支出的回報並建立目標受眾。 如需更多詳情，請參閱[此處](https://ads.pinterest.com/)。

[!DNL Pinterest Conversion Tracking] 是Adobe Experience Platform的廣告推廣。 有關擴展功能的詳細資訊，請參閱上的擴展頁 [AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100523.pinterest-conversion-tracking-for-adobe-launch.html)。

此目標是標籤擴展。 有關標籤擴展在平台中如何工作的詳細資訊，請參見 [標籤擴展概述](../launch-extensions/overview.md)。

![Pinterest轉換跟蹤擴展](../../assets/catalog/advertising/pinterest/catalog.png)
...
安裝 [!DNL Pinterest Conversion Tracking] 擴展：
...
有關擴展配置選項和安裝支援的資訊，請參見 [PinterestAdobeExchange上的轉換跟蹤頁](https://exchange.adobe.com/experiencecloud.details.100523.pinterest-conversion-tracking-for-adobe-launch.html)。
