---
keywords: facebook pixel擴充功能；facebook pixel擴充功能；facebook pixel目的地；facebook pixel
title: facebook Pixel擴充功能
description: facebook Pixel擴充功能是Adobe Experience Platform中的廣告目的地。 如需擴充功能的相關詳細資訊，請參閱Adobe交換上的擴充功能頁面。
...
此 [!DNL Facebook Pixel] 是一款分析工具，可讓您透過瞭解訪客在您網站上採取的行動，來評估廣告效益。

[!DNL Facebook Pixel] 是Adobe Experience Platform中的廣告擴充功能。 如需擴充功能的相關詳細資訊，請參閱 [facebook Pixel網站](https://developers.facebook.com/docs/facebook-pixel/).
