---
keywords: facebook畫素擴充功能；facebook畫素擴充功能；facebook畫素目的地；facebook畫素
title: facebook畫素擴充功能
...
[!DNL Facebook Pixel]是Adobe Experience Platform中的廣告擴充功能。 如需關於擴充功能功能的詳細資訊，請參閱[Facebook Pixel網站](https://developers.facebook.com/docs/facebook-pixel/)。

此目的地是標籤延伸模組。 如需標籤擴充功能在Platform中如何運作的詳細資訊，請參閱[標籤擴充功能概觀](../launch-extensions/overview.md)。

![Facebook Pixel延伸模組](../../assets/catalog/advertising/facebook-pixel/catalog.png)
