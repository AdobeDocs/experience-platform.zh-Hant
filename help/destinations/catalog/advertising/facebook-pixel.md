...
description: Facebook Pixel擴充功能是Adobe Experience Platform的廣告目的地。 如需擴充功能的詳細資訊，請參閱Adobe交換的擴充功能頁面。
...
[!DNL Facebook Pixel] 是Adobe Experience Platform的廣告推廣。如需擴充功能的詳細資訊，請參閱[Facebook Pixel網站](https://developers.facebook.com/docs/facebook-pixel/)。
