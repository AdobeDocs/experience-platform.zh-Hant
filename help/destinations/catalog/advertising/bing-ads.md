...
[!DNL Bing Ads Universal Event Tracking] (UET)for是 [!DNL Experience Platform Launch] 追蹤某人點按您的搜尋廣告後所發生內容的實用方法。使用單一UET標籤來記錄客戶在您網站上的行為，您可以運用該資料，讓您使用再行銷清單來追蹤轉換或鎖定對象。
