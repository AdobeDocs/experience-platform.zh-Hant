...
description: Bing Ads通用事件追蹤(UET)擴充功能是Adobe Experience Platform的廣告目的地。 如需擴充功能的詳細資訊，請參閱Adobe交換的擴充功能頁面。
...
[!DNL Bing Ads Universal Event Tracking] (UET)為Adobe Experience Platform的廣告延伸。有關擴展功能的詳細資訊，請參閱[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100154.html)上的擴展頁。
...
有關擴展配置選項和安裝支援的資訊，請參閱AdobeExchange上的[Bing Ads通用事件跟蹤(UET)頁。](https://exchange.adobe.com/experiencecloud.details.100154.html)
