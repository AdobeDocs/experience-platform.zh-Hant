...
此 [!DNL Bing Ads Universal Event Tracking] (UET)標籤擴充功能是追蹤某人點按您的搜尋廣告後所發生內容的實用方式。 使用單一UET標籤來記錄客戶在您網站上的行為，您可以運用該資料，讓您使用再行銷清單來追蹤轉換或鎖定對象。

[!DNL Bing Ads Universal Event Tracking] (UET)是Adobe Experience Platform的廣告擴充功能。 如需擴充功能的詳細資訊，請參閱 [AdobeExchange](https://exchange.adobe.com/experiencecloud.details.100154.html).
...
如需擴充功能組態選項和安裝支援的相關資訊，請參閱 [Bing AdsAdobeExchange上的通用事件追蹤(UET)頁面](https://exchange.adobe.com/experiencecloud.details.100154.html).
