...
安裝 [!DNL LinkedIn Insight Tag] 若要使用轉換追蹤、重新定位和網站人口統計功能。

[!DNL LinkedIn Insight Tag] 是Adobe Experience Platform中的廣告擴充功能。 如需擴充功能的詳細資訊，請參閱 [linkedIn Insight標籤](https://business.linkedin.com/marketing-solutions/insight-tag).
