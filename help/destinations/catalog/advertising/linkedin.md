---
keywords: linkedIn；linkedin；Linkedin；LinkedIn Insight標籤；Insight標籤
title: linkedIn Insight標籤擴充功能
description: linkedIn Insight Tag擴充功能是Adobe Experience Platform中的廣告目的地。 如需擴充功能的相關詳細資訊，請參閱Adobe Exchange上的擴充功能頁面。
...
如需擴充功能組態選項和安裝支援的相關資訊，請參閱[LinkedIn Insight標籤](https://business.linkedin.com/marketing-solutions/insight-tag)。
