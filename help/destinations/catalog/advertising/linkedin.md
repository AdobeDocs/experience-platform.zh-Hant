...
description: LinkedIn Insight Tag擴充功能是即時客戶資料平台中的廣告目的地。 如需擴充功能的詳細資訊，請參閱Adobe Exchange的擴充功能頁面。
seo-description: LinkedIn Insight Tag擴充功能是即時客戶資料平台中的廣告目的地。 如需擴充功能的詳細資訊，請參閱Adobe Exchange的擴充功能頁面。
...
安裝以 [!DNL LinkedIn Insight Tag] 使用轉換追蹤、重新定位和網站人口統計功能。

[!DNL LinkedIn Insight Tag] 是即時客戶資料平台中的廣告延伸。 如需擴充功能的詳細資訊，請參 [閱LinkedIn Insight標籤](https://business.linkedin.com/marketing-solutions/insight-tag)。
...
要安裝擴展 [!DNL LinkedIn Insight Tag] 名：
...
如需擴充功能設定選項和安裝支援的詳細資訊，請參 [閱LinkedIn Insight標籤](https://business.linkedin.com/marketing-solutions/insight-tag)。
