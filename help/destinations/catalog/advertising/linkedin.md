---
keywords: LinkedIn；Linkedin；Linkedin；LinkedIn Insight標籤；insight標籤；Insight標籤
title: LinkedIn Insight標籤擴充功能
description: LinkedIn Insight標籤擴充功能是Adobe Experience Platform中的廣告目的地。 如需擴充功能的相關詳細資訊，請參閱Adobe Exchange上的擴充功能頁面。
...
[!DNL LinkedIn Insight Tag]是[!DNL Adobe Experience Platform]中的Advertising擴充功能。 如需關於擴充功能功能的詳細資訊，請參閱[LinkedIn Insight標籤](https://business.linkedin.com/marketing-solutions/insight-tag)。

此目的地是標籤延伸模組。 如需有關標籤擴充功能在Experience Platform中如何運作的詳細資訊，請參閱[標籤擴充功能概觀](../launch-extensions/overview.md)。

![LinkedIn Insight標籤延伸模組](../../assets/catalog/advertising/linkedin/catalog.png)
...
若要安裝[!DNL LinkedIn Insight Tag]擴充功能：
...
如需有關擴充功能組態選項和安裝支援的資訊，請參閱[LinkedIn Insight標籤](https://business.linkedin.com/marketing-solutions/insight-tag)。
