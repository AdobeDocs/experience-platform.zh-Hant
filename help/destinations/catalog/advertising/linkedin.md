---
keywords: linkedIn;linkedin;Linkedin;LinkedIn Insight標籤；分析標籤；分析標籤
title: linkedIn Insight Tag擴充功能
description: LinkedIn Insight Tag擴充功能是Adobe Experience Platform中的廣告目的地。 如需擴充功能的詳細資訊，請參閱Exchange上的擴充功能頁面。
...
[!DNL LinkedIn Insight Tag] 是Adobe Experience Platform中的廣告擴充功能。如需擴充功能的詳細資訊，請參閱[LinkedIn Insight Tag](https://business.linkedin.com/marketing-solutions/insight-tag)。
...
![linkedIn Insight Tag擴充功能](../../assets/catalog/advertising/linkedin/catalog.png)
...
要安裝[!DNL LinkedIn Insight Tag]擴展，請執行以下操作：
...
如需擴充功能組態選項和安裝支援的相關資訊，請參閱[LinkedIn Insight Tag](https://business.linkedin.com/marketing-solutions/insight-tag)。
