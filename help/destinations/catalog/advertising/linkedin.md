...
description: LinkedIn Insight Tag擴充功能是Adobe Experience Platform的廣告目的地。 如需擴充功能的詳細資訊，請參閱Adobe交換的擴充功能頁面。
...
[!DNL LinkedIn Insight Tag] 是Adobe Experience Platform的廣告推廣。如需擴充功能的詳細資訊，請參閱[LinkedIn Insight Tag](https://business.linkedin.com/marketing-solutions/insight-tag)。
