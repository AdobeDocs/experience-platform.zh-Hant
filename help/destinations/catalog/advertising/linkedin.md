---
keywords: linkedIn；林克丁；林克丁；LinkedIn真知灼見標籤；真知灼見標籤；真知灼見標籤
title: linkedIn洞察標籤擴展
description: LinkedIn真知灼見標籤擴展是Adobe Experience Platform的一個廣告目的地。 有關擴展功能的詳細資訊，請參閱AdobeExchange上的擴展頁。
...
安裝 [!DNL LinkedIn Insight Tag] 使用轉換跟蹤、重定位和網站人口統計功能。

[!DNL LinkedIn Insight Tag] 是Adobe Experience Platform的廣告推廣。 有關擴展功能的詳細資訊，請參見 [linkedIn真知灼見](https://business.linkedin.com/marketing-solutions/insight-tag)。

此目標是標籤擴展。 有關標籤擴展在平台中如何工作的詳細資訊，請參見 [標籤擴展概述](../launch-extensions/overview.md)。

![linkedIn洞察標籤擴展](../../assets/catalog/advertising/linkedin/catalog.png)
...
安裝 [!DNL LinkedIn Insight Tag] 擴展：
...
有關擴展配置選項和安裝支援的資訊，請參見 [linkedIn真知灼見](https://business.linkedin.com/marketing-solutions/insight-tag)。
