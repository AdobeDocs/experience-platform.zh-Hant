...
title: Googlegtag擴展
description: Google加特分機是Adobe Experience Platform的一個廣告目的地。 有關擴展功能的詳細資訊，請參閱AdobeExchange上的擴展頁。
...
# Googlegtag擴展 {#gtag-advertising-extension}

>[!IMPORTANT]
>
>此處介紹的Googlegtag擴展已棄用，並替換為 [[!DNL Google Global Site Tag (gtag)]](https://exchange.adobe.com/apps/ec/101437/google-global-site-tag-gtag) 擴展 [!DNL Acronym]。 您可以找到 [!DNL Google Global Site Tag (gtag)] 擴展 [[!UICONTROL 標籤]](../../../tags/home.md) Experience PlatformUI中的工作區。

## 總覽 {#overview}

負荷Google `gtag.js` 發送事件資料到您的站點 [!DNL Google Analytics]、Google廣告，以及 [!DNL Google Marketing Platform]。 此擴展僅將gtag代碼添加到您的站點。 您需要使用其他Google擴展來添加將使用gtag的事件和操作。

Googlegtag是Adobe Experience Platform的廣告分銷。 有關擴展功能的詳細資訊，請參閱上的擴展頁 [AdobeExchange](https://exchange.adobe.com/experiencecloud.details.102805.google-gtag.html)。

此目標是標籤擴展。 有關標籤擴展在平台中如何工作的詳細資訊，請參見 [標籤擴展概述](../launch-extensions/overview.md)。

![Googlegtag擴展](../../assets/catalog/advertising/gtag-advertising/catalog.png)
...
有關擴展配置選項和安裝支援的資訊，請參見 [GoogleAdobeExchange上的gtag頁](https://exchange.adobe.com/experiencecloud.details.102805.google-gtag.html)。
