...
>[!IMPORTANT]
>
>此處說明的Google gtag擴充功能已過時，並由[!DNL Acronym]開發的[[!DNL Google Global Site Tag (gtag)]](https://exchange.adobe.com/apps/ec/101437/google-global-site-tag-gtag)擴充功能取代。 您可以在資料收集UI或Experience PlatformUI的[[!UICONTROL 標籤]](../../../tags/home.md)工作區中找到[!DNL Google Global Site Tag (gtag)]擴充功能。
