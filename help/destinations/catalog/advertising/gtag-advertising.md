...
>[!IMPORTANT]
>
>此處所述的Google gtag擴充功能已淘汰，並取代為 [[!DNL Google Global Site Tag (gtag)]](https://exchange.adobe.com/apps/ec/101437/google-global-site-tag-gtag) 由 [!DNL Acronym]. 您可以找到 [!DNL Google Global Site Tag (gtag)] 擴充功能 [[!UICONTROL 標籤]](../../../tags/home.md) 工作區(位於資料收集UI或Experience PlatformUI中)。

## 總覽 {#overview}

載入Google `gtag.js` 進入您的網站，將事件資料傳送至 [!DNL Google Analytics]、 Google Ads和 [!DNL Google Marketing Platform]. 此擴充功能只會將標籤程式碼新增至您的網站。 您需要使用其他Google擴充功能，以新增將使用gtag的事件和動作。

Google gtag是Adobe Experience Platform中的廣告擴充功能。 如需擴充功能的詳細資訊，請參閱 [AdobeExchange](https://exchange.adobe.com/experiencecloud.details.102805.google-gtag.html).
...
如需擴充功能組態選項和安裝支援的相關資訊，請參閱 [GoogleAdobeExchange上的Gtag頁面](https://exchange.adobe.com/experiencecloud.details.102805.google-gtag.html).
