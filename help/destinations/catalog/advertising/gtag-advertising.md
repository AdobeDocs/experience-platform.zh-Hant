...
Google gtag是[!DNL Adobe Experience Platform]中的廣告擴充功能。 如需有關擴充功能功能的詳細資訊，請參閱[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.102805.google-gtag.html)上的擴充功能頁面。
