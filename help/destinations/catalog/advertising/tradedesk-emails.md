...
>[!IMPORTANT]
>
>Platform中的[!DNL The Trade Desk - CRM]目的地目前是Beta版。 檔案和功能可能會有所變更。
>
...
>
>Experience Platform中的兩個目的地目前都是測試版。 此目的地聯結器和檔案頁面是由&#x200B;*[!DNL Trade Desk]*&#x200B;團隊建立和維護。 若有任何查詢或更新要求，請連絡您的[!DNL Trade Desk]代表，檔案與功能可能會有所變更。
...
您必須先連絡您的[!DNL The Trade Desk]帳戶管理員以簽署CRM入門合約，才能為[!DNL The Trade Desk]啟用對象。 然後[!DNL The Trade Desk]將授予許可權並共用您的廣告商ID以設定您的目的地。
