---
keywords: twitter；Twitter；twitter通用網站標籤；Twitter通用網站標籤；TwitterUWT標籤；Twitteruwt；twitteruwt
title: twitter通用網站標籤擴充功能
description: twitter通用網站標籤擴充功能是Adobe Experience Platform中的廣告目的地。 如需擴充功能的相關詳細資訊，請參閱Adobe Exchange上的擴充功能頁面。
...
[!DNL Twitter Universal Website Tag]提供傳送信標至TwitterUWT標籤的動作。

[!DNL Twitter Universal Website Tag]是Adobe Experience Platform中的廣告擴充功能。 如需有關擴充功能功能的詳細資訊，請參閱Twitter檔案中的[轉換追蹤](https://business.twitter.com/en/help/campaign-measurement-and-analytics/conversion-tracking-for-websites.html)。

此目的地是標籤延伸模組。 如需標籤擴充功能在Platform中如何運作的詳細資訊，請參閱[標籤擴充功能概觀](../launch-extensions/overview.md)。

![Twitter通用網站標籤延伸](../../assets/catalog/advertising/twitter-uwt/catalog.png)
...
若要安裝[!DNL Twitter Universal Website Tag]擴充功能：
