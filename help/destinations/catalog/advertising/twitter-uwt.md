...
description: Twitter通用網站標籤擴充功能是Adobe Experience Platform的廣告目的地。 如需擴充功能的詳細資訊，請參閱Adobe交換的擴充功能頁面。
...
[!DNL Twitter Universal Website Tag] 是Adobe Experience Platform的廣告推廣。如需擴充功能的詳細資訊，請參閱[進階轉換追蹤](https://business.twitter.com/en/solutions/twitter-ads/website-clicks/advanced-conversion-tracking.html)。
...
要安裝[!DNL Twitter Universal Website Tag]擴展：
