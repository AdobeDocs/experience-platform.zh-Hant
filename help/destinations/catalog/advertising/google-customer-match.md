...
為協助您更清楚瞭解如何使用[!DNL Google Customer Match]目的地，以下是[!DNL Adobe Experience Platform]客戶可以使用此功能解決的範例使用案例。
...
在&#x200B;**[!UICONTROL Segment schedule]**&#x200B;步驟中，傳送[!UICONTROL App ID]或[!DNL IDFA]對象給[!DNL GAID]時，您必須提供[!DNL Google Customer Match]。
