---
keywords: Flashtalking OneTag擴充功能；Flashtalking OneTag擴充功能；Flashtalking OneTag目的地；Flashtalking OneTag；Flashtalking onetag
title: Flashtalking OneTag擴充功能
description: Flashtalking OneTag擴充功能是Adobe Experience Platform中的廣告目的地。 如需擴充功能的相關詳細資訊，請參閱Adobe Exchange上的擴充功能頁面。
...
[!DNL Flashtalking OneTag]標籤擴充功能可讓您輕鬆將網站動作歸因到顯示、影片和行動廣告活動。 使用標籤將[!DNL Flashtalking OneTag]部署至您的Web屬性。

[!DNL Flashtalking OneTag]是[!DNL Adobe Experience Platform]中的Advertising擴充功能。 如需有關擴充功能功能的詳細資訊，請參閱[Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html)上的擴充功能頁面。

此目的地是標籤延伸模組。 如需有關標籤擴充功能在Experience Platform中如何運作的詳細資訊，請參閱[標籤擴充功能概觀](../launch-extensions/overview.md)。

![Flashtalking延伸模組](../../assets/catalog/advertising/flashtalking/catalog.png)
...
若要安裝[!DNL Flashtalking OneTag]擴充功能：
...
如需有關擴充功能組態選項和安裝支援的資訊，請參閱Adobe Exchange[上的](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html)Flashtalking OneTag頁面。
