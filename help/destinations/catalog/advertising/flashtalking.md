---
keywords: Flashtalking OneTag擴展；Flashtalking OneTag擴展；Flashtalking OneTag目標；Flashtalking OneTag;Flashtalking OneTag;Flashtalking oneTag
title: Flashtalking OneTag擴展
description: Flashtalking OneTag擴充功能是Adobe Experience Platform中的廣告目的地。 如需擴充功能的詳細資訊，請參閱Exchange上的擴充功能頁面。
...
[!DNL Flashtalking OneTag] 是Adobe Experience Platform中的廣告擴充功能。如需擴充功能的詳細資訊，請參閱[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html)上的擴充功能頁面。
...
要安裝[!DNL Flashtalking OneTag]擴展，請執行以下操作：
...
如需擴充功能組態選項和安裝支援的相關資訊，請參閱AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html)上的[Flashtalking OneTag頁面。
