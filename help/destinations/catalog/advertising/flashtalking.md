...
description: Flashtalking OneTag擴充功能是Adobe Experience Platform的廣告目的地。 如需擴充功能的詳細資訊，請參閱Adobe交換的擴充功能頁面。
...
[!DNL Flashtalking OneTag]擴充功能可讓您輕鬆將網站動作歸因於顯示、視訊和行動廣告活動。 使用Launch將[!DNL Flashtalking OneTag]部署至您的Web屬性。

[!DNL Flashtalking OneTag] 是Adobe Experience Platform的廣告推廣。有關擴展功能的詳細資訊，請參閱[AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html)上的擴展頁。
...
有關擴展配置選項和安裝支援的資訊，請參見AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html)上的[ Flashtalking OneTag頁。
