...
此 [!DNL Flashtalking OneTag] 標籤擴充功能可讓您輕鬆歸因網站動作，以顯示、影片和行動廣告活動。 部署 [!DNL Flashtalking OneTag] 使用標籤來傳送至您的Web屬性。

[!DNL Flashtalking OneTag] 是Adobe Experience Platform中的廣告擴充功能。 如需擴充功能的詳細資訊，請參閱 [AdobeExchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html).
...
如需擴充功能組態選項和安裝支援的相關資訊，請參閱 [Flashtalking OneTag頁面(在AdobeExchange上)](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html).
