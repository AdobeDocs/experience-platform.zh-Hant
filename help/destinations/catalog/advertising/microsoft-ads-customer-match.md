...
使用[!DNL Microsoft Ads Customer Match]目的地，依電子郵件地址比對客戶，並在[!DNL Microsoft Advertising Network]中與客戶重新互動，包括搜尋和對象廣告。 將您的[!DNL Microsoft Advertising]帳戶連結至[!DNL Real-Time CDP]，以直接從Experience Platform自動建立和管理客戶比對清單。
