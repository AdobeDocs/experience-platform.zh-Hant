...
title: 分支擴充功能
description: 分店擴充功能是Adobe Experience Platform的廣告目的地。 如需擴充功能的詳細資訊，請參閱Adobe交換的擴充功能頁面。
...
Branch是Adobe Experience Platform的廣告延伸。 如需擴充功能的詳細資訊，請參閱Branch網站上的[功能頁面](https://branch.io/features/)。
