...
title: 分支擴充功能
description: Branch擴充功能是Adobe Experience Platform中的廣告目的地。 如需擴充功能的相關詳細資訊，請參閱Adobe交換上的擴充功能頁面。
...
Branch提供強大的連結和解決方案，可協助您取得、參與所有裝置、管道和平台，並加以測量。

Branch是Adobe Experience Platform中的廣告擴充功能。 如需擴充功能的相關詳細資訊，請參閱 [功能頁面](https://branch.io/features/) （在分支網站上）。
