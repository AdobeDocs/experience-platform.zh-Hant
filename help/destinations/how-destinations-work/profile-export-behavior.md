...
## 串流目的地中的訊息彙總 {#message-aggregation}
...
Experience Platform中的[企業目的地](/help/destinations/destination-types.md#advanced-enterprise-destinations)為Amazon Kinesis、Azure事件中樞及HTTP API。
...
### 決定資料匯出的因素及匯出中包含的因素 {#file-based-export-details}
