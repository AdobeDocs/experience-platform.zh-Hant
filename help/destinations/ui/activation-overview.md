...
### 從目的地目錄啟用對象 {#activate-from-catalog}
...
### 從[!UICONTROL Browse]頁面啟用對象 {#activate-from-browse}

請依照下列步驟，從&#x200B;**[!UICONTROL Browse]**&#x200B;頁面啟用您目的地的資料。

1. 移至&#x200B;**[!UICONTROL Connections > Destinations]**，然後選取&#x200B;**[!UICONTROL Browse]**&#x200B;標籤。

   ![瀏覽標籤](../assets/ui/activation-overview/browse-tab.png)

1. 尋找要用來啟動區段的目的地連線，選取[!UICONTROL Name]欄中的三個點，然後選取&#x200B;**[!UICONTROL Activate audiences]**。

   ![啟用對象按鈕](../assets/ui/activation-overview/activate-segments.png)

1. 視選取的目的地而定，請依照下列文章中所述的步驟（從&#x200B;**[!UICONTROL Select segments]**&#x200B;步驟開始）完成啟動工作流程：
