---
keywords: 啟用受眾串流目的地；啟用受眾串流目的地；啟用資料
title: 啟用串流目的地的受眾資料
type: Tutorial
...
某些受眾串流目的地會要求您選取來源屬性或身分名稱空間，以將目的地中的身分對應為目標身分。
...
1. 於 **[!UICONTROL 對象排程]** 頁面，選取每個對象，然後使用 **[!UICONTROL 開始日期]** 和 **[!UICONTROL 結束日期]** 選取器，設定傳送資料至目的地的時間間隔。

   ![對象排程](../assets/ui/activate-segment-streaming-destinations/audience-schedule.png)

   * 有些目的地會要求您選取 **[!UICONTROL 對象來源]** 對於每個對象，使用行事曆選擇器下方的下拉式選單。 如果您的目的地不包含此選擇器，請略過此步驟。
...
![稽核步驟中的選取專案摘要。](../assets/ui/activate-segment-streaming-destinations/review.png)
