...
>[!IMPORTANT]
>
>此步驟僅適用於部分受眾串流目的地。 如果您的目的地沒有&#x200B;**[!UICONTROL Mapping]**&#x200B;步驟，請跳至[對象排程](#scheduling)。
>
...
1. 在&#x200B;**[!UICONTROL Select source field]**&#x200B;頁面中，使用&#x200B;**[!UICONTROL Select attributes]**&#x200B;或&#x200B;**[!UICONTROL Select identity namespace]**&#x200B;選項，在兩個類別的可用來源欄位之間切換。 從可用的[!DNL XDM]設定檔屬性和身分識別名稱空間中，選取您要對應到目的地的設定檔屬性和身分識別名稱空間，然後選擇&#x200B;**[!UICONTROL Select]**。
...
1. 在&#x200B;**[!UICONTROL Select target field]**&#x200B;頁面中，選取您要對應來源欄位的目標身分名稱空間，然後選擇&#x200B;**[!UICONTROL Select]**。
...
1. 在&#x200B;**[!UICONTROL Audience schedule]**&#x200B;頁面上，選取每個對象，然後使用&#x200B;**[!UICONTROL Start date]**&#x200B;及&#x200B;**[!UICONTROL End date]**&#x200B;選取器來設定傳送資料至目的地的時間間隔。

   ![醒目提示的對象排程篩選器。](../assets/ui/activate-segment-streaming-destinations/audience-schedule.png)

   * 有些目的地會要求您使用行事曆選取器下方的下拉式功能表，為每個對象選取&#x200B;**[!UICONTROL Origin of audience]**。 如果您的目的地不包含此選擇器，請略過此步驟。

     ![反白顯示對應ID下拉式清單。](../assets/ui/activate-segment-streaming-destinations/origin-of-audience.png)

   * 部分目的地會要求您手動將[!DNL Experience Platform]對象對應至目標目的地中的對應對象。 若要這麼做，請選取每個對象，然後在&#x200B;**[!UICONTROL Mapping ID]**&#x200B;欄位中輸入目的地平台中對應的對象ID。 如果您的目的地不包含此欄位，請略過此步驟。

     ![醒目提示的對象來源下拉式清單。](../assets/ui/activate-segment-streaming-destinations/mapping-id.png)

   * 啟用&#x200B;**[!UICONTROL App ID]**&#x200B;或[!DNL IDFA]對象時，某些目的地會要求您輸入[!DNL GAID]。 如果您的目的地不包含此欄位，請略過此步驟。
