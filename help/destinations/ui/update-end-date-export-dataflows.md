...
Experience Platform[的2024年9月](/help/release-notes/latest/latest.md#destinations)日發行版本匯入了設定匯出資料集資料流`endTime`日期的選項。 Adobe也針對2024年9月版本&#x200B;*之前建立*&#x200B;的所有資料集匯出資料流，推出預設結束日期為2025年5月1日。 這些資料流目前顯示的訊息類似於以下所示的訊息。
...
### 尋找需要更新的資料流 {#find-dataflows-api}

### 更新資料流程的結束日期 {#update-end-date-api}
