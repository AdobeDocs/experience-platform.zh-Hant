...
![顯示三個小部件的目標概述儀表板。](../assets/ui/workspace/destinations-overview.png)
...
* 選擇以查看 **[!UICONTROL 連接]** 和/或 **[!UICONTROL 擴展]** 的下界。 要瞭解兩種類別的區別，請閱讀 [目標類型和類別](../destination-types.md)。

![顯示幾個廣告和雲儲存目標的目標目錄。](../assets/ui/workspace/catalog.png)

目標卡包含主控制選項和輔助控制選項。 主控制項包括 [!UICONTROL 設定]。 [!UICONTROL 激活]。 [!UICONTROL 激活段]或 [!UICONTROL 導出資料集]。 輔助控制項允許查看選項。 下面介紹了這些控制項：

| 控制 | 說明 |
|---------|----------|
| [!UICONTROL 設定] | 允許您建立到目標的連接。 |
| [!UICONTROL 啟動] | 建立到目標的連接後，可以激活段或將資料集導出到此目標。 |
| [!UICONTROL 激活段] | 建立到目標的連接後，可以激活到此目標的段。 |
| [!UICONTROL 導出資料集] | 建立到目標的連接後，可以將資料集導出到此目標。 |
| [!UICONTROL 查看帳戶] | 查看您為目標連接的帳戶。 |
| [!UICONTROL 查看資料流] | 查看目標存在的資料激活流。 |
| [!UICONTROL 檢視文件] | 開啟指向該特定目標的文檔頁面的連結，瞭解詳細資訊並幫助您設定該目標。 |
...
>[!TIP]
>
> * 選擇省略號(`...`) [!UICONTROL 平台] 列和使用 ![激活控制項](../assets/ui/workspace/add-data-symbol.png)**[!UICONTROL 激活&#x200B;]**/**[!UICONTROL &#x200B;激活段&#x200B;]**/**[!UICONTROL &#x200B;導出資料集&#x200B;]**控制項將段或資料集導出到該目標。
> * 選擇省略號(`...`) [!UICONTROL 平台] 列和使用 ![編輯詳細資訊控制項](../assets/ui/workspace/pencil-icon.png)**[!UICONTROL 編輯詳細資訊&#x200B;]**控制 [更新](update-accounts.md) 現有目標帳戶的詳細資訊。
> * 選擇省略號(`...`) [!UICONTROL 平台] 列和使用 ![刪除控制項](../assets/ui/workspace/delete-destination-symbol.png)**[!UICONTROL 刪除&#x200B;]**控制 [刪除](delete-destination-account.md) 現有目標帳戶。
...
>[!TIP]
>
> * 選擇省略號(`...`) [!UICONTROL 名稱] 列和使用 ![激活段控制項](../assets/ui/workspace/add-data-symbol.png)**[!UICONTROL 激活&#x200B;]**控制項將段或資料集導出到該目標。
> * 選擇省略號(`...`) [!UICONTROL 名稱] 列和使用 ![刪除控制項](../assets/ui/workspace/delete-destination-symbol.png)**[!UICONTROL 刪除&#x200B;]**控制 [刪除](delete-destinations.md) 到目標的現有連接。
> * 選擇省略號(`...`) [!UICONTROL 名稱] 列和使用 ![在監視控制中查看](../assets/ui/workspace/monitoring-icon.png)**[!UICONTROL 在監視中查看&#x200B;]**控制項：查看此目標的激活資訊 [監控儀表板](/help/dataflows/ui/monitor-destinations.md#monitoring-destinations-dashboard)。
> * 選擇省略號(`...`) [!UICONTROL 名稱] 列和使用 ![訂閱警報 ](../assets/ui/workspace/alerts-icon.png)**[!UICONTROL 訂閱警報&#x200B;]**控制項訂閱目標資料流警報。 您可以訂閱警報以接收有關流運行狀態、成功或失敗的消息。 請參閱 [訂閱上下文中的目標警報](alerts.md) 有關目標資料流警報的詳細資訊……
