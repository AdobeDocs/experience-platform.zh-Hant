...
| 控制 | 說明 |
|---------|----------|
| [!UICONTROL Set up] | 可讓您建立與目的地的連線。 |
| [!UICONTROL Activate] | 建立與目的地的連線後，您可以啟用對象或匯出資料集到此目的地。 |
| [!UICONTROL Activate audiences] | 建立與目的地的連線後，您就可以啟用此目的地的對象。 |
| [!UICONTROL Export datasets] | 建立與目的地的連線後，您可以將資料集匯出到此目的地。 |
...
選取目的地名稱，可檢視與此目的地啟用的對象相關的資訊。 按一下&#x200B;**[!UICONTROL Edit destination]**&#x200B;以[修改目的地設定](/help/destinations/ui/edit-destination.md)或&#x200B;**[!UICONTROL Activate audiences]**&#x200B;將新對象新增至資料流。
...
**[!UICONTROL Accounts]**&#x200B;索引標籤顯示您已與各種目的地建立之連線的詳細資料，並可讓您更新或刪除現有的帳戶詳細資料。 請參閱下表，以取得每個目的地帳戶的所有資訊。
