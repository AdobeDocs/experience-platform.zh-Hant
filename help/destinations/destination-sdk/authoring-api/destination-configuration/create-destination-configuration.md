...
| `identityNamespaces.externalId.acceptsCustomNamespaces` | 布林值 | 表示客戶是否可將屬於[自訂名稱空間](/help/identity-service/features/namespaces.md#create-namespaces)的身分對應到您正在設定的身分。 |
