...
本頁面列出您在提交或更新您使用Adobe Experience Platform Destination SDK製作的目的地時，需要提供的所有資訊。 若要在Adobe Experience Platform中成功提交目的地，請傳送電子郵件至 <aepdestsdk@adobe.com> 包括：
...
* （僅限產品化整合）說明檔案PR（提取請求），請遵循 [自助服務檔案程式](./docs-framework/documentation-instructions.md).
