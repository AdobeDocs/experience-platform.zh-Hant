...
title: 使用自定義檔案名和格式設定選項配置AmazonS3目標。
...
# 使用自定義檔案名和格式設定選項配置AmazonS3目標

## 總覽 {#overview}

本頁介紹如何使用Destination SDK配置具有自定義功能的AmazonS3目標 [檔案格式選項](configure-file-formatting-options.md) 和習俗 [檔案名配置](../../functionality/destination-configuration/batch-configuration.md#file-name-configuration)。
...
下面的負載包括通用的AmazonS3配置，帶有自定義 [CSV檔案格式](../../functionality/destination-server/file-formatting.md) 用戶可以在Experience PlatformUI中定義的配置參數。
