...
本頁說明如何使用Destination SDK來設定 [!DNL Azure Data Lake Storage] 自訂目的地 [檔案格式選項](configure-file-formatting-options.md) 和自訂 [檔案名配置](../../functionality/destination-configuration/batch-configuration.md#file-name-configuration).
...
以下裝載包含通用 [!DNL Azure Data Lake Storage] 配置，使用自定義 [CSV檔案格式](../../functionality/destination-server/file-formatting.md) 設定參數，供使用者在Experience PlatformUI中定義。
...
![螢幕記錄顯示含有選定目的地卡片的目的地目錄頁面。](../../assets/guides/batch/adls-destination-card.gif)

在以下影像和錄影中，請注意 [檔案式目的地的啟用工作流程](../../../ui/activate-batch-profile-destinations.md) 符合您在目的地設定中選取的選項。
