...
>[!TIP]
>
>**驗證Experience Platform UI**。 使用下節中示範的設定來設定檔案格式選項時，您應該檢查Experience Platform UI以瞭解這些選項的呈現方式。
...
您在目的地設定中新增檔案格式選項作為客戶資料欄位的順序反映在UI中。 例如，下列設定會相應地反映在UI中，選項會依順序&#x200B;**[!UICONTROL Delimiter]**、**[!UICONTROL Quote Character]**、**[!UICONTROL Escape Character]**、**[!UICONTROL Empty Value]**、**[!UICONTROL Null Value]**&#x200B;顯示。

![顯示Experience Platform UI中檔案格式選項順序的影像。](../../assets/guides/batch/file-formatting-order.png)
...
若要這麼做，請使用`"type": "object"`建立群組，並在`properties`引數中收集所需的檔案格式選項，如下列範例所示，其中群組&#x200B;**[!UICONTROL CSV Options]**&#x200B;是反白的。
...
### 完成API請求，其中包含上方顯示的所有選項 {#complete-api-request}
