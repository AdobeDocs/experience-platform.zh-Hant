...
以下承載包含一般SFTP設定，其中包含預先定義的預設[CSV檔案格式](../../functionality/destination-server/file-formatting.md)設定引數，使用者可在Experience Platform UI中定義這些引數。
...
您現在知道如何使用Destination SDK編寫自訂SFTP目的地。 接下來，您的團隊可以使用檔案型目的地的[啟動工作流程](../../../ui/activate-batch-profile-destinations.md)，將資料匯出至目的地。
