...
以下裝載包含通用 [!DNL Data Landing Zone] 配置，使用自定義 [CSV檔案格式](../../server-and-file-configuration.md#file-configuration) 設定參數，供使用者在Experience PlatformUI中定義。
...
![螢幕記錄顯示含有選定目的地卡片的目的地目錄頁面。](../../assets/dlz-destination-card.gif)
