...
本頁說明如何使用Destination SDK以自訂[!DNL Data Landing Zone]檔案格式選項[和自訂](configure-file-formatting-options.md)檔案名稱組態[來設定](../../functionality/destination-configuration/batch-configuration.md#file-name-configuration)目的地。
...
以下承載包含一般[!DNL Data Landing Zone]設定，其中包含使用者可在Experience Platform UI中定義的自訂[CSV檔案格式](../../functionality/destination-server/file-formatting.md)設定引數。
...
您現在知道如何使用Destination SDK編寫自訂[!DNL Data Landing Zone]目的地。 接下來，您的團隊可以使用檔案型目的地的[啟動工作流程](../../../ui/activate-batch-profile-destinations.md)，將資料匯出至目的地。
