...
閱讀本文後，您現在已瞭解[!DNL Adobe Experience Platform]支援的OAuth 2授權模式，並知道如何使用OAuth 2授權支援來設定您的目的地。 接下來，您可以使用Destination SDK設定您的OAuth 2支援目的地。 閱讀[使用Destination SDK設定您的目的地](../../guides/configure-destination-instructions.md)以瞭解後續步驟。
