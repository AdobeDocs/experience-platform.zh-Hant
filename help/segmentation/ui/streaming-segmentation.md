---
keywords: Experience Platform；首頁；熱門主題；串流細分；細分；細分服務；細分服務；ui指南；
...
![隨即顯示區段詳細資訊頁面。](../images/ui/streaming-segmentation/monitoring-streaming-segment.png)
...
>[!NOTE]
>
>如果區段從無狀態變為已實現，或從退出變為已實現，則視為符合條件。 如果區段從實現變為退出，則會視為不合格。
>
