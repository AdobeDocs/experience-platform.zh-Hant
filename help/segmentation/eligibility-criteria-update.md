...
| -------- | ------ | ----------- | ---------------- | ----------- |
| 加州居民 | 輪廓 | 批次來源 | 住家地址在加利福尼亞州 | `e3be6d7f-1727-401f-a41e-c296b45f607a` |
| 最近結帳 | 體驗事件 | 串流來源 | 在過去24小時內至少有一個結帳 | `9e1646bb-57ff-4309-ba59-17d6c5bab6a1` |
...
| 客群 | 結構描述 | Source型別 | 查詢定義 | 客群 ID |
| -------- | ------ | ----------- | ---------------- | ----------- |
| 最近的放棄 | 體驗事件 | 批次來源 | 在過去48小時內至少有一個放棄事件 | `7deb246a-49b4-4687-95f9-6316df049948` |
| 最近結帳 | 體驗事件 | 串流來源 | 在過去24小時內至少有一個結帳 | `9e1646bb-57ff-4309-ba59-17d6c5bab6a1` |
