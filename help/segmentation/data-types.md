...
在Platform中建立的區段可以用在其他 [Adobe Experience Cloud核心服務](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html?lang=zh-Hant). 若要啟用此功能，您需要連絡解決方案架構師或顧問。
