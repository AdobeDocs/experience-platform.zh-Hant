...
| dformat | 根據指定格式將時間戳轉換為日期字串。 | <ul><li>時間戳：**必要**&#x200B;您要格式化的時間戳記。 這會以毫秒為單位寫入。</li><li>格式：**必要**&#x200B;您希望將時間戳變更為的格式。</li></ul> | dformat&#x200B;(TIMESTAMP, FORMAT) | dformat(1571829875, &quot;dd-MMM-yyyy hh:mm&quot;) | 「2019年10月23日11:24」 |
