---
keywords: Experience Platform;home；熱門主題；Amazon S3;amazon s3;S3;s3
solution: Experience Platform
title: Amazon S3 Source Connector概觀
topic: overview
description: 瞭解如何使用API或使用者介面將S3連接至Adobe Experience Platform。
...
以下檔案提供如何使用API或使用者介面將S3連接至Adobe Experience Platform的資訊：
