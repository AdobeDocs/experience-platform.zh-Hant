...
## 設定您在Azure上Experience Platform的[!DNL Amazon S3]來源 {#azure}

請依照下列步驟，瞭解如何設定[!DNL Amazon S3]帳戶以在Azure上Experience Platform。
...
- [使用流量服務API連線Amazon S3以Experience Platform](../../tutorials/api/create/cloud-storage/s3.md)
