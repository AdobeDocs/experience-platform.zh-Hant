...
Adobe Experience Platform為AWS等雲端服務供應商提供原生連線， [!DNL Google Cloud Platform]、和 [!DNL Azure]，可讓您從這些系統帶入資料。 內嵌的資料可以格式化為JSON、Parquet或分隔。 對雲端儲存空間提供者的支援包括 [!DNL Apache] HDFS。
...
## 連線 [!DNL Apache] HDFS至 [!DNL Platform]
