...
topic: overview
description: 以下檔案提供如何使用API或使用者介面將Salesforce Service Cloud連接至平台的資訊。
...
# （測試版）連 [!DNL Salesforce Service Cloud] 接器
...
[!DNL Experience Platform] 支援從協力廠商客戶成功系統擷取資料。 支援客戶成功提供者包括 [!DNL Salesforce Service Cloud]。
...
以下檔案提供如何連線至使用API [!DNL Salesforce Service Cloud] 或使 [!DNL Platform] 用者介面的資訊：

## 使用 [!DNL Salesforce Service Cloud ]API連 [!DNL Platform] 接至
...
## 使用 [!DNL Salesforce Service Cloud] UI [!DNL Platform] 連線至
