---
keywords: Experience Platform；首頁；熱門主題；Adobe Analytics Classifications Source聯結器
solution: Experience Platform
title: 分類資料的Adobe Analytics Source Connector
description: 瞭解如何使用使用者介面將Analytics分類連結至Platform
...
以下檔案提供如何使用使用者介面將Analytics分類連線至Platform的相關資訊：

## 使用UI將Analytics分類連線至Platform
