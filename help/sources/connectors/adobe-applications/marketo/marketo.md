...
| 目標 | 預期延遲 |
| ----------- | ---------------- |
| [!DNL Real-Time Customer Profile] | &lt; 20分鐘 |
| 資料湖 | &lt; 60分鐘 |

>[!NOTE]
>
>上述延遲數字代表95%信賴水準的預期值。 實際延遲時間會有所不同，而且在某些情況下，實際延遲時間會超出這些數字。

## 後續步驟和其他資源

下列檔案提供有關建立[!DNL Marketo Engage]來源連線的進一步資訊：

* 如需如何將[!DNL Marketo Engage]資料連線至Experience Platform的詳細資訊，請參閱在UI[中建立 [!DNL Marketo Engage] 來源連線的教學課程。](../../../tutorials/ui/create/adobe-applications/marketo.md)
