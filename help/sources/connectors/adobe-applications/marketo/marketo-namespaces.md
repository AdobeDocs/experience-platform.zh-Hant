...
>[!IMPORTANT]
>
>您必須有[Adobe Real-time Customer Data Platform B2B Edition](../../../../rtcdp/b2b-overview.md)的存取權，B2B結構描述才能參與[即時客戶設定檔](../../../../profile/home.md)。

## 設定B2B名稱空間和結構描述自動產生公用程式

使用B2B名稱空間和結構描述自動產生公用程式的第一個步驟是設定您的平台開發人員主控台和[!DNL Postman]環境。
...
| 方案名稱 | 基底類別 | 欄位群組 | 結構描述中的[!DNL Profile] | 主要身分識別 | 主要身分名稱空間 | 次要身分 | 次要身分名稱空間 | 關係 | 附註 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
