...
您可以使用資料彙集`CORE`、[Mobile SDK](/help/collection/identity/overview.md)或[Experience Cloud ID服務API](https://developer.adobe.com/client-sdks/documentation/mobile-core/identity/)中的[身分來設定訪客的Experience Cloud ID，以建立](https://experienceleague.adobe.com/docs/id-service/using/intro/overview.html?lang=zh-Hant)名稱空間。
