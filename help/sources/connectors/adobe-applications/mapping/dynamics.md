...
| `concat(contactid,"@${CRM_ORG_ID}.Dynamics")` | `b2b.personKey.sourceKey` | 主要身分識別. 的值 `"${CRM_ORG_ID}"` 將自動更換。 |
...
| `concat(leadid,"@${CRM_ORG_ID}.Dynamics")` | `b2b.personKey.sourceKey` | 主要身分識別. 的值 `"${CRM_ORG_ID}"` 將自動更換。 |
...
| `accountid` | `accountKey.sourceID` | 主要身分識別. 的值 `"${CRM_ORG_ID}"` 將自動更換。 |
...
| `concat(opportunityid,"@${CRM_ORG_ID}.Dynamics")` | `opportunityKey.sourceKey` | 主要身分識別. 的值 `"${CRM_ORG_ID}"` 將自動更換。 |
...
| `concat(connectionid,"@${CRM_ORG_ID}.Dynamics")` | `opportunityPersonKey.sourceKey` | 主要身分識別. 的值 `"${CRM_ORG_ID}"` 將自動更換。 |
| `createdon` | `extSourceSystemAudit.createdDate` |
| `modifiedon` | `extSourceSystemAudit.lastUpdatedDate` |
...
| `concat(campaignid,"@${CRM_ORG_ID}.Dynamics")` | `campaignKey.sourceKey` | 主要身分識別. 的值 `"${CRM_ORG_ID}"` 將自動更換。 |
...
| `concat(listid,"@${CRM_ORG_ID}.Dynamics")` | `marketingListKey.sourceKey` | 主要身分識別. 的值 `"${CRM_ORG_ID}"` 將自動更換。 |
| `modifiedon` | `extSourceSystemAudit.lastUpdatedDate` |
| `createdon` | `extSourceSystemAudit.createdDate` |
...
| `concat(listmemberid,"@${CRM_ORG_ID}.Dynamics")` | `marketingListMemberKey.sourceKey` | 主要身分識別. 的值 `"${CRM_ORG_ID}"` 將自動更換。 |
