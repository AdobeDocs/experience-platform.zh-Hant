...
title: Azure HDInsights Source聯結器上的Apache Spark概觀
...
# [!DNL Apache Spark]聯結器上的(Beta) [!DNL Azure HDInsights]

>[!NOTE]
>
>[!DNL Apache Spark]聯結器上的[!DNL Azure HDInsights]為Beta版。 如需使用Beta標籤聯結器的詳細資訊，請參閱[來源概觀](../../home.md#terms-and-conditions)。
...
[!DNL Experience Platform]支援從協力廠商資料庫擷取資料。 [!DNL Experience Platform]可以連線到不同型別的資料庫，例如關聯式、NoSQL或資料倉儲。 支援的資料庫提供者包括[!DNL Apache Spark]上的[!DNL Azure HDInsights]。
...
以下檔案提供有關如何使用API或使用者介面將[!DNL Apache Spark]上的[!DNL Azure HDInsights]連線到[!DNL Experience Platform]的資訊：

## 使用API將[!DNL Apache Spark]上的[!DNL Azure HDInsights]連線至[!DNL Experience Platform]
...
## 使用使用者介面將[!DNL Apache Spark]上的[!DNL Azure HDInsights]連線至[!DNL Experience Platform]
