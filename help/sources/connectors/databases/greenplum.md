...
下面的文檔提供了如何使用API或用戶介面將[!DNL GreenPlum]連接到[!DNL Platform]的資訊：

## 使用API將[!DNL GreenPlum]連接至[!DNL Platform]

- [使用Flow Service API建立GreenPlum來源連線](../../tutorials/api/create/databases/greenplum.md)
...
## 使用UI將[!DNL GreenPlum]連接至[!DNL Platform]

- [在UI中建立GreenPlum來源連線](../../tutorials/ui/create/databases/greenplum.md)
