---
keywords: Experience Platform;home；熱門主題；BigQuery;bigquery;Google BigQuery;google bigQuery
...
# （測試版）[!DNL Google BigQuery]連接器

>[!NOTE]
>
>[!DNL Google BigQuery]在測試中。 有關使用beta標籤連接器的詳細資訊，請參閱[ Sources綜覽](../../home.md#terms-and-conditions)。
...
下面的文檔提供了如何使用API或用戶介面將[!DNL Google BigQuery]連接到[!DNL Platform]的資訊：

## 使用API將[!DNL Google BigQuery]連接至[!DNL Platform]

- [使用Flow Service API建立Google BigQuery來源連線](../../tutorials/api/create/databases/bigquery.md)
...
## 使用UI將[!DNL Google BigQuery]連接至[!DNL Platform]
