...
title: Phoenix Source Connector概觀
topic: overview
description: 瞭解如何使用API或使用者介面將Phoenix連接至Adobe Experience Platform。
...
下面的文檔提供了如何使用API或用戶介面將[!DNL Phoenix]連接到[!DNL Platform]的資訊：

## 使用API將[!DNL Phoenix]連接至[!DNL Platform]

- [使用Flow Service API建立Phoenix來源連線](../../tutorials/api/create/databases/phoenix.md)
...
## 使用UI將[!DNL Phoenix]連接至[!DNL Platform]

- [在UI中建立Phoenix來源連線](../../tutorials/ui/create/databases/phoenix.md)
