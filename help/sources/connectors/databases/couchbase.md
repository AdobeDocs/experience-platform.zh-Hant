...
以下檔案提供如何使用API或使用者介面將[!DNL Couchbase]連線到[!DNL Experience Platform]的資訊：

## 使用API連線[!DNL Couchbase]至[!DNL Experience Platform]
...
## 使用UI連線[!DNL Couchbase]至[!DNL Experience Platform]
