...
title: Azure資料總管連接器
topic: overview
description: 以下檔案提供如何使用API或使用者介面將Azure資料總管連接至平台的資訊。
...
# （測試版）連 [!DNL Azure Data Explorer] 接器
...
支援不同類型的第三方資料庫，包括關聯式、NoSQL或資料倉庫。 支援資料庫提供者包括 [!DNL Azure Data Explorer]。
...
以下檔案提供如何連線至使用API [!DNL Azure Data Explorer] 或使 [!DNL Platform] 用者介面的資訊：

## 連線 [!DNL Azure Data Explorer] 至使 [!DNL Platform] 用API
...
## 使用 [!DNL Azure Data Explorer] UI [!DNL Platform] 連線至
