...
以下檔案提供如何連線的資訊 [!DNL Azure Data Explorer] to [!DNL Platform] 使用API或使用者介面：

## Connect [!DNL Azure Data Explorer] to [!DNL Platform] 使用API
...
## Connect [!DNL Azure Data Explorer] to [!DNL Platform] 使用UI
