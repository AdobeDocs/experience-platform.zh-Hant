...
title: MariaDB連接器
topic: overview
description: 以下檔案提供如何使用API或使用者介面將MariaDB連接至平台的資訊。
...
以下檔案提供如何連線至使用API [!DNL MariaDB] 或使 [!DNL Platform] 用者介面的資訊：

## 連線 [!DNL MariaDB] 至使 [!DNL Platform] 用API

- [使用Flow Service API建立MariaDB連接器](../../tutorials/api/create/databases/mariadb.md)
...
## 使用 [!DNL MariaDB] UI [!DNL Platform] 連線至

- [在UI中建立MariaDB來源連接器](../../tutorials/ui/create/databases/mariadb.md)
