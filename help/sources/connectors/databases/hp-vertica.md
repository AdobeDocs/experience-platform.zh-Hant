...
title: HP Vertica Source聯結器概述
description: 瞭解如何使用API或使用者介面將HP Vertica連線至Adobe Experience Platform。
...
Adobe Experience Platform為資料庫提供者（例如[!DNL Microsoft]、MySQL和[!DNL Azure]）提供原生連線。 您可以將資料從這些系統帶入[!DNL Platform]。

支援不同型別的第三方資料庫，包括關聯式、NoSQL或資料倉儲。 支援資料庫提供者包括[!DNL HP Vertica]。

## IP位址允許清單

使用來源聯結器之前，必須將IP位址清單新增至允許清單。 未能將您區域特定的IP位址新增到允許清單可能會導致使用來源時的錯誤或效能不佳。 如需詳細資訊，請參閱[IP位址允許清單](../../ip-address-allow-list.md)頁面。

以下檔案提供如何使用API或使用者介面將[!DNL HP Vertica]連線到[!DNL Platform]的資訊：

## 使用API連線[!DNL HP Vertica]至[!DNL Platform]
...
## 使用UI連線[!DNL HP Vertica]至[!DNL Platform]
