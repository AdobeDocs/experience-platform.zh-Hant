...
title: Azure Synapse Analytics連接器
topic: overview
description: 以下檔案提供如何使用API或使用者介面將Azure Synapse Analytics連接至平台的資訊。
...
# （測試版）連 [!DNL Azure Synapse Analytics] 接器
...
以下檔案提供如何連線至使用API [!DNL Azure Synapse Analytics] 或使 [!DNL Platform] 用者介面的資訊：

## 連線 [!DNL Azure Synapse Analytics] 至使 [!DNL Platform] 用API

- [使用Flow Service API建立Azure Synapse Analytics連接器](../../tutorials/api/create/databases/synapse-analytics.md)
...
## 使用 [!DNL Azure Synapse Analytics] UI [!DNL Platform] 連線至

- [在UI中建立Azure Synapse Analytics來源連接器](../../tutorials/ui/create/databases/synapse-analytics.md)
