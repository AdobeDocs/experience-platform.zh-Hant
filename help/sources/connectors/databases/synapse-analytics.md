---
title: azure synapseAnalytics Source聯結器總覽
...
[!DNL Experience Platform]支援從協力廠商資料庫擷取資料。 [!DNL Platform]可以連線到不同型別的資料庫，例如關聯式、NoSQL或資料倉儲。 支援的資料庫提供者包括[!DNL Azure Synapse Analytics]。

## IP位址允許清單

使用來源聯結器之前，必須將IP位址清單新增至允許清單。 未能將您區域特定的IP位址新增到允許清單可能會導致使用來源時的錯誤或效能不佳。 如需詳細資訊，請參閱[IP位址允許清單](../../ip-address-allow-list.md)頁面。

以下檔案提供如何使用API或使用者介面將[!DNL Azure Synapse Analytics]連線到[!DNL Platform]的資訊：

## 使用API連線[!DNL Azure Synapse Analytics]至[!DNL Platform]
...
## 使用UI連線[!DNL Azure Synapse Analytics]至[!DNL Platform]
