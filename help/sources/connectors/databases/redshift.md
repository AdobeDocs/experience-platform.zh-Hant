...
title: Amazon Redshift連接器
topic: overview
description: 以下文檔提供了如何使用API或用戶介面將Amazon Redshift連接到平台的資訊。
...
以下檔案提供如何連線至使用API [!DNL Amazon Redshift] 或使 [!DNL Platform] 用者介面的資訊：

## 連線 [!DNL Amazon Redshift] 至使 [!DNL Platform] 用API

- [使用Flow Service API建立Amazon Redshift連接器](../../tutorials/api/create/databases/redshift.md)
...
## 使用 [!DNL Amazon Redshift] UI [!DNL Platform] 連線至

- [在UI中建立Amazon Redshift源連接器](../../tutorials/ui/create/databases/redshift.md)
