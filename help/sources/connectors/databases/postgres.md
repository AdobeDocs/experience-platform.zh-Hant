...
Experience Platform支援從協力廠商資料庫擷取資料。 平台可以連接到不同類型的資料庫，如關係型、NoSQL或資料倉庫。 支援資料庫提供者包括PostgreSQL。

以下文檔提供了有關如何使用API或用戶介面將PostgreSQL連接到平台的資訊：

## 使用API將PostgreSQL連接到平台
