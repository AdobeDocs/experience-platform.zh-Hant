...
本教學課程涵蓋從資料庫來源擷取資料，以及使用[[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/)將資料帶到Platform的步驟。
...
依照本教學課程中的指示，您已建立來源聯結器，以根據排程從資料庫收集資料。 下游Platform服務（例如[!DNL Real-Time Customer Profile]和[!DNL Data Science Workspace]）現在可以使用傳入的資料。 如需更多詳細資訊，請參閱下列檔案：
