...
本教學課程涵蓋從協力廠商通訊協定應用程式擷取資料，並透過來源連接器和[[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/)擷取資料至Adobe Experience Platform的步驟。
