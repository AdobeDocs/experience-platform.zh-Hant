...
# 使用為付款源建立資料流 [!DNL Flow Service] API

本教學課程涵蓋從支付來源擷取資料，以及使用 [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).

>[!NOTE]
>
>為了建立資料流，您必須已具有與付款源的有效基本連接ID。 如果您沒有此ID，請參閱 [來源概觀](../../../home.md#payments) ，以獲取可建立基本連接的付款來源清單。
