---
title: 使用流量服務API建立Oracle Eloqua基本連線
description: 瞭解如何使用流量服務API將Adobe Experience Platform連線至Oracle Eloqua。
...
若要建立基底連線ID，請在提供您的[!DNL Oracle Eloqua]驗證認證作為要求引數的一部分時，對`/connections`端點提出POST要求。
