...
title: 使用流量服務API建立Oracle物件儲存基礎連線
type: Tutorial
description: 瞭解如何使用流量服務API將Adobe Experience Platform連線至Oracle物件儲存。
...
若要建立基底連線ID，請在提供您的[!DNL Oracle Object Storage]驗證認證作為要求引數的一部分時，對`/connections`端點提出POST要求。
