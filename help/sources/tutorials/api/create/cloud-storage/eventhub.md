...
閱讀本教學課程以瞭解如何連線 [!DNL Azure Event Hubs] (以下稱「[!DNL Event Hubs]&quot;)至Experience Platform，使用 [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
