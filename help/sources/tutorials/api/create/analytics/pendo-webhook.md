...
## 連線 [!DNL Pendo] 至平台，使用 [!DNL Flow Service] API {#connect-platform-to-flow-api}

以下概述建立來源連線和資料流所需的步驟，以將 [!DNL Pendo] 要Experience Platform的事件資料。
...
從匯入資料的最後一步 [!DNL Pendo] 到Platform就是建立資料流。 到現在為止，您已準備下列必要值：
