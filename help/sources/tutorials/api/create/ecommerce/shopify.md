...
# 使用[!DNL Flow Service] API建立[!DNL Shopify]連接器
...
在本教程中，您使用[!DNL Flow Service] API建立了[!DNL Shopify]連接，並獲取了該連接的唯一ID值。 您可在下一個教學課程中使用此ID，同時學習如何使用Flow Service API[來探索電子商務連線。](../../explore/ecommerce.md)