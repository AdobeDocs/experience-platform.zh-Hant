...
# 使用[!DNL Microsoft] API建立[!DNL Flow Service] SQL Server基本連線

基礎連線代表來源和Adobe Experience Platform之間的已驗證連線。

閱讀本教學課程，瞭解如何使用[!DNL Microsoft SQL Server]API[[!DNL Flow Service] 為](https://www.adobe.io/experience-platform-apis/references/flow-service/)建立基礎連線。
...
下列章節提供您需瞭解的其他資訊，才能使用[!DNL Microsoft SQL Server] API成功連線到[!DNL Flow Service]。
...
若要建立基底連線ID，請在提供您的`/connections`驗證認證作為要求引數的一部分時，對[!DNL Microsoft SQL Server]端點提出POST要求。
...
依照此教學課程，您已使用[!DNL Microsoft SQL Server] API建立[!DNL Flow Service]基礎連線。 您可以在下列教學課程中使用此基本連線ID：
