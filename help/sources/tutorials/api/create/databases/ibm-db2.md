...
# 使用Flow Service API建立IBM DB2連接器
...
本教學課程使用Flow Service API來引導您完成將IBM DB2（以下稱為「DB2」）連接至Experience Platform的步驟。
...
在本教程中，您使用Flow Service API建立了IBM DB2連接，並獲取了該連接的唯一ID值。 在下一個教學課程中，您可以使用此ID來學習如何使 [用Flow Service API來探索資料庫](../../explore/database-nosql.md)。
