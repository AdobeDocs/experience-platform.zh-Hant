...
title: 使用流服務API建立IBM DB2源連接
topic: overview
type: Tutorial
description: 瞭解如何使用Flow Service API將IBM DB2連線至Adobe Experience Platform。
...
# 使用[!DNL Flow Service] API建立IBM DB2源連接
...
本教程使用[!DNL Flow Service] API來引導您完成將IBM DB2（以下稱為「DB2」）連接到[!DNL Experience Platform]的步驟。
