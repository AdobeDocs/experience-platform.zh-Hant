...
title: 使用流程服務API建立Azure AzureData Explorer基礎連線
type: Tutorial
description: 瞭解如何使用流量服務API將Azure AzureData Explorer連線至Adobe Experience Platform。
...
若要建立基底連線ID，請在提供[!DNL Azure Data Explorer]驗證認證作為要求引數的一部分時，向`/connections`端點提出POST要求。
