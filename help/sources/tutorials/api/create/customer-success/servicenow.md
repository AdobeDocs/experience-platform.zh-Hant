...
topic: overview
type: Tutorial
description: 本教學課程使用Flow Service API來引導您完成將Experience Platform連接至ServiceNow伺服器的步驟。
...
# 使用[!DNL Flow Service] API建立[!DNL ServiceNow]連接器
...
在本教程中，您使用[!DNL Flow Service] API建立了[!DNL ServiceNow]連接，並獲取了該連接的唯一ID值。 在下一個教學課程中，您可以使用此連線ID，學習如何使用流式服務API[來探索客戶成功系統。](../../explore/customer-success.md)