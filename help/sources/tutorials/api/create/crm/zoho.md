...
# （測試版）建立 [!DNL Zoho CRM] 基本連接使用 [!DNL Flow Service] API
...
依照本教學課程，您已建立 [!DNL Zoho CRM] 基本連接使用 [!DNL Flow Service] API，並已取得連線的唯一ID值。 您可以在下一個教學課程中使用此ID，以了解如何 [使用流量服務API探索CRM系統](../../explore/crm.md).
