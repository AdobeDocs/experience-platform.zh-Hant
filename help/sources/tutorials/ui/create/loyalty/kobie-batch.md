---
title: 使用UI將批次資料從Kobie擷取到Experience Platform
description: 瞭解如何使用UI將批次資料從Kobie擷取到Adobe Experience Platform。
badge: Beta
hide: true
hidefromtoc: true
...
# 使用UI將批次資料從[!DNL Kobie]擷取到Experience Platform

閱讀本教學課程，瞭解如何使用UI中的來源工作區將批次資料從您的[!DNL Kobie]帳戶擷取到Adobe Experience Platform。
...
若要從[!DNL Kobie]擷取資料，請在&#x200B;**[!UICONTROL Kobie Batch Source Connector]**&#x200B;下選取&#x200B;*[!UICONTROL Loyalty]*&#x200B;來源卡，然後選取&#x200B;**[!UICONTROL Add data]**。
...
若要為您的[!DNL Kobie]來源建立新帳戶，請選取&#x200B;**[!UICONTROL New account]**，並為您的帳戶提供名稱和選擇性說明。 接下來，提供您的[!DNL Kobie]網域和您的[!UICONTROL Kobie Management API Key]。 完成後，請選取「**[!UICONTROL Connect to source]**」，讓您的連線建立一段時間。



### 使用現有帳戶

若要使用現有帳戶，請選取&#x200B;**[!UICONTROL Existing account]**，然後從帳戶介面選取您要使用的[!DNL Kobie]帳戶。
...
>[!IMPORTANT]
>
>如需對應您[!DNL Kobie]來源資料的其他指引，請閱讀[[!DNL Kobie]概觀]
