...
Adobe Experience Platform中的來源聯結器可讓您依排程擷取外部來源的資料。 本教學課程提供建立 [!DNL Apache Hive] 於 [!DNL Azure HDInsights] 來源聯結器使用 [!DNL Platform] 使用者介面。
...
如需入門的詳細資訊，請參閱 [此 [!DNL Hive] 檔案](https://cwiki.apache.org/confluence/display/Hive/Tutorial#Tutorial-GettingStarted).

## 連線您的 [!DNL Hive] 帳戶

收集完所需的認證後，您可以依照下列步驟連結 [!DNL Hive] 帳戶至 [!DNL Platform].
...
如果您使用新認證，請選取 **[!UICONTROL 新帳戶]**. 在出現的輸入表單上，提供名稱、選擇性說明，以及 [!DNL Hive] 認證。 完成後，選取 **[!UICONTROL Connect]** 然後等待一段時間以建立新連線。
...
依照本教學課程，您已建立與的連線， [!DNL Hive] 帳戶。 您現在可以繼續下一節教學課程和 [設定資料流以將資料帶入 [!DNL Platform]](../../dataflow/databases.md).
