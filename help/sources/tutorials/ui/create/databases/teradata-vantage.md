...
若要在Experience Platform上存取您的[!DNL Teradata Vantage]帳戶，您必須提供下列驗證值：
...
依照本教學課程中的指示，您已建立與Teradata Vantage帳戶的連線。 您現在可以繼續進行下一個教學課程，並[設定資料流以將資料帶入Experience Platform](../../dataflow/databases.md)。
