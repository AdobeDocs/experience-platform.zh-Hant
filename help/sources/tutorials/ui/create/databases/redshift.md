...
本教學課程提供如何連線至 [!DNL Amazon Redshift] (以下稱「[!DNL Redshift]&quot;)帳號使用使用者介面前往Adobe Experience Platform。
...
| **認證** | **說明** |
| -------------- | --------------- |
| 伺服器 | 與您的伺服器關聯的伺服器 [!DNL Redshift] 帳戶。 |
...
收集必要的認證後，您可以依照下列步驟連結 [!DNL Redshift] 要Experience Platform的帳戶。

## 連線您的 [!DNL Redshift] 帳戶

>[!NOTE]
>
>預設編碼標準 [!DNL Redshift] 是Unicode。 無法變更此設定。
...
如果您正在使用新認證，請選取 **[!UICONTROL 新帳戶]**. 在出現的輸入表單上，提供名稱、選擇性說明，以及 [!DNL Redshift] 認證。 完成後，選取 **[!UICONTROL 連線]** 然後等待一段時間以建立新連線。
...
依照本教學課程中的指示，您已建立與的連線， [!DNL Redshift] 帳戶。 您現在可以繼續進行下一個教學課程及 [設定資料流以將資料帶入Experience Platform](../../dataflow/databases.md).
