...
### 建立Platform結構描述 [!DNL Pendo] {#create-platform-schema}

您也必須確保先建立用於來源的Platform結構描述。 請參閱上的教學課程 [建立平台結構描述](../../../../../xdm/schema/composition.md) 以取得如何建立綱要的完整步驟。

![顯示Pendo結構描述範例的平台UI。](../../../../images/tutorials/create/analytics-pendo-webhook/schema.png)
...
前往 [!UICONTROL Analytics] 類別以檢視 [!DNL Pendo] 來源卡。 若要開始，請選取 **[!UICONTROL 新增資料]**.
...
為了建構用於在上設定webhook的URL [!DNL Pendo] 您必須擷取下列專案：
...
接下來，登入您的帳戶於 [[!DNL Pendo]](https://pendo.io/) 並建立webhook。 有關如何使用 [!DNL Pendo] 使用者介面，請參閱 [[!DNL Pendo] 建立webhook指南](https://support.pendo.io/hc/en-us/articles/360032285012-Webhooks#create-a-webhook-0-4).

建立webhook後，請導覽至 [!DNL Pendo] webhook ，並在 [!DNL URL] 欄位。
...
依照本教學課程中的指示，您已成功設定串流資料流，將 [!DNL Pendo] 要Experience Platform的資料。 若要監視正在擷取的資料，請參閱上的指南 [使用Platform UI監控串流資料流](../../monitor-streaming.md).

## 其他資源 {#additional-resources}

以下各節提供您在使用時，可參考的其他資源 [!DNL Pendo] 來源。
...
![Pendo UI熒幕擷圖顯示聊天記錄](../../../../images/tutorials/create/analytics-pendo-webhook/pendo-events.png)

* 在Platform UI中選取 **[!UICONTROL 檢視資料流]** 在 [!DNL Pendo] 來源目錄上的卡片功能表。 接下來，選取 **[!UICONTROL 預覽資料集]** 驗證針對您在中設定的webhook所擷取的資料 [!DNL Pendo].
...
若要修正此錯誤，您必須確認 *唯一識別碼* 已設定對應。 如需其他指引，請參閱 [Mping](#mapping) 區段。
