...
>[!NOTE]
>
>FTP連接器處於測試階段。 有關使用beta標籤連接器的詳細資訊，請參閱[來源概觀](../../../../home.md#terms-and-conditions)。
...
在[!UICONTROL 雲端儲存區]類別下，選取&#x200B;**[!UICONTROL FTP]**。 如果這是您第一次使用此連接器，請選擇&#x200B;**[!UICONTROL Configure]**。 否則，請選擇&#x200B;**[!UICONTROL 添加資料]**&#x200B;以建立新的FTP連接。

![目錄](../../../../images/tutorials/create/ftp/catalog.png)

此時將顯示&#x200B;**[!UICONTROL 連接到FTP]**&#x200B;頁。 在此頁上，您可以使用新認證或現有認證。
...
若要連接現有帳戶，請選取您要連線的FTP帳戶，然後選取&#x200B;**[!UICONTROL Next]**&#x200B;繼續。
