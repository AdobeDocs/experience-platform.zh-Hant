...
# 使用Platform UI建立[!DNL Mailchimp Campaigns]來源連線
...
為了將您的[!DNL Mailchimp Campaigns]資料帶入Platform，您必須先提供對應至您[!DNL Mailchimp]帳戶的適當驗證認證。
...
## 將您的[!DNL Mailchimp Campaigns]帳戶連線到Platform
...
在您的[!DNL Mailchimp]帳戶通過驗證，且已選取[!DNL Mailchimp Campaigns]資料後，您現在可以開始建立資料流，將您的資料匯入Platform。 如需有關如何建立資料流的詳細步驟，請參閱有關[建立資料流以將行銷自動化資料帶到Platform](../../dataflow/marketing-automation.md)的檔案。
