...
![具有OracleNetSuite Entities卡片之目錄的Platform UI熒幕擷取畫面](../../../../images/tutorials/create/marketing-automation/oracle-netsuite-entities/catalog-card.png)

**[!UICONTROL 連線OracleNetSuite Entities帳戶]**&#x200B;頁面就會顯示。 您可以在此頁面使用新的證明資料或現有的證明資料。
...
![將OracleNetSuite Entities帳戶與現有帳戶連線的Platform UI熒幕擷取畫面](../../../../images/tutorials/create/marketing-automation/oracle-netsuite-entities/existing.png)

### 新帳戶 {#new-account}

如果您正在建立新帳戶，請選取&#x200B;**[!UICONTROL 新帳戶]**，然後提供名稱、選擇性說明和您的認證。 完成時，請選取&#x200B;**[!UICONTROL 連線到來源]**，然後等待一段時間以建立新連線。

![用來連線OracleNetSuite Entities帳戶與新帳戶的平台UI熒幕擷取畫面](../../../../images/tutorials/create/marketing-automation/oracle-netsuite-entities/new.png)
...
![OracleNetsuite實體的Platform UI熒幕擷取畫面，顯示已選取連絡人選項的組態](../../../../images/tutorials/create/marketing-automation/oracle-netsuite-entities/select-data-contact.png)

>[!TAB 客戶]

![OracleNetsuite實體的Platform UI熒幕擷取畫面，顯示已選取客戶選項的組態](../../../../images/tutorials/create/marketing-automation/oracle-netsuite-entities/select-data-customer.png)

>[!ENDTABS]

## 後續步驟 {#next-steps}

依照本教學課程中的指示，您已建立與[!DNL Oracle NetSuite Entities]帳戶的連線。 您現在可以繼續進行下一個教學課程，並[設定資料流，以將行銷自動化資料帶入Platform](../../dataflow/marketing-automation.md)。
