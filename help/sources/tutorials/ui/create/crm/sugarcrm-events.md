...
### 為[!DNL SugarCRM]建立Experience Platform結構描述
...
![Experience Platform UI熒幕擷圖顯示SugarCRM Events的範例結構描述](../../../../images/tutorials/create/sugarcrm-events/sugarcrm-schema-events.png)

>[!WARNING]
>
>對應結構描述時，請確定您也對應了Experience Platform所需的必要`event_id`和`timestamp`欄位。
...
使用SugarCRM Events卡片目錄的![Experience Platform UI熒幕擷圖](../../../../images/tutorials/create/sugarcrm-events/catalog-sugarcrm-events.png)
...
![使用新帳戶連線SugarCRM Events帳戶的Experience Platform UI熒幕擷圖](../../../../images/tutorials/create/sugarcrm-events/new.png)

## 後續步驟

依照本教學課程中的指示，您已建立與[!DNL SugarCRM Events]帳戶的連線。 您現在可以繼續進行下一個教學課程，並[設定資料流以將資料帶入Experience Platform](../../dataflow/crm.md)。
...
* 在Experience Platform UI中，選取來源目錄上[!DNL SugarCRM Events]卡片功能表旁的&#x200B;**[!UICONTROL 檢視資料流程]**。 接著，選取&#x200B;**[!UICONTROL 預覽資料集]**&#x200B;以驗證所擷取的資料。
