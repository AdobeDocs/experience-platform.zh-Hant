...
Adobe Experience Platform中的來源連接器可讓您依計畫吸收外部來源的CRM資料。 本教程提供使用[!DNL Platform]用戶介面建立[!DNL Salesforce]源連接器的步驟。
...
在&#x200B;**[!UICONTROL Databases]**&#x200B;類別下，選擇&#x200B;**[!UICONTROL Salesforce]**。 如果這是您第一次使用此連接器，請選擇&#x200B;**[!UICONTROL Configure]**。 否則，請選擇&#x200B;**[!UICONTROL 新增資料]**&#x200B;以建立新的Salesforce連接器。

![目錄](../../../../images/tutorials/create/salesforce/catalog.png)

此時會顯示&#x200B;**[!UICONTROL 連線至Salesforce]**&#x200B;頁面。 在此頁上，您可以使用新認證或現有認證。

### 新帳戶

如果您使用新憑據，請選擇&#x200B;**[!UICONTROL 新建帳戶]**。 在顯示的輸入表單上，提供名稱、可選說明和您的[!DNL Salesforce]憑證。 完成後，選擇&#x200B;**[!UICONTROL Connect]** ，然後為建立新連接留出一些時間。

![連接](../../../../images/tutorials/create/salesforce/new.png)

### 現有帳戶

要連接現有帳戶，請選擇要連接的[!DNL Salesforce]帳戶，然後選擇右上角的&#x200B;**[!UICONTROL Next]**&#x200B;繼續。
