...
收集完所需的認證後，您可依照下列步驟建立新帳戶以 [!DNL Salesforce] 連接至 [!DNL Platform]。
...
在「資 *[!UICONTROL 料庫]* 」類別下，選取 **[!UICONTROL Salesforce]** ，接著 **[!UICONTROL 新增資料]** ，以建立新的Salesforce連接器。
...
如果您使用新認證，請選擇「新 **[!UICONTROL 帳戶」]**。 在出現的輸入表單上，提供連線名稱、選用說明和您的認 [!DNL Salesforce] 證。 完成後，選擇 **[!UICONTROL Connect]** ，然後為新帳戶建立留出一些時間。
...
遵循本教學課程，您已建立與帳戶的 [!DNL Salesforce] 連線。 您現在可以繼續下一個教程，並 [配置資料流以將資料導入平台](../../dataflow/crm.md)。