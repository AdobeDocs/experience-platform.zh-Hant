...
* [[!DNL Real-Time Customer Profile]](../../../../../profile/home.md)：基於來自多個來源的聚合數據，提供統一的實時消費者設定檔。
* [源](../../../../home.md)：Experience Platform 允許從各種源引入數據，同時使您能夠使用 Experience Platform 服務構建、標記和增強傳入的數據。

### 收集所需的憑據

若要連接到 [!DNL Algolia] Experience Platform，必須為以下憑據提供值：
...
To use an existing account, select **[!UICONTROL Existing account]** and then select the [!DNL Algolia User Profiles] account that you want to use. 若要繼續，請選取&#x200B;**[!UICONTROL 下一步]**。

![現有的帳戶介面。](../../../../images/tutorials/create/algolia/user-profiles/existing-account.png)

### 新帳戶

如果要創建新帳戶，請選擇“ **[!UICONTROL 新帳戶]**”，然後提供名稱、可選說明和 [!DNL Algolia] 憑據。 完成後，選擇「連接到源&#x200B;]**」，**[!UICONTROL &#x200B;然後留出一些時間建立新連接。

![新的帳戶介面。](../../../../images/tutorials/create/algolia/user-profiles/new-account.png)
...
![源的映射步驟工作流程。](../../../../images/tutorials/create/algolia/user-profiles/mapping.png)

### 計劃引入運行

下一個，請使用計劃介面定義數據流的引入計劃。
...
![源工作流程的計劃步驟。](../../../../images/tutorials/create/algolia/user-profiles/scheduling.png)
...
可以刪除不再需要的數據流，或者使用數據流&#x200B;]**工作環境中**[!UICONTROL &#x200B;提供的刪除&#x200B;]**函數錯誤**[!UICONTROL &#x200B;創建的數據流。有關如何刪除数据流的詳細信息，造訪UI](../../delete.md)中刪除數據流的[教學課程。
