...
Adobe Experience Platform中的來源連接器可讓您依計畫吸收外部來源的資料。 本教學課程提供從&#x200B;**[!UICONTROL Sources]**&#x200B;工作區刪除帳戶的步驟。
...
登入[Adobe Experience Platform](https://platform.adobe.com)，然後從左側導覽列選擇&#x200B;**[!UICONTROL Sources]**&#x200B;以存取&#x200B;**[!UICONTROL Sources]**&#x200B;工作區。 **[!UICONTROL Catalog]**&#x200B;螢幕顯示了各種源，您可以用這些源建立帳戶和資料流。 每個源顯示與其關聯的現有帳戶和資料流的數量。
...
**[!UICONTROL Properties]**&#x200B;面板會顯示在畫面的右側，其中包含有關所選帳戶的資訊。

選取您要刪除之帳戶名稱旁的省略號(`...`)。 此時會出現彈出式面板，提供&#x200B;**[!UICONTROL 「新增資料]**」、「編輯詳細資料&#x200B;]**」和「刪除]**」的選項。 **[!UICONTROL **[!UICONTROL &#x200B;選擇&#x200B;**[!UICONTROL Delete]**&#x200B;刪除帳戶。

![dataflows-sort](../../images/tutorials/delete-accounts/delete.png)

最後將顯示確認對話框，選擇&#x200B;**[!UICONTROL Delete]**&#x200B;以完成該過程。
