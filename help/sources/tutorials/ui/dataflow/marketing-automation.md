---
keywords: Experience Platform; home；熱門主題；行銷自動化連接器
solution: Experience Platform
title: 在UI中為Marketing Automation Source連線設定資料流
topic: overview
type: Tutorial
description: 資料流是從源中檢索資料並將資料帶入資料集的計畫任務。  [!DNL Platform] 本教學課程提供使用行銷自動化帳戶設定新資料流的步驟。
...
資料流是從源中檢索資料並將資料帶入[!DNL Platform]資料集的計畫任務。 本教學課程提供使用行銷自動化帳戶設定新資料流的步驟。
...
此外，本教學課程要求您已建立行銷自動化帳戶。 有關在UI中建立不同行銷自動化連接器的教學課程清單，請參閱[來源連接器概述](../../../home.md)。
