...
type: Tutorial
description: 資料流是從源中檢索資料並將資料帶入Adobe Experience Platform資料集的計畫任務。 本教程提供使用付款帳戶配置新資料流的步驟。
...
資料流是從源中檢索資料並將資料帶入Adobe Experience Platform資料集的計畫任務。 本教程提供使用付款帳戶配置新資料流的步驟。
...
此外，本教學課程要求您已建立付款帳戶。 在[來源連接器概觀](../../../home.md)中可找到在UI中建立不同付款連接器的教學課程清單。

## 選擇資料

建立付款帳戶後，會出現&#x200B;**[!UICONTROL Select data]**&#x200B;步驟，提供互動式介面供您探索檔案階層。
