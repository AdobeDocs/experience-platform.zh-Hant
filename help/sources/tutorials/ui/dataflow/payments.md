---
keywords: Experience Platform；首頁；熱門主題；付款連接器
solution: Experience Platform
title: 在UI中使用付款源建立資料流
topic-legacy: overview
type: Tutorial
description: 資料流是一個排程任務，可從源中檢索資料並將資料內嵌到Platform資料集。 本教學課程提供如何使用Platform UI為付款來源建立資料流的步驟。
...
資料流是一項排程任務，可從來源擷取資料，並內嵌至Adobe Experience Platform中的資料集。 本教學課程提供如何使用Platform UI為付款來源建立資料流的步驟。

>[!NOTE]
>
>為了建立資料流，您必須已擁有具有支付源的已驗證帳戶。 您可以在 [來源概觀](../../../home.md#payments).
...
建立您的付款來源帳戶後， **[!UICONTROL 新增資料]** 步驟，提供介面供您瀏覽付款來源帳戶的表層次結構。
...
按照本教程，您已成功建立了資料流，以便將資料從付款源帶到Platform。 下游現在可以使用傳入的資料 [!DNL Platform] 服務，例如 [!DNL Real-Time Customer Profile] 和 [!DNL Data Science Workspace]. 如需詳細資訊，請參閱下列檔案：
