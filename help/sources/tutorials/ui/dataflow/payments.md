...
>[!NOTE]
>
>為了建立資料流，您必須擁有具有付款來源的已驗證帳戶。 在UI中建立不同付款來源帳戶的教學課程清單，請參閱 [來源概觀](../../../home.md#payments).
...
建立您的付款來源帳戶之後， **[!UICONTROL 新增資料]** 步驟即會顯示，提供介面供您探索付款來源科目的表格階層。
...
依照本教學課程中的指示，您已成功建立資料流，將資料從您的付款來源帶入Platform。 下游現在可以使用傳入的資料 [!DNL Platform] 服務，例如 [!DNL Real-Time Customer Profile] 和 [!DNL Data Science Workspace]. 如需更多詳細資訊，請參閱下列檔案：
