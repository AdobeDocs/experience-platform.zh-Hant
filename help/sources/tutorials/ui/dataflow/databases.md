...
資料流是一項排程任務，可從來源擷取資料，並內嵌至Adobe Experience Platform中的資料集。 本教學課程提供如何使用Platform UI為資料庫來源建立資料流的步驟。

>[!NOTE]
>
>要建立資料流，您必須已擁有已驗證的帳戶，該帳戶具有資料庫源。 您可以在 [來源概觀](../../../home.md#database).
...
建立資料庫源帳戶後， **[!UICONTROL 新增資料]** 步驟，提供介面供您瀏覽資料庫源帳戶的表層次結構。
...
按照本教程，您已成功建立資料流以將資料從資料庫源帶入Platform。 下游現在可以使用傳入的資料 [!DNL Platform] 服務，例如 [!DNL Real-Time Customer Profile] 和 [!DNL Data Science Workspace]. 如需詳細資訊，請參閱下列檔案：
