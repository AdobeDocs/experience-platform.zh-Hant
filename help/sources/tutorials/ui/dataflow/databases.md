---
keywords: Experience Platform;home；熱門主題；資料庫連接器
...
建立資料庫帳戶後，將出現&#x200B;**[!UICONTROL 選擇資料]**&#x200B;步驟，為您提供一個互動式介面以瀏覽資料庫層次。
...
**[!UICONTROL Properties]**&#x200B;欄會顯示在畫面的右側，包括&#x200B;**[!UICONTROL Enabled]**&#x200B;切換按鈕。 選擇切換以禁用資料流。 在禁用資料流後，可以使用相同的切換來重新啟用資料流。
