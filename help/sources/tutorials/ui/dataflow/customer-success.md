...
>[!NOTE]
>
>為了建立資料流，您必須擁有已驗證的帳戶，且帳戶具有客戶成功來源。 在UI中建立不同客戶成功來源帳戶的教學課程清單可在以下網址找到： [來源概觀](../../../home.md#customer-success).
...
建立客戶成功來源帳戶後， **[!UICONTROL 新增資料]** 步驟隨即顯示，提供介面供您探索客戶成功來源帳戶的表格階層。
...
依照本教學課程所述，您已成功建立資料流，以將客戶成功來源中的資料匯入Platform。 下游現在可以使用傳入的資料 [!DNL Platform] 服務，例如 [!DNL Real-Time Customer Profile] 和 [!DNL Data Science Workspace]. 如需更多詳細資訊，請參閱下列檔案：
