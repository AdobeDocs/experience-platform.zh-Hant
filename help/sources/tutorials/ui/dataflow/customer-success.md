---
keywords: Experience Platform；首頁；熱門主題；配置資料流；客戶成功連接器
solution: Experience Platform
title: 在UI中為客戶成功源連接配置資料流
topic-legacy: overview
type: Tutorial
description: 資料流是從源中檢索資料並將資料接收到的計畫任務 [!DNL Platform] 資料集。 本教程提供了使用客戶成功帳戶配置新資料流的步驟。
...
資料流是從源中檢索資料並將資料接收到的計畫任務 [!DNL Platform] 資料集。 本教程提供了使用客戶成功帳戶配置新資料流的步驟。
...
此外，本教程要求您已經建立了客戶成功帳戶。 有關在UI中建立不同客戶成功連接器的教程清單，請參見 [源連接器概述](../../../home.md)。

## 選擇資料

建立客戶成功連接器後， **[!UICONTROL 選擇資料]** 的子菜單。
...
![選擇 — 現有資料集](../../../images/tutorials/dataflow/customer-success/select-dataset.png)
...
![選擇模式](../../../images/tutorials/dataflow/customer-success/select-schema.png)
...
- **[!UICONTROL 映射詳細資訊]**:顯示源資料正被攝取到的資料集，包括該資料集所遵循的架構。
- **[!UICONTROL 計畫詳細資訊]**:顯示接收計畫的活動期間、頻率和間隔。
...
通過學習本教程，您已成功建立了資料流，以從客戶成功源中導入資料，並深入瞭解了監視資料集。 傳入資料現在可供下游使用 [!DNL Platform] 服務，如 [!DNL Real-time Customer Profile] 和 [!DNL Data Science Workspace]。 有關詳細資訊，請參閱以下文檔：
...
在 **[!UICONTROL 驗證]** 螢幕中，選擇與要禁用的資料流關聯的帳戶名稱。
