---
keywords: Experience Platform；首頁；熱門主題；設定資料流；客戶成功連接器
solution: Experience Platform
title: 在UI中為客戶成功源連接配置資料流
topic-legacy: overview
type: Tutorial
description: 資料流是一個排程任務，可從源中檢索並將資料內嵌到 [!DNL Platform] 資料集。 本教學課程提供使用客戶成功帳戶設定新資料流的步驟。
...
資料流是從源中檢索資料並將資料內嵌到[!DNL Platform]資料集的計畫任務。 本教學課程提供使用客戶成功帳戶設定新資料流的步驟。
...
此外，本教學課程需要您已建立客戶成功帳戶。 若需在UI中建立不同客戶成功連接器的教學課程清單，請參閱[來源連接器概述](../../../home.md)。

## 選擇資料

建立客戶成功連接器後，會出現&#x200B;**[!UICONTROL 選取資料]**&#x200B;步驟，提供互動式介面供您探索檔案階層。
...
依照本教學課程，您已成功建立資料流，從客戶成功來源匯入資料，並深入了解監控資料集。 下游[!DNL Platform]服務（如[!DNL Real-time Customer Profile]和[!DNL Data Science Workspace]）現在可以使用傳入的資料。 如需詳細資訊，請參閱下列檔案：
