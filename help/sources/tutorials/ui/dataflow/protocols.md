...
type: Tutorial
description: 資料流是一項排程任務，可從來源擷取資料，並內嵌至Adobe Experience Platform資料集。 本教學課程提供使用您的通訊協定帳戶設定新資料流的步驟。
...
資料流是一項排程任務，可從來源擷取資料，並內嵌至Adobe Experience Platform資料集。 本教學課程提供使用您的通訊協定帳戶設定新資料流的步驟。
...
此外，本教學課程需要您已建立通訊協定帳戶。 若需在UI中建立不同通訊協定連接器的教學課程清單，請參閱[來源連接器概述](../../../home.md)。

## 選擇資料

建立您的協定帳戶後，將顯示&#x200B;**[!UICONTROL 選擇資料]**&#x200B;步驟，提供交互介面供您瀏覽檔案層次結構。
