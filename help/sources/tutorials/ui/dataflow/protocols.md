...
>[!NOTE]
>
>* 為了建立資料流，您必須擁有具有通訊協定來源的已驗證帳戶。 在UI中建立不同通訊協定來源帳戶的教學課程清單，請參閱 [來源概觀](../../../home.md#protocols).
...
建立通訊協定來源帳戶後， **[!UICONTROL 新增資料]** 步驟隨即顯示，提供介面供您探索通訊協定來源帳戶的表格階層。
...
依照本教學課程中的指示，您已成功建立資料流，將您的通訊協定來源中的資料匯入Platform。 下游現在可以使用傳入的資料 [!DNL Platform] 服務，例如 [!DNL Real-Time Customer Profile] 和 [!DNL Data Science Workspace]. 如需更多詳細資訊，請參閱下列檔案：
