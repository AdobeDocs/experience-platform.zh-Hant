...
type: Tutorial
description: 資料流是從源中檢索資料並將資料接收到Adobe Experience Platform資料集的計畫任務。 本教程提供了使用協定帳戶配置新資料流的步驟。
...
資料流是從源中檢索資料並將資料接收到Adobe Experience Platform資料集的計畫任務。 本教程提供了使用協定帳戶配置新資料流的步驟。
...
此外，本教程要求您已建立協定帳戶。 有關在UI中建立不同協定連接器的教程清單，請參見 [源連接器概述](../../../home.md)。

## 選擇資料

建立協定帳戶後， **[!UICONTROL 選擇資料]** 的子菜單。
...
![選擇 — 現有資料集](../../../images/tutorials/dataflow/protocols/select-existing-dataset.png)
...
![新建資料集](../../../images/tutorials/dataflow/protocols/new-dataset.png)

的 **[!UICONTROL 選擇架構]** 對話框。 選擇要應用到新資料集的架構，然後按一下 **[!UICONTROL 完成]**。

![選擇模式](../../../images/tutorials/dataflow/protocols/select-existing-schema.png)
...
的 **[!UICONTROL 資料流詳細資訊]** 步驟，允許您命名並提供有關新資料流的簡短說明。
...
![瀏覽資料集流](../../../images/tutorials/dataflow/protocols/view-dataset-flows.png)
