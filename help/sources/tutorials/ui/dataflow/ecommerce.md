...
此外，本教學課程要求您已建立&#x200B;**[!UICONTROL eCommerce]**&#x200B;帳戶。 有關在UI中建立不同&#x200B;**[!UICONTROL eCommerce]**&#x200B;連接器的教程清單，請參閱[源連接器概述](../../../home.md)。

## 選擇資料

在建立&#x200B;**[!UICONTROL eCommerce]**&#x200B;帳戶後，會顯示&#x200B;**[!UICONTROL Select data]**&#x200B;步驟，提供互動式介面供您探索檔案階層。
