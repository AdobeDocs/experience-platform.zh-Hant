---
keywords: Experience Platform; home；熱門主題；eCommerce Connector;eCommerce
solution: Experience Platform
title: 在UI中為電子商務源連接配置資料流
topic: overview
type: Tutorial
description: 資料流是從源中檢索資料並將資料帶入資料集的計畫任務。  [!DNL Platform] 本教學課程提供使用電子商務帳戶配置新資料流的步驟。
...
資料流是從源中檢索資料並將資料帶入[!DNL Platform]資料集的計畫任務。 本教程提供使用&#x200B;**[!UICONTROL eCommerce]**&#x200B;帳戶配置新資料流的步驟。
...
此外，本教學課程要求您已建立&#x200B;**[!UICONTROL eCommerce]**&#x200B;帳戶。 在[來源連接器概述](../../../home.md)中，可找到在UI中建立不同&#x200B;**[!UICONTROL eCommerce]**&#x200B;連接器的教學課程清單。

## 選擇資料

在建立&#x200B;**[!UICONTROL eCommerce]**&#x200B;帳戶後，會顯示&#x200B;**[!UICONTROL 選擇資料]**&#x200B;步驟，提供互動式介面供您探索檔案階層。
...
通過本教程，您成功建立了一個資料流以導入&#x200B;**[!UICONTROL eCommerce]**&#x200B;資料並獲得了對監控資料集的深入瞭解。 現在，下游[!DNL Platform]服務（例如[!DNL Real-time Customer Profile]和[!DNL Data Science Workspace]）可以使用傳入的資料。 如需詳細資訊，請參閱下列檔案：
