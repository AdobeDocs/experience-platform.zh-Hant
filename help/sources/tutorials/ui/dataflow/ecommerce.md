...
type: Tutorial
description: 資料流是一個排程任務，可從源中檢索並將資料內嵌到 [!DNL Platform] 資料集。 本教學課程提供使用您的電子商務帳戶設定新資料流的步驟。
...
資料流是從源中檢索資料並將資料內嵌到[!DNL Platform]資料集的計畫任務。 本教學課程提供使用&#x200B;**[!UICONTROL eCommerce]**&#x200B;帳戶配置新資料流的步驟。
...
此外，本教學課程要求您已建立&#x200B;**[!UICONTROL eCommerce]**&#x200B;帳戶。 若需在UI中建立不同&#x200B;**[!UICONTROL eCommerce]**&#x200B;連接器的教學課程清單，請參閱[來源連接器概述](../../../home.md)。

## 選擇資料

建立&#x200B;**[!UICONTROL eCommerce]**&#x200B;帳戶後，將顯示&#x200B;**[!UICONTROL 選擇資料]**&#x200B;步驟，提供互動式介面供您探索檔案階層。
...
依照本教學課程，您已成功建立資料流以帶入&#x200B;**[!UICONTROL eCommerce]**&#x200B;資料，並獲得監控資料集的深入分析。 下游[!DNL Platform]服務（如[!DNL Real-time Customer Profile]和[!DNL Data Science Workspace]）現在可以使用傳入的資料。 如需詳細資訊，請參閱下列檔案：
