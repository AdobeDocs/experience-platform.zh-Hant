...
title: 在UI中為電子商務源連接配置資料流
topic-legacy: overview
type: Tutorial
description: 資料流是從源中檢索資料並將資料接收到的計畫任務 [!DNL Platform] 資料集。 本教程提供了使用電子商務帳戶配置新資料流的步驟。
...
資料流是從源中檢索資料並將資料接收到的計畫任務 [!DNL Platform] 資料集。 本教程提供了使用 **[!UICONTROL 電子商務]** 帳戶。
...
此外，本教程要求您已建立 **[!UICONTROL 電子商務]** 帳戶。 用於建立不同教程的清單 **[!UICONTROL 電子商務]** UI中的連接器可在 [源連接器概述](../../../home.md)。

## 選擇資料

在建立 **[!UICONTROL 電子商務]** 帳戶， **[!UICONTROL 選擇資料]** 的子菜單。
...
![選擇資料](../../../images/tutorials/dataflow/ecommerce/select-data.png)
...
![選擇 — 現有資料集](../../../images/tutorials/dataflow/ecommerce/select-existing-dataset.png)
...
![新建資料集](../../../images/tutorials/dataflow/ecommerce/new-dataset.png)

的 **[!UICONTROL 選擇架構]** 對話框。 選擇要應用到新資料集的架構，然後按一下 **[!UICONTROL 完成]**。

![選擇模式](../../../images/tutorials/dataflow/ecommerce/select-schema.png)
...
![審查](../../../images/tutorials/dataflow/ecommerce/review.png)
...
按照本教程，您已成功建立了要引入的資料流 **[!UICONTROL 電子商務]** 並對監控資料集有了深刻的認識。 傳入資料現在可供下游使用 [!DNL Platform] 服務，如 [!DNL Real-time Customer Profile] 和 [!DNL Data Science Workspace]。 有關詳細資訊，請參閱以下文檔：
