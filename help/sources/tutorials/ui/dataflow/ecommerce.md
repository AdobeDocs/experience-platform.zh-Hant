...
建立您的電子商務來源帳戶後， **[!UICONTROL 新增資料]** 步驟隨即顯示，提供介面供您探索電子商務來源帳戶的表格階層。
...
依照本教學課程所述，您已成功建立資料流，以將您的電子商務來源中的資料匯入Platform。 下游現在可以使用傳入的資料 [!DNL Platform] 服務，例如 [!DNL Real-Time Customer Profile] 和 [!DNL Data Science Workspace]. 如需更多詳細資訊，請參閱下列檔案：
