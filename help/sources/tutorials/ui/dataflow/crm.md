...
>[!NOTE]
>
>如果您使用 [!DNL Salesforce] 作為Real-time Customer Data PlatformB2B版的一部分，請參閱 [[!DNL Salesforce] 欄位映射文檔](../../../connectors/adobe-applications/mapping/salesforce.md) 關於繪圖的指導 [!DNL Salesforce] 源欄位到其相應的XDM目標欄位。
