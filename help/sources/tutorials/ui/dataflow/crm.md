...
資料流是一項排程任務，可從來源擷取資料，並內嵌至Adobe Experience Platform中的資料集。 本教學課程提供如何使用Platform UI為CRM（客戶關係管理）來源建立資料流的步驟。

>[!NOTE]
>
>若要建立資料流，您必須已擁有具有CRM來源的已驗證帳戶。 若需在UI中建立不同CRM來源帳戶的教學課程清單，請參閱 [來源概觀](../../../home.md#crm).
...
建立CRM來源帳戶後， **[!UICONTROL 新增資料]** 步驟，提供介面供您探索CRM帳戶的表格階層。
...
>[!NOTE]
>
>如果您使用 [!DNL Salesforce] 如需Adobe Real-time Customer Data Platform B2B版的一部分，請參閱 [[!DNL Salesforce] 欄位對應檔案](../../../connectors/adobe-applications/mapping/salesforce.md) 地圖指南 [!DNL Salesforce] 來源欄位至其適當的XDM目標欄位。
