...
* 同意{#consent}
   ...
   * IAB透明與同意架構2.0 {#iab-tcf}
      ...
      * [整合Adobe Experience Platform Launch](consent/iab-tcf/with-launch.md)
      * [不使用Adobe Experience Platform Launch整合](consent/iab-tcf/without-launch.md)
* Adobe Experience Platform Launch的Web SDK擴充功能{#extension}
   * [Web SDK擴充功能](extension/web-sdk-extension.md)
