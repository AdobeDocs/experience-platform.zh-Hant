...
| 欄位 | 說明 |
| --- | --- |
| [!UICONTROL 沙箱] | **（必需）** 選擇要向其發送資料的平台沙盒。 沙箱是Adobe Experience Platform的虛擬分區，允許您將資料和實施與組織中的其他人隔離開來。<br><br>如果建立資料流而不選擇沙盒，則以後仍可以選擇沙盒。<br><br>建立資料流並選擇沙盒後，無法更改沙盒。 的 [!UICONTROL 沙盒] 因此，當使用選定沙盒編輯現有資料流時，選擇欄位不可用。<br><br> 的 [!UICONTROL 沙盒] 因此，編輯現有資料流時，選擇欄位不可用。<br><br>有關沙箱在Experience Platform中角色的詳細資訊，請參見 [箱文檔](../../sandboxes/home.md)。 |
