...
>title="輪廓計數"
>abstract="這個小工具會顯示取得快照時輪廓存放區內合併的輪廓總數。該數量取決於套用至您輪廓資料的所選合併原則。"
...
>title="輪廓計數變更"
>abstract="這個小工具會顯示上一次快照時&#x200B;**新增**&#x200B;至輪廓存放區合併的輪廓總數。該數量取決於套用至您輪廓資料的所選合併原則。"
...
>title="輪廓計數變更趨勢"
>abstract="這個小工具會顯示在過去 30 天、90 天或 12 個月內每天新增至輪廓存放區的合併輪廓數量。該數量也取決於套用至您輪廓資料的所選合併原則。"
