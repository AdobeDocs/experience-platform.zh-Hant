...
![在左側導覽中顯示儀表板並反白顯示「建立儀表板」的控制面板詳細目錄。](./images/user-defined-dashboards/create-dashboard.png)
...
![醒目提示「標籤」下拉式清單的Widget Composer。](./images/user-defined-dashboards/marks-dropdown.png)

將屬性新增為篩選器後，您可以選取要包含或排除Widget中的值。 從屬性清單新增篩選器後，[!UICONTROL 篩選器]對話方塊會出現，您可以在其中使用核取方塊選取或取消選取值。

![篩選條件對話方塊，以從您的Widget篩選值。](./images/user-defined-dashboards/filter-dialog.png)
...
![含有[!UICONTROL 最近日期]和[!UICONTROL 套用]的[!UICONTROL 篩選器： date_key]對話方塊已強調顯示。](./images/user-defined-dashboards/recent-date.png)
...
![包含個別日期核取方塊的[!UICONTROL 篩選器： date_key]對話方塊已核取及取消核取。](./images/user-defined-dashboards/select-dates.png)
...
![包含自訂Widget和醒目提示儲存按鈕的使用者定義儀表板。](./images/user-defined-dashboards/user-defined-dashboard.png)
...
![自訂儀表板中的Widget，反白顯示橢圓和重複的Widget。](./images/user-defined-dashboards/duplicate.png)
