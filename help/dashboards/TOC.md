...
* 資料Distiller {#data-distiller}
   ...
   * 延伸應用程式報表{#customizable-insights}的可自訂分析
      ...
      * 篩選器{#filters}
         * [日期篩選器](data-distiller/customizable-insights/filters/date-filter.md)
         * [全域篩選器](data-distiller/customizable-insights/filters/global-filter.md)
      * [檢視更多資訊](data-distiller/customizable-insights/view-more.md)
      * [檢視 SQL](data-distiller/customizable-insights/view-sql.md)
      * [下載為CSV檔](data-distiller/customizable-insights/download-csv.md)
* 可用的儀表板{#guides}
