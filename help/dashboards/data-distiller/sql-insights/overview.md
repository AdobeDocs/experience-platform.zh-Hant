...
![反白顯示[建立儀表板]的儀表板詳細目錄。](../../images/sql-insights/create-dashboard.png)
...
![以Query pro模式和[儲存]反白顯示的[!UICONTROL 建立儀表板]對話方塊。](../../images/sql-insights/query-pro-mode.png)

## 建立圖表 {#create-a-chart}

如需使用SQL建立圖表的逐步指示，請參閱[query pro mode guide](../query-pro-mode/overview.md)。
