...
![此[!UICONTROL 建立全域篩選對話方塊]包含資料集下拉式功能表、執行圖示和「下一步」反白顯示。](../../../images/query-pro-mode/global-filter.png)
...
![ [!UICONTROL 建立全域篩選對話方塊]，其中的Select和篩選標籤文字輸入反白顯示。](../../../images/query-pro-mode/global-filter-label.png)
...
![具有全域篩選器切換的Widget Composer已反白顯示。](../../../images/query-pro-mode/global-filter-consent.png)
...
![反白顯示篩選對話方塊的自訂儀表板。](../../../images/query-pro-mode/custom-filters.png)
