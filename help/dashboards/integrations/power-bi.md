...
Power BI報告模板功能允許您建立填有Adobe Experience Platform資料的引人注目的報告。 簡化的安裝過程會自動為即時客戶概要檔案、細分和目標安裝標準小部件。 此安裝還將Power BI連接到資料模型，以便您可以輕鬆自定義和擴展報告模板。 這些報告可以在您整個組織中共用，而不需要您的平台上IMS組織的收件人憑證。
