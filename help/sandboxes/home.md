...
沙盒是單一Experience Platform例項中的虛擬分區，可讓您與數位體驗應用程式的開發流程順暢整合。 Experience Platform實例支援多個生產和非生產沙盒，每個沙盒維護其獨立的平台資源庫（包括方案、資料集、配置檔案等）。 在沙盒中執行的所有內容和動作都僅限於該沙盒，不會影響任何其他沙盒。

非生產沙盒可讓您測試功能、執行實驗並建立自訂組態，而不會影響生產沙盒。 此外，生產與非生產沙盒都有重設功能，可從沙盒移除所有客戶建立的資源。 非生產沙盒無法轉換為生產沙盒。 預設的Experience Platform授權會授與您五個沙盒（一個製作與四個非製作）。 您最多可新增10個沙盒，最多總共75個沙盒。 這些額外的沙盒可用來建立生產與非生產沙盒。 如需詳細資訊，請連絡您的IMS組織管理員或Adobe銷售代表。
...
為了檢視、建立、更新或刪除生產與非生產沙盒，使用者也必須獲得沙盒管理權限。
