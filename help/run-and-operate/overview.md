...
* **實作人員**：驗證實作效率和可靠性的從業人員，以及疑難排解技術問題的從業人員。

## 先決條件 {#prerequisites}

若要存取[執行與操作]工具，您需要&#x200B;**[!UICONTROL View Job Schedules]**&#x200B;與&#x200B;**[!UICONTROL View Profile Management]** [存取控制許可權](/help/access-control/home.md#permissions)。 請聯絡您的系統管理員，以確保您擁有適當的許可權。
...
透過[健康狀態檢查](health-checks.md)，您可以主動偵測結構描述和身分設定問題，以免其影響您的業務運作。 目前，健康情況檢查會每天對您的方案和身分名稱空間執行靜態掃描，顯示遺漏的最佳實務、錯誤設定和模式，這些都會導致下游失敗。
...
* **[自訂身分名稱空間描述](health-checks.md#namespace-missing-description)**：確認名稱空間中繼資料完整。
