...
機器人偵測可讓您識別產生的事件 [[!DNL Web SDK]](../edge/home.md)， [[!DNL Mobile SDK]](https://developer.adobe.com/client-sdks/home/) 和 [[!DNL Server API]](../server-api/overview.md) 由已知的編目程式和機器人所產生。
