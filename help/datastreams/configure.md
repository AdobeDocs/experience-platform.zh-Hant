...
| [!UICONTROL Third Party ID Sync Container ID] | 用於協力廠商 ID 同步之容器的數值 ID。<br><br>**注意：**&#x200B;資料流參考預設的Audience Manager容器識別碼0。 如果您有多個Audience Manager ID同步容器ID，請洽詢您的Audience Manager顧問，以正確識別並解析ID同步設定。 |
