...
| [!UICONTROL Media Analytics] | 選取此選項即可啟用透過Experience Platform SDK或Media Edge API處理Edge Network整合的串流追蹤資料。 若要瞭解Media Analytics，請參閱 [檔案](https://experienceleague.adobe.com/docs/media-analytics/using/media-overview.html). |
