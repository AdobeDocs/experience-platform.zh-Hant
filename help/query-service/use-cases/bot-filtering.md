...
* Marketing CloudID(MCID):這提供了通用、持久的ID，可標識所有Adobe解決方案中的訪問者。
...
表達式將過濾滿足閾值但不處理來自其他時間間隔的通信量峰值的所有訪問者的MCID。
...
示例語句收集各個持續時間內每個MCID的最大按一下次數。 初始語句已擴展為包括1分（60秒）、5分（300秒）和1小時（即1800秒）時段。
...
| 656366098591762751 | 6 | 6 | 6 |
| 24035661057693627 | 4 | 4 | 4 |
