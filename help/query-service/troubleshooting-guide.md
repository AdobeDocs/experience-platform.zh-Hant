...
+++答案是，您可以使用Postman（一個免費的第三方應用程式）可視化所有AdobeAPI服務並與之交互。 觀看 [郵遞員設定指南](https://video.tv.adobe.com/v/28832) 有關如何在「Adobe開發人員控制台」中設定項目並獲取與Postman一起使用的所有必要憑據的逐步說明。 請參閱 [關於啟動、運行和共用郵件收藏的指導](https://learning.postman.com/docs/running-collections/intro-to-collection-runs/)。
+++
