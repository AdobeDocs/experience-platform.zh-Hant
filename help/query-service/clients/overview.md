...
本節說明如何從各種案頭使用者端應用程式連線至[!DNL Query Service]，以及如何驗證這些連線。 [!DNL Query Service]使用[!DNL PostgreSQL]通訊協定，因此本節中的指示說明如何使用[!DNL PostgreSQL]工具和驅動程式來連線和寫入查詢。
...
>[!IMPORTANT]
>
>身為Power BI和Tableau使用者，您可以從「查詢服務」憑證標籤將Customer Journey Analytics連線至您的BI工具。 請參閱認證檔案，瞭解如何[將您的BI工具連線至Customer Journey Analytics](../ui/credentials.md#connect-to-customer-journey-analytics)的說明。
