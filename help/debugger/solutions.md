...
使用「Adobe Experience Platform標籤」部分查看標籤請求。 也可以選擇 **[!UICONTROL 配置]** 配置 [嵌入代碼](../tags/ui/publishing/environments.md#embed-code)。 您可以在 Experience Platform Debugger 中編輯、替換或新增更多內嵌程式碼。登入的話，可以使用下拉式選單選取替代屬性。
