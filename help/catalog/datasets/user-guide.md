...
資料使用標籤可讓您根據套用至該資料的使用原則來分類資料集和欄位。 請參閱 [Data Governance概觀](../../data-governance/home.md) ，以進一步瞭解標籤，或參閱資料使 [](../../data-governance/labels/overview.md) 用標籤使用指南，以取得如何將標籤套用至資料集的指示。
