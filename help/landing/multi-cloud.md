...
description: 瞭解在Microsoft Azure上執行Experience Platform與在Amazon Web Services上執行有何差異。
...
在Azure上的Experience Platform或AWS之間選擇，取決於您業務的特定因素：

* **業務和技術需求**：評估您組織的需求和長期雲端策略。
* **現有基礎結構**：考慮您目前的雲端基礎結構和整合需求。
* **雲端技術依賴**：如果您的業務嚴重依賴Microsoft技術，則Azure可能更適合。 如果您更依賴Amazon服務，AWS可能是更好的選擇。
...
Experience Platform提供在6個Microsoft Azure託管位置和1個Amazon Web Services (AWS)託管位置使用，並透過分散在世界各地的7個[Edge Network節點](../collection/home.md#edge)將資料路由到Adobe服務。

### Microsoft Azure地區 {#azure-regions}

下表顯示Experience Platform託管所在的Microsoft Azure區域。
...
### 在Microsoft Azure上執行Experience Platform與AWS之間的差異 {#azure-aws-differences}

下表著重說明在Microsoft Azure上執行Experience Platform與在AWS上執行的主要差異。

| 特色/功能 | Microsoft Azure | Amazon Web Services |
| --- | --- | --- |
| [符合HIPAA規範](https://www.adobe.com/tw/trust/compliance/hipaa-ready.html) | 支援 | 不支援 |
...
Experience Platform提供在Microsoft Azure或Amazon Web Services上執行的選項，讓您擁有彈性與選擇。 評估您的業務需求和現有基礎架構，以針對使用哪個雲端平台做出明智的決策。
