...
**Adobe Experience Platform決策服務** 「運用即時客戶個人檔案」，根據「個人檔案」從啟用的資料集提取的行為資料，判斷客戶最可能從一組選項中做出的選擇。

**Adobe Experience Platform Launch:**[!DNL Launch] 是標籤和SDK管理生態系統，與應用程式 [!DNL Experience Platform] 和應 [!DNL Experience Cloud] 用程式。 [!DNL Launch] 提供部署、統一及管理分析、行銷和廣告整合的工具，以在所有用戶端裝置上提供相關客戶體驗。

**Adobe Experience Platform Launch Extensions:**[!DNL Experience Platform Launch] 擴充功能可將原始事件資料直接傳送至 [!DNL Real-time Customer Data Platform] 目的地。 安裝擴 [!DNL Launch] 充功能需要存取屬 [!DNL Launch] 性。
...
**決策規則：** 在中， [!DNL Decisioning Service]決策規則是定義並控制對最終用戶顯示選件的內容、時間、地點和方式的邏輯。
...
**現場定位行銷動作** —一種行銷動作，使用資料來製作現場廣告，包括在您組織的網站或應用程式上選擇和發佈廣告，或測量此類廣告的發佈和效果。
...
**即時客戶個人檔案：**[!DNL Real-time Customer Profile] 是集中式個人檔案，用於目標明確的個人化體驗管理，並根據來自多個來源的匯總資料，提供統一、即時的消費者個人檔案。
