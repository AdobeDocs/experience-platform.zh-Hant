...
[!DNL Experience Platform]以RESTful API為基礎，向開發人員公開系統的完整功能，支援使用熟悉的工具輕鬆整合企業解決方案。 [!DNL Experience Platform] 還支援合作夥伴根據需要構建和整合自己的產品和技術。這種強大和靈活性使[!DNL Experience Platform]在市場上獨一無二。 它為合作夥伴、客戶和開發人員社群提供基礎，以建立推動體驗業務的創新：提供持續改善且完全個人化的體驗，從客戶及其個人偏好的360度檢視中獲得，超越客戶期望。

## [!DNL Experience Platform] 文件

[!DNL Experience Platform] 檔案以多種格式提供，以適用於各種功能和服務。若要進一步了解可用的檔案類型，請造訪[平台檔案概述](documentation/overview.md)。

若要開始了解有關特定[!DNL Platform]服務的更多資訊，請返回[文檔登錄頁面](https://experienceleague.adobe.com/docs/experience-platform.html)並選擇相應的指南。

### [!DNL Experience Platform]上構建的應用程式服務文檔
...
您可以依照逐步教學課程快速輕鬆地開始使用[!DNL Platform]，其中涵蓋從準備資料擷取到進階機器學習演算法等所有內容。 這些教學課程的設計目的是補充[!DNL Experience Platform]檔案中的資訊，因此為了獲得最佳結果，在完成教學課程時，請保持檔案的現有狀態。
