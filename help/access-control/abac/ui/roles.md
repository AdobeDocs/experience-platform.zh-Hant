...
此 **[!UICONTROL 建立新角色]** 對話方塊隨即顯示，提示您輸入名稱以及可選的說明。
...
使用下拉式選單選取您要包含在角色中的資源許可權。 對要納入角色的所有資源重複此步驟。 完成後，選取 **[!UICONTROL 儲存並退出]**.

![flac-save-resources](../../images/flac-ui/flac-save-resources.png)

新角色已成功建立，您將被重新導向至 **[!UICONTROL 角色]** 頁面，您會在其中看到新建立的角色出現在清單中。
...
若要複製現有角色，請從以下位置選取角色： **[!UICONTROL 角色]** 標籤。 或者，使用篩選選項來篩選結果，以尋找您要複製的角色。
...
接著，您會進入角色的詳細資訊頁面，您可在此變更角色的名稱和許可權。 詳細資訊、標籤和沙箱會與先前的角色重複。 需要透過使用者索引標籤新增使用者。 您可以檢視 [管理角色的許可權](permissions.md) 檔案，以進一步瞭解將詳細資訊、標籤、沙箱和使用者新增至角色。

按一下左箭頭返回 **[!UICONTROL 角色]** 標籤。
...
選取省略符號(`…`)，而下拉式清單則會顯示可編輯、刪除或複製角色的控制項。 從下拉式清單中選取刪除。
...
在建立新角色後，您可以繼續下一步以 [管理角色的許可權](permissions.md).
