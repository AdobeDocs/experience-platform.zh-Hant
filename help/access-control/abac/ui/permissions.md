...
若要以使用者或開發人員的身分使用Experience Platform API，系統管理員除了角色的特定許可權集以外，還需要新增API認證。 如需建立和指派API認證以及所需許可權的完整指南，請參閱[驗證和存取Experience PlatformAPI](../../../landing/api-authentication.md#generate-credentials)中的逐步教學課程。
