...
在[建立新角色](#create-a-new-role)之後，您立即返回&#x200B;**[!UICONTROL Roles]**&#x200B;標籤。 如果您正在編輯現有角色的許可權，請從「**[!UICONTROL Roles]**」標籤中選取該角色。 或者，使用篩選選項來篩選結果以尋找角色。
...
| [!UICONTROL Modified between] | 選取開始日期和/或結束日期，以定義篩選結果的日期範圍。 |
| [!UICONTROL Modified by] | 從下拉式清單中選取使用者，依角色修飾元篩選。 |
...
從&#x200B;**[!UICONTROL Roles]**&#x200B;標籤中選取角色，這會開啟角色的[!UICONTROL Details]儀表板。

![所選取角色的詳細資訊工作區會顯示反白的總覽資訊。](../../images/flac-ui/flac-details.png)

[!UICONTROL Details]儀表板提供角色的概觀。 概觀會顯示角色名稱、說明、建立者、上次修改者，以及建立和修改日期。 它也會顯示附加至角色的許可權，以及指派的沙箱清單。 如有需要，可修改角色名稱和說明。

## 管理角色的標籤

選取「**[!UICONTROL Labels]**」標籤以開啟角色標籤工作區，然後選取「**[!UICONTROL Add labels]**」以指派標籤給角色。

![角色的「標籤」工作區會以「標籤」索引標籤和「新增標籤」按鈕突出顯示。](../../images/flac-ui/flac-labels.png)

顯示&#x200B;**[!UICONTROL Apply Access and Data Governance Labels]**&#x200B;對話方塊，顯示標籤清單。 清單會顯示標簽名稱、易記名稱、類別及其說明。

從清單中選取您要新增至角色的標籤，然後選取&#x200B;**[!UICONTROL Save]**

![已選取標籤的[套用存取權和資料控管標籤]對話方塊。](../../images/flac-ui/flac-add-labels.png)

新增的標籤會顯示在&#x200B;**[!UICONTROL Labels]**&#x200B;標籤下。

![角色的「標籤」工作區中反白顯示新增的標籤。](../../images/flac-ui/flac-added-labels.png)

若要從角色中移除標籤，請選取標籤，然後選取&#x200B;**[!UICONTROL Remove Labels]**。

![角色的「標籤」工作區已選取角色，且「移除標籤」選項已反白顯示。](../../images/flac-ui/flac-delete-labels.png)

## 管理角色的沙箱

選取「**[!UICONTROL Details]**」標籤，並導覽至「**[!UICONTROL Sandboxes]**」區段。 選取&#x200B;**[!UICONTROL View All]**&#x200B;以檢視新增至角色的沙箱完整清單。

![角色的「詳細資訊」工作區中，「沙箱」區段已反白顯示。](../../images/flac-ui/flac-sandboxes.png)

若要新增更多沙箱至角色，請從UI右上角選取「**[!UICONTROL Edit]**」。

![角色的[詳細資訊]工作區中反白顯示[編輯]選項。](../../images/flac-ui/flac-add-sandboxes.png)

下一個畫面會提示您使用下拉式清單，選擇要包含在角色中的沙箱資源。 完成後，請選取&#x200B;**[!UICONTROL Save]**，然後選取&#x200B;**[!UICONTROL Close]**。

![角色的「資源」儀表板，沙箱資源下拉式功能表已反白顯示。](../../images/flac-ui/flac-add-role-permission.png)

## 管理角色的使用者

選取「**[!UICONTROL Users]**」標籤以開啟角色[!UICONTROL Users]工作區，然後選取「**[!UICONTROL Add Users]**」以將使用者指派給角色。

![顯示角色的「使用者」工作區，並反白顯示「使用者」索引標籤和「新增使用者」選項。](../../images/flac-ui/flac-users.png)

**[!UICONTROL Add Users]**&#x200B;對話方塊隨即顯示。 從清單中選取您想要新增至角色的使用者。 或者，使用搜尋列輸入使用者的名稱或電子郵件地址來搜尋使用者，然後選取&#x200B;**[!UICONTROL Save]**

![[新增使用者]對話方塊中選取了使用者，且搜尋列和儲存選項反白顯示。](../../images/flac-ui/flac-add-users.png)

新增的使用者會出現在&#x200B;**[!UICONTROL Users]**&#x200B;標籤下。
...
>[!IMPORTANT]
>
> 若要在[!UICONTROL Permissions]中使用和管理API認證，使用者必須擁有系統管理員許可權。
...
選取&#x200B;**[!UICONTROL API credentials]**&#x200B;標籤以開啟角色API認證工作區，然後選取&#x200B;**[!UICONTROL Add API credentials]**&#x200B;以指派API認證給角色。

![角色的API認證工作區中，[新增認證]選項已反白顯示。](../../images/flac-ui/flac-api-credentials.png)

**[!UICONTROL Add API credentials]**&#x200B;對話方塊隨即顯示。 從清單中選取要新增至角色的API認證，然後選取&#x200B;**[!UICONTROL Save]**

![已選取[新增API認證]對話方塊，並反白顯示[儲存]選項。](../../images/flac-ui/flac-add-api-credentials.png)

新增的API認證會出現在&#x200B;**[!UICONTROL API credentials]**&#x200B;標籤下。
...
**[!UICONTROL Remove API credentials]**&#x200B;對話方塊隨即顯示，提示您確認刪除。 選取&#x200B;**[!UICONTROL Confirm]**&#x200B;以完成移除選取的認證。

![[移除認證]彈出視窗提示您確認移除認證。](../../images/flac-ui/flac-confirm-api-credentials-delete.png)

您將會返回&#x200B;**[!UICONTROL API credentials]**&#x200B;標籤。
...
選取「**[!UICONTROL User groups]**」標籤以開啟角色的使用者群組工作區，然後選取「**[!UICONTROL Add Groups]**」以將使用者群組指派給角色。

![角色的使用者群組工作區包含[新增群組]選項](../../images/flac-ui/flac-user-groups.png)

**[!UICONTROL Add Groups]**&#x200B;對話方塊隨即顯示。 從清單中選取您想要新增至角色的使用者群組。 或者，使用搜尋列來搜尋使用者群組，方法是輸入群組名稱，然後選取&#x200B;**[!UICONTROL Save]**

![已選取[新增群組]對話方塊，且已反白顯示[搜尋並儲存]選項。](../../images/flac-ui/flac-add-user-groups.png)

新增的使用者群組會出現在&#x200B;**[!UICONTROL User groups]**&#x200B;標籤下。
...
**[!UICONTROL Remove user group]**&#x200B;對話方塊隨即顯示，提示您確認刪除。 選取&#x200B;**[!UICONTROL Confirm]**&#x200B;以移除選取的使用者群組。

![顯示並反白顯示移除使用者群組的彈出視窗。](../../images/flac-ui/flac-confirm-user-groups-delete.png)

您將會返回&#x200B;**[!UICONTROL User groups]**&#x200B;標籤。
...
若要新增使用者Experience Platform，請登入[Admin Console](https://adminconsole.adobe.com)並選取&#x200B;**[!UICONTROL Add users]**。

![反白顯示[新增使用者]選項的Adobe Admin Console儀表板。](../../images/flac-ui/product-profile-add-users.png)

**[!UICONTROL Add users to your team]**&#x200B;對話方塊隨即顯示。 輸入使用者的電子郵件地址、名字（選用）和姓氏（選用）。 然後選取&#x200B;**[!UICONTROL Products]**。

![[新增使用者至團隊]對話方塊中反白顯示使用者欄位和產品選項。](../../images/flac-ui/product-profile-add-users-to-your-team.png)

**[!UICONTROL Select products]**&#x200B;對話方塊隨即顯示。 選擇「**[!UICONTROL Adobe Experience Platform]**」。

![反白顯示Adobe Experience Platform的選取產品對話方塊。](../../images/flac-ui/product-profile-select-product.png)

**[!UICONTROL Select product profiles]**&#x200B;對話方塊隨即顯示。 選取&#x200B;**[!UICONTROL AEP-Default-All-Users]**，然後選取&#x200B;**[!UICONTROL Save]**。

![已選取並套用AEP-Default-All-Users的「選取產品設定檔」對話方塊反白顯示。](../../images/flac-ui/product-profile-select-product-profiles.png)

檢閱資訊，然後選取&#x200B;**[!UICONTROL Save]**&#x200B;以新增使用者。
