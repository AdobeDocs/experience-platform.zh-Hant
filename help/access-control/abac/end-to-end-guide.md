...
Platform UI的許可權工作區隨即顯示，並在&#x200B;**[!UICONTROL 角色]**&#x200B;頁面上開啟。
...
若要開始，請從&#x200B;**[!UICONTROL 角色]**&#x200B;頁面中選取&#x200B;**[!UICONTROL ACME業務群組]**。

![影像顯示角色中正在選取的ACME企業角色](../images/abac-end-to-end-user-guide/abac-select-role.png)
...
貴組織中的所有標籤清單隨即顯示。 選取&#x200B;**[!UICONTROL RHD]**&#x200B;以新增&#x200B;**[!UICONTROL PHI/規範健康情況資料]**&#x200B;的標籤。 請稍候片刻，讓標籤旁邊出現一個藍色核取記號，然後選取[**[!UICONTROL 儲存]**]。
...
從左側導覽中選取&#x200B;**[!UICONTROL 區段]**。 隨即顯示貴組織中可用的區段清單。 在此範例中，下列兩個區段會加上標籤，因為它們包含敏感的健康情況資料：
...
![顯示從[區段]索引標籤中選取的血糖> 100的影像](../images/abac-end-to-end-user-guide/abac-select-segment.png)

區段&#x200B;**[!UICONTROL 詳細資料]**&#x200B;畫面隨即顯示。 選取&#x200B;**[!UICONTROL 管理存取權]**。

![影像顯示管理存取的選取專案](../images/abac-end-to-end-user-guide/abac-segment-fields-manage-access.png)

「**[!UICONTROL 編輯標籤]**」對話方塊會顯示，讓您選擇要套用至區段的標籤。 針對此使用案例，請選取&#x200B;**[!UICONTROL PHI/規範健康情況資料]**&#x200B;標籤，然後選取&#x200B;**[!UICONTROL 儲存]**。
...
接著，選取原則名稱旁的省略符號(`...`)，下拉式清單會顯示編輯、啟動、刪除或複製角色的控制項。 從下拉式清單中選取&#x200B;**[!UICONTROL 啟動]**。
