...
>[!NOTE]
>
> 使用[!UICONTROL 物件層級存取控制]，將在[許可權](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/access-control/object-based-access)工作區中建立的標籤（例如上方的區段標籤）指派給Adobe Journey Optimizer中的各種物件。
