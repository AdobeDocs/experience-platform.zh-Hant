...
>[!NOTE]
>
> 使用[!UICONTROL Permissions]物件層級存取控制[，將在](https://experienceleague.adobe.com/zh-hant/docs/journey-optimizer/using/access-control/object-based-access)工作區中建立的標籤（例如上方的區段標籤）指派給Adobe Journey Optimizer中的各種物件。
...
>[!VIDEO](https://video.tv.adobe.com/v/3451850?captions=chi_hant&learn=on)
