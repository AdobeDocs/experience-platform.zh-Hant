...
type: Documentation
description: Adobe Experience Platform 使用與傳統關聯式資料模型不同的高度非標準化混合資料模型。本文檔提供預設使用和速率限制，幫助您使用Real-time Customer Data PlatformB2B版為資料建模以獲得最佳系統效能。
...
>[!NOTE]
>
>本文中概述的限制表示Real-time Customer Data PlatformB2B版所啟用的更改。 要獲得即時CDP B2B版本的預設限制的完整清單，請將這些限制與中概述的一般Adobe Experience Platform限制結合起來 [即時客戶配置檔案資料文檔的護欄](../profile/guardrails.md)。
...
>[!NOTE]
>
>本節中概述的資料模型限制表示Real-time Customer Data PlatformB2B版所啟用的更改。 要獲得即時CDP B2B版本的預設限制的完整清單，請將這些限制與中概述的一般Adobe Experience Platform限制結合起來 [即時客戶配置檔案資料文檔的護欄](../profile/guardrails.md)。

| 瓜德賴爾 | 限制 | 限制類型 | 說明 |
| --- | --- | --- | --- |
| 即時CDP B2B Edition標準XDM類資料集 | 60 | 軟 | 建議最多使用Real-time CDP B2B Edition提供的標準體驗資料模型(XDM)類的60個資料集。 有關B2B使用情形的標準XDM類的完整清單，請參閱 [即時CDP B2B版文檔中的架構](schemas/b2b.md)。 <br/><br/>*注：由於Experience Platform的非規範混合資料模型的性質，大多數客戶沒有超過此限制。 有關如何對資料建模的問題，或者如果您想瞭解有關自定義限制的更多資訊，請與您的客戶服務代表聯繫。* |
...
>[!NOTE]
>
>本節中概述的資料大小限制表示Real-time Customer Data PlatformB2B版所啟用的更改。 要獲得即時CDP B2B版本的預設限制的完整清單，請將這些限制與中概述的一般Adobe Experience Platform限制結合起來 [即時客戶配置檔案資料文檔的護欄](../profile/guardrails.md)。
...
>[!NOTE]
>
>本節概述的細分限制表示Real-time Customer Data PlatformB2B版所啟用的更改。 要獲得即時CDP B2B版本的預設限制的完整清單，請將這些限制與中概述的一般Adobe Experience Platform限制結合起來 [即時客戶配置檔案資料文檔的護欄](../profile/guardrails.md)。
