...
如需擴充功能設定選項的詳細資訊，請參閱 [Experience Launch檔案中的「Adobe Media Analytics for Audio and Video extension](https://docs.adobe.com/content/help/zh-Hant/launch/using/extensions-ref/adobe-extension/media-analytics-extension/overview.html) 」頁面。
