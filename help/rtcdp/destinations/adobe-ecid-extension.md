...
# Experience Cloud ID 服務擴充功能 {#adobe-ecid-extension}

## 概述 {#overview}

此擴充功能實作Experience Cloud ID服務，可識別所有Experience Cloud解決方案的訪客。
...
如需擴充功能設定選項和安裝支援的詳細資訊，請參閱Experience Launch文 [件中的](https://docs.adobe.com/content/help/zh-Hant/launch/using/extensions-ref/adobe-extension/id-service-extension/overview.html) 「Experience Cloud ID服務」擴充頁。
