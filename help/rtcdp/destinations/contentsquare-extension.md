...
seo-title: Contentsquare擴充功能
description: Contentsquare擴充功能是Adobe即時客戶資料平台中的分析目的地。 如需擴充功能的詳細資訊，請參閱Adobe Exchange的擴充功能頁面。
seo-description: Contentsquare擴充功能是Adobe即時客戶資料平台中的分析目的地。 如需擴充功能的詳細資訊，請參閱Adobe Exchange的擴充功能頁面。
...
# Contentsquare擴充功能 {#contentsquare-extension}

## 概述 {#overview}

視覺化頁面內行為，瞭解客戶放棄的原因，以及您如何改善。 為每個Analytics區段和Target測試的UX和內容元素歸因收入。 安裝Contentsquare標籤、設定自訂變數和事件。 只要按幾下滑鼠，即可開始收集UX分析資料。

Contentsquare是Adobe即時客戶資料平台中的分析擴充功能。 如需擴充功能的詳細資訊，請參閱 [Adobe Exchange的擴充功能頁面](https://exchange.adobe.com/experiencecloud.details.100364.html)。
...
![Contentsquare擴充功能](assets/contentsquare-extension.png)
...
如需擴充功能設定選項的詳細資訊，請參 [閱Adobe Exchange上的Contentsquare擴充](https://exchange.adobe.com/experiencecloud.details.100364.html) 頁面。
