...
# Medallia擴充功能 {#medallia-extension}

## 概述 {#overview}

在您的Web屬性上快速順暢地部署Medalia。 此擴充功能還可讓您偵測調查事件、透過資料元素即時擷取客戶意見、在規則中使用它來個人化客戶體驗，並與Adobe Analytics共用資料。

Medallia是Adobe即時客戶資料平台中客戶延伸功能的代言人。 如需擴充功能的詳細資訊，請參閱 [Adobe Exchange的擴充功能頁面](https://exchange.adobe.com/experiencecloud.details.103279.medallia-for-adobe-launch.html)。
