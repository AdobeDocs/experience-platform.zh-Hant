...
# Facebook Pixel擴充功能 {#facebook-pixel-extension}

## 概述 {#overview}

Facebook像素是一種分析工具，可讓您透過瞭解訪客在您的網站上採取的動作來評估廣告的成效。

Facebook Pixel是Adobe即時客戶資料平台中的廣告延伸。 如需擴充功能的詳細資訊，請參閱 [Facebook Pixel網站](https://developers.facebook.com/docs/facebook-pixel/)。
...
![Facebook Pixel擴充功能](assets/facebook-pixel-extension.png)
