...
description: Twitter通用網站標籤擴充功能是Adobe即時客戶資料平台中的廣告目的地。 如需擴充功能的詳細資訊，請參閱Adobe Exchange的擴充功能頁面。
seo-description: Twitter通用網站標籤擴充功能是Adobe即時客戶資料平台中的廣告目的地。 如需擴充功能的詳細資訊，請參閱Adobe Exchange的擴充功能頁面。
...
# Twitter通用網站標籤延伸功能 {#twitter-uwt-extension}

## 概述 {#overview}

Twitter通用網站標籤提供將信標傳送至Twitter UWT標籤的動作。

Twitter通用網站標籤是Adobe即時客戶資料平台中的廣告延伸。 如需擴充功能的詳細資訊，請參閱進 [階轉換追蹤](https://business.twitter.com/en/solutions/twitter-ads/website-clicks/advanced-conversion-tracking.html)。
...
![Twitter通用網站標籤延伸功能](assets/twitter-uwt-extension.png)
