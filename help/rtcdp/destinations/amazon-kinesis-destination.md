...
* **[!DNL Amazon Web Services]訪問密鑰和密鑰**:在中 [!DNL Amazon Web Services]，產生 `access key - secret access key` 一對以授與Adobe即時CDP存取權給您的帳 [!DNL Amazon Kinesis] 戶。 請參閱 [Amazon Web Services檔案瞭解更多](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_access-keys.html)。
