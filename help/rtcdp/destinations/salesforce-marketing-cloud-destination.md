...
將即時CDP連接到Amazon S3或SFTP儲存後，您必須將資料從儲存位置導入到中 [!DNL Salesforce Marketing Cloud]。 如要瞭解如何完成此作業，請參 [閱中的「從檔案將訂閱者匯入Marketing Cloud](https://help.salesforce.com/articleView?id=mc_es_import_subscribers_from_file.htm&amp;type=5) 」 [!DNL Salesforce Help Center]。