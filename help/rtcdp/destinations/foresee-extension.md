...
description: Foresee擴充功能是Adobe即時客戶資料平台中的調查目的地。 如需擴充功能的詳細資訊，請參閱Adobe Exchange的擴充功能頁面。
seo-description: Foresee擴充功能是Adobe即時客戶資料平台中的調查目的地。 如需擴充功能的詳細資訊，請參閱Adobe Exchange的擴充功能頁面。
...
使用 [!DNL ForeSee] Experience Platform Launch來設定產品部署。

[!DNL Foresee] 是Adobe即時客戶資料平台中的調查擴充功能。 如需擴充功能的詳細資訊，請參閱 [Adobe Exchange的擴充功能頁面](https://exchange.adobe.com/experiencecloud.details.100164.html)。
...
![Foresee extension](assets/foresee-extension.png)
...
如需擴充功能設定選項的詳細資訊，請參 [閱Adobe Exchange上的](https://exchange.adobe.com/experiencecloud.details.100164.html) Foresee擴充功能頁面。
