...
description: Foresee擴充功能是即時客戶資料平台中的調查目的地。 如需擴充功能的詳細資訊，請參閱Adobe Exchange的擴充功能頁面。
seo-description: Foresee擴充功能是即時客戶資料平台中的調查目的地。 如需擴充功能的詳細資訊，請參閱Adobe Exchange的擴充功能頁面。
...
[!DNL Foresee] 是即時客戶資料平台中的調查擴充功能。 如需擴充功能的詳細資訊，請參閱 [Adobe Exchange的擴充功能頁面](https://exchange.adobe.com/experiencecloud.details.100164.html)。
