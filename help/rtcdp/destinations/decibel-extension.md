...
快速順暢地在您的 [!DNL Decibel] Web屬性上部署。 使用透過擴充功能提供的動作，也可隨規則部署其他進階設定。

[!DNL Decibel] 是Adobe即時客戶資料平台中的分析擴充功能。 如需擴充功能的詳細資訊，請參閱 [Adobe Exchange的擴充功能頁面](https://exchange.adobe.com/experiencecloud.details.100913.html)。
