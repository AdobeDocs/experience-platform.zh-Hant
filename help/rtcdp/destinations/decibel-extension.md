...
title: 分貝擴展
seo-title: 分貝擴展
description: Decibel擴充功能是Adobe即時客戶資料平台中的分析目的地。 如需擴充功能的詳細資訊，請參閱Adobe Exchange的擴充功能頁面。
seo-description: Decibel擴充功能是Adobe即時客戶資料平台中的分析目的地。 如需擴充功能的詳細資訊，請參閱Adobe Exchange的擴充功能頁面。
...
# 分貝擴展 {#decibel-extension}

## 概述 {#overview}

快速順暢地在您的Web屬性上部署Decibel。 使用透過擴充功能提供的動作，也可隨規則部署其他進階設定。

Decibel是Adobe即時客戶資料平台中的分析擴充功能。 如需擴充功能的詳細資訊，請參閱 [Adobe Exchange的擴充功能頁面](https://exchange.adobe.com/experiencecloud.details.100913.html)。
...
![分貝擴展](assets/decibel-extension.png)
...
如需擴充功能設定選項的詳細資訊，請參 [閱Adobe Exchange的](https://exchange.adobe.com/experiencecloud.details.100913.html) Decibel擴充功能頁面。
