...
# Parse.ly Analytics擴充功能 {#parsely-analytics-extension}

## 概述 {#overview}

Parse.ly Analytics可協助2,500多家公司使用資料來瞭解其線上受眾。 此擴充功能會安裝JavaScript程式碼片段，以追蹤訪客與您網站內容的互動方式。
...
![Parse.ly Analytics擴充功能](assets/parsely-extension.png)
