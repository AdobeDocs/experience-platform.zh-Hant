...
# Yext轉換追蹤擴充功能 {#yext-extension}

## 概述 {#overview}

「轉換追蹤擴充功能」可讓您測量可歸因於您使用Yext產品的轉換。

「轉換追蹤」是Adobe即時客戶資料平台中的分析擴充功能。 如需擴充功能的詳細資訊，請參閱 [Adobe Exchange的擴充功能頁面](https://exchange.adobe.com/experiencecloud.details.103174.yext-conversion-tracking.html)。
