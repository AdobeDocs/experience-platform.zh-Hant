...
description: DialogTech擴充功能是Adobe即時客戶資料平台中的分析目的地。 如需擴充功能的詳細資訊，請參閱Adobe Exchange的擴充功能頁面。
seo-description: DialogTech擴充功能是Adobe即時客戶資料平台中的分析目的地。 如需擴充功能的詳細資訊，請參閱Adobe Exchange的擴充功能頁面。
...
# DialogTech擴充功能 {#dialogtech-extension}

## 概述 {#overview}

在Adobe Launch中加入DialogTech SourceTrakjavascript程式碼片段

DialogTech是Adobe即時客戶資料平台中的分析擴充功能。 如需擴充功能的詳細資訊，請參閱Dialogtech [網站](https://www.dialogtech.com/)。
...
![DialogTech擴充功能](assets/dialogtech-extension.png)
