...
在Adobe Launch中 [!DNL DialogTech SourceTrak] 加入javascript程式碼片段

[!DNL DialogTech] 是Adobe即時客戶資料平台中的分析擴充功能。 如需擴充功能的詳細資訊，請參閱Dialogtech [網站](https://www.dialogtech.com/)。
