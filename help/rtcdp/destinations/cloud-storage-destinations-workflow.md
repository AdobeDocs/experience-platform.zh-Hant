...
2. 在「驗 **證** 」步驟中，如果您先前已設定雲端儲存空間目的地的連線，請選取並 **[!UICONTROL Existing Account]** 選取您現有的連線。 或者，您可以選 **[!UICONTROL New Account]** 擇設定到雲儲存目標的新連接。 填寫您的帳戶驗證憑證並選取 **[!UICONTROL Connect to destination]**。
...
3. 在步 **[!UICONTROL Setup]** 驟中，輸入啟 **[!UICONTROL Name]** 動流程 **[!UICONTROL Description]** 的和。
   1. 對於Amazon S3目標，請將 **[!UICONTROL Bucket name]** 和 **[!UICONTROL Folder path]** 檔案插入雲儲存目標中。 在您 **[!UICONTROL Create Destination]** 填入上述欄位後選取。
   2. 對於SFTP目標，請插入 **[!UICONTROL Folder path]**
   ![連線至雲端儲存空間目標——驗證步驟](/help/rtcdp/destinations/assets/cloud-destinations-setup-step.png)

4. 您的目標現在已建立。 您可以選 **[!UICONTROL Save & Exit]** 取以後要啟用區段，或選取 **[!UICONTROL Next]** 以繼續工作流程並選取要啟用的區段。 在這兩種情況下，請參閱下一 [節「啟用區段](#activate-segments)」，以匯出資料的其餘工作流程。
