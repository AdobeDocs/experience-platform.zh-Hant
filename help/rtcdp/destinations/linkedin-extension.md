...
# LinkedIn In Insight標籤擴充功能 {#linkedin-insights-extension}

## 概述 {#overview}

安裝LinkedIn In Insight Tag，以使用轉換追蹤、重新定位和網站人口統計功能。

LinkedIn Insight Tag是Adobe即時客戶資料平台中的廣告延伸。 如需擴充功能的詳細資訊，請參 [閱LinkedIn Insight標籤](https://business.linkedin.com/marketing-solutions/insight-tag)。
