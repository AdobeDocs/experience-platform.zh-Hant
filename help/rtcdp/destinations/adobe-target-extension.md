...
如需擴充功能設定選項的詳細資訊，請參閱 [Experience Launch檔案中的](https://docs.adobe.com/content/help/zh-Hant/launch/using/extensions-ref/adobe-extension/target-extension/overview.html) Adobe Target擴充功能頁面。
