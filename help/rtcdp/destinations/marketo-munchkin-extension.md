...
# Marketo Munchkin 擴充功能 {#marketo-munchkin-extension}

## 概述 {#overview}

從銷售機會管理到以客戶為基礎的行銷，Marketo Engagement Platform可簡化您在客戶和潛在客戶體驗的每個階段規劃、策劃和衡量互動的方式。

Marketo的Munchkin JavaScript可追蹤使用者頁面瀏覽次數，以及對您Marketo登陸頁面和外部網頁的點按次數。

Marketo Munchkin是Adobe即時客戶資料平台的電子郵件擴充功能。 如需擴充功能的詳細資訊，請參閱 [Adobe Exchange的擴充功能頁面](https://exchange.adobe.com/experiencecloud.details.101054.marketo-munchkin.html)。
