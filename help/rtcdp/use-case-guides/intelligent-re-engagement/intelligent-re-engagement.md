...
此結構用於建構和參考事件資料，這些資料構成了您的網站或相關數位平台上發生的客戶活動。 此資料通常會透過[!DNL Adobe Experience Platform]網頁SDK[擷取至](/help/web-sdk/home.md)，且為參考各種用來觸發歷程、詳細線上客戶分析、增強受眾功能和個人化傳訊的瀏覽和轉換事件所必需。
