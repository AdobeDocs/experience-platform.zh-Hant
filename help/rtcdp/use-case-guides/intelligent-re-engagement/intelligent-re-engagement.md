...
此歷程鎖定已放入購物車但未同時在網站和應用程式上購買的產品。 用於啟動和停止付費媒體行銷活動
...
有4種結構描述設計用於智慧型重新參與歷程。 每個結構描述都需要設定特定欄位，以及一些強烈建議的欄位。
...
![顯示欄位群組清單的客戶屬性結構描述記錄。](../intelligent-re-engagement/images/customer-attributes.gif)

>[!TAB 客戶數位交易]

線上活動(非Adobe Analytics聯結器)的體驗事件結構描述所需的欄位群組包括：
...
![顯示欄位群組清單的客戶數位交易方案的記錄。](../intelligent-re-engagement/images/customer-digital-transactions.gif)

>[!TAB 客戶離線交易]

離線活動之體驗事件結構描述所需的欄位群組包括：
...
![顯示欄位群組清單的客戶離線交易結構描述的記錄。](../intelligent-re-engagement/images/customer-offline-transactions.gif)

>[!TAB Adobe的Web聯結器結構描述]
...
![顯示欄位群組清單的AdobeWeb Connector結構描述記錄。](../intelligent-re-engagement/images/adobe-web-connector.png)
...
以下事件用於重新參與歷程，其中設定檔已線上上檢視產品，且未在未來24小時內新增到購物車，接著在接下來的3天內沒有品牌參與。
