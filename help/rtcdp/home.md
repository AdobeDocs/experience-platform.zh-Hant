...
<a href="https://experienceleague.adobe.com/docs/experience-platform/landing/home.html?lang=zh-Hant" target="_blank">檔案</a> - <a href="https://developer.adobe.com/experience-platform-apis/" target="_blank">API參考 — <a href="https://experienceleague.adobe.com/docs/courses/using/experienceplatform-u-1-2020-1.html?lang=zh-Hant" target="_blank">課程： Experience Platform簡介</a></a>
</td>
</tr></table>

<table style="table-layout:auto"><tr style="border: 0;"><td><img src="assets/do-not-localize/newsletter.png"></td><td>
<b>掌握最新資訊、為社群作出貢獻，並提升您的Adobe Real-Time CDP體驗！</b><br/>造訪Real-Time Customer Data Platform社群，與其他從業人員討論功能。 <a href="https://experienceleaguecommunities.adobe.com/t5/real-time-customer-data-platform/ct-p/Real-time-CDP?profile.language=zh-Hant">立即加入社群！</a></td></tr></table>
