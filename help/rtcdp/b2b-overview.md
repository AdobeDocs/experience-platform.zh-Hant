...
Real-Time CDP B2B edition提供數種新的XDM結構描述類別、欄位群組和關係型別，以擷取和建構您的資料並專門用於B2B用途。 如需這些增強功能的詳細資訊，請參閱Real-Time CDP B2B edition[中](./schemas/b2b.md)XDM的概觀。
...
請參閱Real-Time CDP B2B edition[檔案中的](./sources/b2b.md)來源，以取得有關Marketo和將B2B資料帶入Experience Platform的詳細資訊。
