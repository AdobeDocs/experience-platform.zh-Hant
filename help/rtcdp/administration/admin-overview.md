...
本檔案概述由Adobe Experience Platform提供支援的即時客戶資料平台的管理功能。

Experience Platform可讓管理員管理使用者的角色存取控制，並管理虛擬沙盒以進行應用程式開發。

以下各節介紹Experience Platform管理功能的中心元件，並包含Experience Platform檔案的連結，其中提供更詳細的資訊。
