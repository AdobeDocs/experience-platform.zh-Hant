...
2. 在您的Experience Data Model (XDM) B2B結構描述之間建立關係。 根據B2B版本屬性的對象需要類別之間的關係，才能完全使用擴充的B2B細分功能。 請參閱以下檔案： [如何定義兩個B2B結構描述之間的關係](../../xdm/tutorials/relationship-b2b.md) 以取得詳細資訊。
3. 使用以您的B2B結構為基礎的資料集來擷取資料。 請參閱來原始檔，瞭解 [有關如何內嵌資料的資訊](../../sources/connectors/adobe-applications/marketo/marketo.md).
