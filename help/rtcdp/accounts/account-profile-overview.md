...
>[!NOTE]
>
>帳戶設定檔僅供Real-time Customer Data Platform B2B Edition客戶使用。 要了解有關Real-time CDP B2B Edition的更多資訊，包括可用的功能，請從閱讀[Real-time CDP B2B Edition概述](../b2b-overview.md)開始。
