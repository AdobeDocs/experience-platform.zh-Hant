...
在左側導覽的&#x200B;**[!UICONTROL Profiles]**&#x200B;下選取[!UICONTROL Accounts]以檢視帳戶設定檔的概觀。 在[!UICONTROL Overview]標籤下方，儀表板會顯示圖形或圖表，在單一進入點顯示Widget。

![帳戶設定檔總覽索引標籤在左側導覽中有設定檔，並反白顯示總覽。](images/b2b-account-profile-overview.png)

如需瞭解詳細資訊，請參閱[[!UICONTROL Account Profiles]](../../dashboards/guides/account-profiles.md)儀表板的檔案。 請參閱[Real-time Customer Data Platform Insights資料模型B2B edition](../../dashboards/data-models/cdp-insights-data-model-b2b.md)的檔案，以取得有關如何使用您的見解資料模型為您的儀表板建立自訂圖表的詳細資訊。
...
若要設定銷售機會與帳戶的比對，請在左側導覽的&#x200B;**[!UICONTROL Profiles]**&#x200B;下選取[!UICONTROL Accounts]。 在&#x200B;**[!UICONTROL Overview]**&#x200B;索引標籤上，選取右上方的&#x200B;**[!UICONTROL Settings]**。

![設定反白顯示的[帳戶設定檔概述]索引標籤。](images/b2b-configuring-accounts-profile.png)

**[!UICONTROL Account settings]**&#x200B;對話方塊開啟。 從此處選取&#x200B;**[!UICONTROL Enable lead-to-account-matching]**&#x200B;切換以啟用該功能。 使用下拉式功能表為&#x200B;**[!UICONTROL Daily]**&#x200B;設定選取&#x200B;**[!UICONTROL Matching cadence]**。 最後，請選取相關的&#x200B;**[!UICONTROL Matching criteria]**&#x200B;選項，然後選取&#x200B;**[!UICONTROL Save]**&#x200B;以確認您的設定並返回&#x200B;**[!UICONTROL Account Profiles]**&#x200B;畫面。
...
若要瀏覽帳戶設定檔，請從左側導覽的&#x200B;**[!UICONTROL Profiles]**&#x200B;下選取[!UICONTROL Accounts]開始。

在&#x200B;**[!UICONTROL Browse]**&#x200B;標籤上，您可以使用連線企業來源的帳戶ID或直接輸入來源詳細資料來探索帳戶設定檔。

![使用帳戶ID來探索設定檔](images/b2b-account-browse-by.png)

### 依[!UICONTROL Connected enterprise source]瀏覽 {#browse-by-connected-enterprise-source}

若要依連線的企業來源瀏覽帳戶設定檔，請從&#x200B;**[!UICONTROL Connected enterprise source]**&#x200B;下拉式清單中選取&#x200B;**[!UICONTROL Browse by]**，然後使用&#x200B;**[!UICONTROL Source]**&#x200B;欄位旁的選擇器按鈕選擇連線的來源。

![依連線的企業來源瀏覽帳戶設定檔](images/b2b-account-browse.png)

這會開啟&#x200B;**[!UICONTROL Select source]**&#x200B;對話方塊，您可以在此根據貴組織建立的連線選取來源。
...
您可以選取連線名稱旁的選項按鈕來選取來源，然後使用&#x200B;**[!UICONTROL Select]**&#x200B;返回[!UICONTROL Browse]索引標籤。

![選取來源工作流程](images/b2b-account-select-source.png)

選取來源後，您現在必須輸入與來源相關的&#x200B;**[!UICONTROL Account ID]**。 例如，選取Salesforce來源會要求您從Salesforce執行個體輸入帳戶ID，以檢視與該ID相關聯的帳戶設定檔。
...
### 依[!UICONTROL Others]瀏覽 {#browse-by-others}

Real-Time CDP、B2B edition可讓您為想要檢視的帳戶輸入&#x200B;**[!UICONTROL Source name]**、**[!UICONTROL Source instance]**&#x200B;和&#x200B;**[!UICONTROL Account ID]**，以支援執行直接查詢。 直接輸入來源名稱和例項即可提供Experience Platform搜尋和顯示正確帳戶設定檔資料所需的內容。
...
若要開始直接查詢，請從「**[!UICONTROL Others]**」下拉式清單中選取「**[!UICONTROL Browse by]**」，然後輸入您要檢視之帳戶的&#x200B;**[!UICONTROL Source name]**、**[!UICONTROL Source instance]**&#x200B;和&#x200B;**[!UICONTROL Account ID]**。

![由其他人瀏覽](images/b2b-account-browse-adhoc.png)

## 檢視帳戶設定檔詳細資料 {#view-account-profile-details}

使用&#x200B;**[!UICONTROL Browse]**&#x200B;標籤尋找帳戶設定檔後，選取&#x200B;**[!UICONTROL Profile ID]**&#x200B;會開啟帳戶設定檔的&#x200B;**[!UICONTROL Detail]**&#x200B;標籤。 **[!UICONTROL Detail]**&#x200B;標籤上顯示的設定檔資訊已從多個設定檔片段合併在一起，以形成個別帳戶的單一檢視。 這包括基本屬性和社群媒體資料等帳戶細節。
...
**[!UICONTROL Attributes]**&#x200B;索引標籤會列出與帳戶相關的所有記錄資訊。 這包括來自多個來源的屬性資料，這些資料已合併在一起，以形成帳戶的單一檢視。
...
**[!UICONTROL People]**&#x200B;索引標籤提供與帳戶相關聯的個別人員清單。 這些人員可能是來自不同企業系統、由組織內不同團隊管理的聯絡人和銷售機會，但在Real-Time CDPB2B edition中，他們以單一清單的形式呈現，可讓您檢視帳戶聯絡人的整體檢視。
...
**[!UICONTROL Opportunities]**&#x200B;索引標籤提供與帳戶相關的未結與已結商機的資訊。 這些機會可能會從多個來源擷取至Experience Platform，不過Real-Time CDP讓B2B edition行銷人員可以輕鬆地在一個位置一起看到所有這些機會。

>[!NOTE]
>
>[!UICONTROL Opportunities]索引標籤會顯示與帳戶關聯的最多25個商機的清單。 若客戶擁有超過25個相關商機，系統會顯示隨機抽樣，共25筆記錄。
...
**[!UICONTROL Related accounts]**&#x200B;索引標籤提供與您瀏覽的帳戶相關的其他帳戶資訊。 如需功能的深入資訊，請閱讀[相關帳戶概述](/help/rtcdp/b2b-ai-ml-services/related-accounts.md)。

>[!NOTE]
>
>* 「相關」帳戶群組最多可以有30個帳戶設定檔。 如果發現超過30個帳戶設定檔相關，則會任意將其分割成多個群組，每個群組的成員不超過30個。 帳戶設定檔的「相關帳戶」群組一律包含自身。
>* [!UICONTROL Related accounts]索引標籤目前會顯示與您瀏覽的帳戶相關聯的最多25個相關帳戶的清單。 此限制將在未來的更新中解決。 儘管有此UI限制，當您在區段定義中使用相關帳戶時，對於30個相關帳戶設定檔的群組，所有設定檔都用於定位。
