...
source-git-commit: 06c037cc6acf1db2f5cb992a2ff1bfd063b08b93
workflow-type: tm+mt
...
購買Real-Time CDP時，貴公司可以選擇三種版本，如下表所示。 所有三個版本都可在標準Prime和Ultimate層級使用。 請參閱以下各節以取得其他資訊，協助您決定哪一個版本最適合您的公司。
...
如需更完整的資訊，請參閱[Real-Time CDP B2B edition概觀](./b2b-overview.md)。
