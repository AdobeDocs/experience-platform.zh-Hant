...
| 合作夥伴ID [!BADGE Beta]{type=Informative} | 合作夥伴ID是資料合作夥伴用來代表人員的識別碼。 合作夥伴ID通常是以假名表示，以免揭露個人的真實身分，而且可能是機率。 在Real-time Customer Data Platform中，合作夥伴ID主要用於擴充受眾啟用和資料擴充，而非用於建立確定性身分圖表連結。 |
