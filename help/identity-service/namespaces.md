...
使用標識命名空間需要瞭解涉及的各種Adobe Experience Platform服務。 開始使用命名空間之前，請查看以下服務的文檔：
...
- [[!DNL Privacy Service]](../privacy-service/home.md):標識命名空間用於遵守常規資料保護條例(GDPR)，在該條例中，可以相對於命名空間發出GDPR請求。
...
| 非人員標識符 | 非人員ID用於儲存需要命名空間但未連接到人員群集的標識符。 例如，產品SKU、與產品、組織或商店相關的資料。 |
