...
![將身分最佳化演演算法視覺化的圖表。](../images/ido_algorithm.png "視覺化身分最佳化演演算法的圖表。"){zoomable="yes"}
...
![案例一共用裝置。](../images/identity-settings/shared-device-case-one.png "共用裝置的案例一。"){zoomable="yes"}
...
![案例二共用裝置。](../images/identity-settings/shared-device-case-two.png "案例二共用裝置。"){zoomable="yes"}
...
![錯誤的電子郵件擷取圖表。](../images/identity-settings/bad-email.png "錯誤的電子郵件擷取圖表。"){zoomable="yes"}
...
![匿名事件關聯圖。](../images/identity-settings/anon-event-association.png "匿名事件關聯的圖表。"){zoomable="yes"}
