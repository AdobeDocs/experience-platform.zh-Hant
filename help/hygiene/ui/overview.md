...
Adobe Experience Platform UI中的&#x200B;**[!UICONTROL Data Lifecycle]**&#x200B;工作區可讓您建立及監控各種資料生命週期管理工作，包括刪除記錄及排程資料集有效期。

本指南說明如何在Experience Platform UI中管理資料生命週期工作。 有關如何使用API呼叫執行這些工作的資訊，請參閱[資料衛生API指南](../api/overview.md)。

若要存取工作區，請在左側導覽中選取&#x200B;**資料生命週期**。

![Experience Platform UI中的[!UICONTROL Data Lifecycle]工作區，左側導覽中反白顯示[!UICONTROL Data Lifecycle]。](../images/ui/overview/home.png)
