---
title: 資料衛生UI指南
description: 瞭解如何在Adobe Experience Platform使用者介面中管理資料檢疫任務。
...
本指南說明如何在Platform UI中管理資料檢疫工作。 如需有關如何使用API呼叫執行這些工作的資訊，請參閱 [資料衛生API指南](../api/overview.md).

若要存取工作區，請選取 **[!UICONTROL 資料衛生]** ，位於左側導覽器中。
