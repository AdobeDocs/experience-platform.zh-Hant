...
>[!IMPORTANT]
>
>目前，只有已購買的組織才能使用資料衛生 **Adobe醫療保健盾** 或 **Adobe隱私與安全防護**. 這些功能預計於近期內正式發行。 如需近期上市的詳細資訊，請洽詢您的Adobe服務代表。 不過，您可以立即 [透過刪除資料集 [!UICONTROL 資料集] UI](../catalog/datasets/user-guide.md#delete).
